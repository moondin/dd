...
## Verbatim Content (Part 606 of 851)
...
---[FILE: image.html]---
Location: ImageMagick-main/www/api/image.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Image Methods, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Image Methods</h1>
    </a>
  </header>
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#AcquireImage">AcquireImage</a></li>
  <li><a href="#AcquireImageInfo">AcquireImageInfo</a></li>
  <li><a href="#AcquireNextImage">AcquireNextImage</a></li>
  <li><a href="#AppendImages">AppendImages</a></li>
  <li><a href="#CatchImageException">CatchImageException</a></li>
  <li><a href="#ClipImagePath">ClipImagePath</a></li>
  <li><a href="#CloneImage">CloneImage</a></li>
  <li><a href="#CloneImageInfo">CloneImageInfo</a></li>
  <li><a href="#CopyImagePixels">CopyImagePixels</a></li>
  ...
  <li><a href="#GetImageInfoFile">GetImageInfoFile</a></li>
  <li><a href="#GetImageMask">GetImageMask</a></li>
  <li><a href="#GetImageVirtualPixelMethod">GetImageVirtualPixelMethod</a></li>
  <li><a href="#InterpretImageFilename">InterpretImageFilename</a></li>
  <li><a href="#IsHighDynamicRangeImage">IsHighDynamicRangeImage</a></li>
  <li><a href="#IsImageObject">IsImageObject</a></li>
  <li><a href="#IsTaintImage">IsTaintImage</a></li>
  <li><a href="#ModifyImage">ModifyImage</a></li>
  <li><a href="#NewMagickImage">NewMagickImage</a></li>
  <li><a href="#ReferenceImage">ReferenceImage</a></li>
  <li><a href="#ResetImagePage">ResetImagePage</a></li>
  <li><a href="#ResetImagePixels">ResetImagePixels</a></li>
  <li><a href="#SetImageAlpha">SetImageAlpha</a></li>
  <li><a href="#SetImageBackgroundColor">SetImageBackgroundColor</a></li>
  <li><a href="#SetImageChannelMask">SetImageChannelMask</a></li>
  <li><a href="#SetImageColor">SetImageColor</a></li>
  <li><a href="#SetImageStorageClass">SetImageStorageClass</a></li>
  <li><a href="#SetImageExtent">SetImageExtent</a></li>
  <li><a href="#SetImageInfoBlob">SetImageInfoBlob</a></li>
  <li><a href="#SetImageInfoCustomStream">SetImageInfoCustomStream</a></li>
  <li><a href="#SetImageInfoFile">SetImageInfoFile</a></li>
  <li><a href="#SetImageMask">SetImageMask</a></li>
  <li><a href="#SetImageRegionMask">SetImageRegionMask</a></li>
  <li><a href="#SetImageVirtualPixelMethod">SetImageVirtualPixelMethod</a></li>
  <li><a href="#SmushImages">SmushImages</a></li>
  <li><a href="#StripImage">StripImage</a></li>
</ul>
</div>
<br/>
<br/>
...
<pre class="bg-light text-dark mx-4"><samp>Image *AcquireImage(const ImageInfo *image_info,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ImageInfo *AcquireImageInfo(void)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void AcquireNextImage(const ImageInfo *image_info,Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>Image *AppendImages(const Image *images,const MagickBooleanType stack,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ExceptionType CatchImageException(Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType ClipImagePath(Image *image,const char *pathname,
...
<pre class="bg-light text-dark mx-4"><samp>Image *CloneImage(const Image *image,const size_t columns,
...
<pre class="bg-light text-dark mx-4"><samp>ImageInfo *CloneImageInfo(const ImageInfo *image_info)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType CopyImagePixels(Image *image,const Image *source_image,
...
<pre class="bg-light text-dark mx-4"><samp>Image *DestroyImage(Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ImageInfo *DestroyImageInfo(ImageInfo *image_info)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void GetImageInfo(ImageInfo *image_info)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>FILE *GetImageInfoFile(const ImageInfo *image_info)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *GetImageMask(const Image *image,const PixelMask type,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>VirtualPixelMethod GetImageVirtualPixelMethod(const Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>size_t InterpretImageFilename(const ImageInfo *image_info,Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType IsHighDynamicRangeImage(const Image *image,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType IsImageObject(const Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType IsTaintImage(const Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType ModifyImage(Image *image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *NewMagickImage(const ImageInfo *image_info,const size_t width,
...
<pre class="bg-light text-dark mx-4"><samp>Image *ReferenceImage(Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType ResetImagePage(Image *image,const char *page)
</samp></pre>
...
<p>ResetImagePixels() reset the image pixels, that is, all the pixel components are zeroed.</p>

<p>The format of the SetImage method is:</p>

<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType ResetImagePixels(Image *image,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetImageAlpha(Image *image,const Quantum alpha,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetImageBackgroundColor(Image *image,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ChannelType SetImageChannelMask(Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetImageColor(Image *image,const PixelInfo *color,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetImageStorageClass(Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetImageExtent(Image *image,const size_t columns,
...
<pre class="bg-light text-dark mx-4"><samp>void SetImageInfoBlob(ImageInfo *image_info,const void *blob,
  const size_t length)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void SetImageInfoCustomStream(ImageInfo *image_info,
...
<pre class="bg-light text-dark mx-4"><samp>void SetImageInfoFile(ImageInfo *image_info,FILE *file)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetImageMask(Image *image,const PixelMask type,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetImageRegionMask(Image *image,const PixelMask type,
...
<pre class="bg-light text-dark mx-4"><samp>VirtualPixelMethod SetImageVirtualPixelMethod(Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>Image *SmushImages(const Image *images,const MagickBooleanType stack,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType StripImage(Image *image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SyncImageSettings(const ImageInfo *image_info,
