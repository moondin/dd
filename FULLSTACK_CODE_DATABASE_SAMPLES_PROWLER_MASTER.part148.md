...
## Verbatim Content (Part 148 of 867)
...
---[FILE: nist_800_53_revision_5_aws.json]---
Location: prowler-master/prowler/compliance/aws/nist_800_53_revision_5_aws.json
      ...
      "Attributes": [
        {
          ...
          "Section": "Access Control (AC)",
          "SubSection": "Account Management (AC-2)",
          "SubGroup": "AC-2(12) Account Monitoring",
          "Service": "guarduty"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Access Control (AC)",
          "SubSection": "Access Enforcement (AC-3)",
          "SubGroup": "AC-3(3) Mandatory Access Control",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Access Control (AC)",
          "SubSection": "Access Enforcement (AC-3)",
          "SubGroup": "AC-3(4) Discretionary Access Control",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Access Control (AC)",
          "SubSection": "Access Enforcement (AC-3)",
          "SubGroup": "AC-3(12)  Assert And Enforce Application Access",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Access Control (AC)",
          "SubSection": "Access Enforcement (AC-3)",
          "SubGroup": "AC-3(15) Discretionary And Mandatory Access Control",
          "Service": "guarduty"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Access Control (AC)",
          "SubSection": "Unsuccessful Logon Attempts (AC-7)",
          "SubGroup": "AC-7(4) Use Of Alternate Authentication Factor",
          "Service": "iam"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Access Control (AC)",
          "SubSection": "Remote Access (AC-17)",
          "SubGroup": "AC-17(4) Privileged Commands And Access",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Assessment, Authorization, And Monitoring (CA)",
          "SubSection": "Continuous Monitoring (CA-7)",
          "SubGroup": "CA-7(4) Risk Monitoring",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "SubGroup": "CM-5(1) Automated Access Enforcement And Audit Records",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Configuration Management (CM)",
          "SubSection": "System Component Inventory (CM-8)",
          "SubGroup": "CM-8(3) Automated Unauthorized Component Detection",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Identification and Authentication (IA)",
          "SubSection": "Identification and Authentication (Organizational users) (IA-2)",
          "SubGroup": "IA-2(6) Acces To Accounts — Separate Device",
          "Service": "iam"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "SubGroup": "IA-3(3) Dynamic Address Allocation",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Identification and Authentication (IA)",
          "SubSection": "Authenticator Management (IA-5)",
          "SubGroup": "IA-5(18) Password Managers",
          "Service": "iam"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "SubGroup": "IA-8(2) Acceptance Of External Authenticators",
          "Service": "iam"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "Maintenance (MA)",
          "SubSection": "Nonlocal Maintenance (MA-4)",
          "SubGroup": "MA-4(1) Logging And Review",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "System and Communications Protection (SC)",
          "SubSection": "Denial Of Service Protection (SC-5)",
          "SubGroup": "SC-5(3) Detection And Monitoring",
          "Service": "guarduty"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "System and Communications Protection (SC)",
          "SubSection": "Boundary Protection (SC-7)",
          "SubGroup": "SC-7(4) External Telecommunications Services",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "System and Communications Protection (SC)",
          "SubSection": "Boundary Protection (SC-7)",
          "SubGroup": "SC-7(9) Restrict Threatening Outgoing Communications Traffic",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "System and Communications Protection (SC)",
          "SubSection": "Boundary Protection (SC-7)",
          "SubGroup": "SC-7(24) Personally Identifiable Information",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "System and Information integrity (SI)",
          "SubSection": "Malicious Code Protection (SI-3)",
          "SubGroup": "SI-3(8) Detect Unauthorized Commands",
          "Service": "aws"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "System and Information integrity (SI)",
          "SubSection": "System Monitoring (SI-4)",
          "SubGroup": "SI-4(4) Inbound and Outbound Communications Traffic",
          "Service": "guarduty"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "Section": "System and Information integrity (SI)",
          "SubSection": "System Monitoring (SI-4)",
          "SubGroup": "SI-4(13) Analyze Traffic And Event Patterns",
          "Service": "guarduty"
        }
      ],
      "Checks": [
      ...
      "Attributes": [
        {
          ...
          "SubGroup": "SI-10(1) Manual Override Capability",
          "Service": "aws"
        }
      ],
      "Checks": [
