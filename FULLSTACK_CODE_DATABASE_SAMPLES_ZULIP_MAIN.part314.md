...
## Verbatim Content (Part 314 of 1290)
...
Location: zulip-main/locale/da/translations.json
Signals: React, Next.js

```json
{
  "%'{file}' exceeds the maximum file size for attachments ({variable} MB).": "%'{file}' overskrider den maksimale filstørrelse ({variable} MB).",
  "(attached file)": "(vedhæftet fil)",
  "(default)": "(standard)",
  "(forever)": "(for altid)",
  "(hidden)": "(skjult)",
  "(link to channel)": "(link til kanal)",
  "(no highlighting)": "(ingen fremhævning)",
  "(or <key-html></key-html>)": "(eller <key-html></key-html>)",
  "(to you and {other_participant_names})": "(til dig og {other_participant_names})",
  "(to you and {participants_count} more)": "(til dig og {participants_count} andre)",
  "(to you)": "(til dig)",
  "(you)": "(dig)",
  ...
  "<kbd>Enter</kbd> sends when composing a message": "<kbd>Enter</kbd> sender når du forfatter en besked",
  "<p><strong>{file_name}</strong> will be removed from the messages where it was shared. This action cannot be undone.</p>": "<p><strong>{file_name}</strong> vil blive slettet fra beskeder, hvor den blev delt. Denne handling kan ikke fortrydes.</p>",
  "<p>You are searching for messages that are sent by more than one person, which is not possible.</p>": "<p>Du søger efter beskeder med mere end én afsender, hvilket ikke er muligt.</p>",
  "<p>You are searching for messages that belong to more than one channel, which is not possible.</p>": "<p>Du søger efter beskeder der tilhører mere end én kanal, hvilket ikke er muligt.</p>",
  "<p>You are searching for messages that belong to more than one topic, which is not possible.</p>": "<p>Du søger efter beskeder med mere end ét emne, hvilket ikke er muligt.</p>",
  "<strong>{name}</strong> <i>(guest)</i> is not subscribed to this channel. They will not be notified if you mention them.": "<strong>{name}</strong> <i>(gæst)</i> abonnerer ikke på denne kanal. De får ikke besked, når du nævner dem.",
  "<strong>{name}</strong> <i>(guest)</i> is not subscribed to this channel. They will not be notified unless you subscribe them.": "<strong>{name}</strong> <i>(gæst)</i> abonnerer ikke på denne kanal. De får ikke besked, medmindre du tilmelder dem.",
  "<strong>{name}</strong> is not subscribed to this channel. They will not be notified if you mention them.": "<strong>{name}</strong> abonnerer ikke på denne kanal. De får ikke besked, når du nævner dem.",
  "<strong>{name}</strong> is not subscribed to this channel. They will not be notified unless you subscribe them.": "<strong>{name}</strong> abonnerer ikke på denne kanal. De får ikke besked, medmindre du tilmelder dem.",
  "<strong>{username}</strong> has {number_of_invites_by_user, plural, one {# unexpired invitation} other {# unexpired invitations}}.": "<strong>{username}</strong> har {number_of_invites_by_user, plural, one {# ikke udløbet invitation} other {# ikke udløbne invitationer}}.",
  ...
  "<z-link>Learn more.</z-link>": "<z-link>Lær mere.</z-link>",
  "<z-link>Learn more</z-link> about other data export options.": "<z-link>Lær mere</z-link> om andre muligheder for dataeksport.",
  "<z-user></z-user> will have the same properties as it did prior to deactivation, including role, owner and channel subscriptions.": "<z-user></z-user>får tildelt de samme egenskaber som før deaktiveringen, inklusive rolle, ejer og kanalabonnementer.",
  "<z-user></z-user> will have the same role, channel subscriptions, user group memberships, and other settings and permissions as they did prior to deactivation.": "<z-user></z-user>får tildelt samme rolle, kanalabonnementer, brugergruppe-medlemskab og andre indstillinger som før deaktiveringen.",
  "@{name} (guest)": "@{name} (gæst)",
  "A channel with this name already exists.": "En kanal med dette navn eksisterer allerede.",
  "A deactivated bot cannot send messages, access data, or take any other action.": "En deaktiveret bot kan ikke sende beskeder, tilgå data eller foretage sig andre handlinger.",
  "A deactivated emoji will remain visible in existing messages and emoji reactions, but cannot be used on new messages.": "En deaktiveret emoji forbliver synlig i eksisterende beskeder og emoji-reaktioner, men kan ikke bruges i nye beskeder.",
  "A deactivated user group with this name already exists.": "En deaktiveret brugergruppe med dette navn findes allerede.",
  "A language is marked as 100% translated only if every string in the web, desktop, and mobile apps is translated, including administrative UI and error messages.": "Et sprog markeres først som 100% oversat, når alle strenge på web, desktop og mobilapp er oversat, inklusive interface til administration og fejlmeldinger.",
  "A poll must be an entire message.": "En afstemning opretter en ny besked.",
  "A public data export is a complete data export for your organization other than <z-private-channel-link>private channel</z-private-channel-link> messages and <z-direct-messages-link>direct messages</z-direct-messages-link>.": "En offentlig dataeksport er en fuldstændig dataeksport for din organisation bortset fra beskeder i <z-private-channel-link>private kanaler</z-private-channel-link> og <z-direct-messages-link>private beskeder</z-direct-messages-link> til andre brugere..",
  "A standard export additionally includes private data accessible to users who have allowed administrators to export their private data.": "En standardeksport indeholder også privat data, som er gjort tilgængelig for brugere, der har givet administratorer lov til at downloade deres private data.",
  "A to-do list must be an entire message.": "En to-do-liste skal være en hel besked.",
  "A topic move is already in progress.": "Overflytning af emne er allerede i gang.",
  "A user group with this name already exists.": "En brugergruppe med dette navn findes allerede.",
  "A wide image (200×25 pixels) for the upper left corner of the app.": "Et bredt billede (200 × 25 pixels) til øverste venstre hjørne af appen.",
  "AI summaries are not available on Zulip Cloud yet.": "AI-opsummeringer er ikke tilgængelige på Zulip Cloud endnu.",
  "AI summaries are not enabled on this server.": "AI-opsummeringer er ikke tilgængelige på denne server.",
  "AI summaries may have errors.": "AI-opsummeringer kan indeholde fejl.",
  "API documentation": "API Dokumentation",
  "API key": "API-nøgle",
  "About Zulip": "Om Zulip",
  "Account": "Konto",
  "Account & privacy": "Konto og privatliv",
  "Action": "Handling",
  "Action message": "Handlingsbesked",
  "Actions": "Handlinger",
  "Active an hour ago": "Aktiv for en time siden",
  "Active and deactivated": "Aktiv og deaktiveret",
  ...
  "Add": "Tilføj",
  "Add GIF": "Tilføj GIF",
  "Add a description": "Til en beskrivelse",
  "Add a new alert word": "Tilføj et nyt signalord",
  "Add a new bot": "Tilføj en ny bot",
  "Add a new channel folder": "Tilføj en ny kanalmappe",
  "Add a new code playground": "Tilføj en ny Code Playground",
  "Add a new custom profile field": "Tilføj et nyt brugerdefineret profilfeld",
  "Add a new emoji": "Tilføj en ny emoji",
  "Add a new linkifier": "Tilføj en ny linkifier",
  "Add a new profile field": "Tilføj et nyt profilfeld",
  "Add alert word": "Tilføj signalord",
  "Add an email to access your API key.": "Tilføj en mailadresse for at tilgå din API-nøgle.",
  "Add another user…": "Tilføj flere brugere…",
  "Add channel": "Tilføj kanal",
  "Add channels": "Tilføj kanaler",
  "Add code playground": "Tilføj Code Playground",
  "Add default channels": "Tilføj standardkanaler",
  "Add email": "Tilføj mailadresse",
  "Add emoji": "Tilføj emoji",
  "Add emoji reaction": "Tilføj emoji reaktion",
  "Add emoji reaction to selected message": "Tilføj emoji-reaktion til udvalgte beskeder",
  "Add extra emoji for members of the {realm_name} organization.": "Tilføj ekstra emoji for medlemmer af organisationen {realm_name}.",
  "Add global time": "Tilføj global tid",
  "Add linkifier": "Tilføj linkifier",
  "Add members": "Tilføj medlemmer",
  "Add members to {group_name}": "Tilføj medlemmer til {group_name}",
  ...
  "Add roles, groups or users": "Tilføj roller, grupper eller brugere",
  "Add saved snippet": "Tilføj gemt udsnit",
  "Add subscribers": "Tilføj deltagere",
  "Add subscribers to": "Tilføj abonnenter til",
  "Add subscribers.": "Tilføj abonnenter.",
  "Add task": "Tilføj opgave",
  "Add to-do list": "Tilføj to-do-liste",
  "Add todo task list title": "Tilføj titel på to-do-liste",
  "Add user groups": "Tilføj brugergrupper",
  "Add users or groups. Use #channelname to add all subscribers.": "Tilføj brugere eller grupper. Brug #kanalnavn for at tilføje alle kanalens abonnenter.",
  "Add video call": "Tilføj videomøde",
  "Add voice call": "Tilføj stemmeopkald",
  "Add your email to <z-link-invite-users-help>invite other users</z-link-invite-users-help> or <z-link-convert-demo-organization-help>convert to a permanent Zulip organization</z-link-convert-demo-organization-help>.": "Tilføj din mailadresse for at <z-link-invite-users-help>invitere andre brugere</z-link-invite-users-help> eller for at <z-link-convert-demo-organization-help>omdanne til en permanent Zulip-organisation</z-link-convert-demo-organization-help>.",
  "Add your email to access this feature.": "Tilføj din mailadresse for at tilgå denne feature.",
  "Add {full_name} to groups": "Tilføj {full_name} til grupper",
  "Added successfully!": "Tilføjelse lykkedes!",
  "Added:": "Tilføjet:",
  "Administrative permissions": "Administrative rettigheder",
  "Administrator": "Administrator",
  "Administrators": "Administratorer",
  "Administrators and moderators this Zulip organization will be able to see this email address.": "Administratorer og moderatorer i denne Zulip-organisation kan se denne mailadresse.",
  "Administrators of this Zulip organization will be able to see this email address.": "Administratorer i denne Zulip-organisation kan se denne mailadresse.",
  "Admins": "Admin",
  ...
  "Advertise organization in the Zulip communities directory": "Vis organisationen i Zulips community-bibliotek",
  "After how much time should all data for this organization be permanently deleted (users, channels, messages, etc.)?": "Hvor længe skal der gå, før al organisationens data skal slettes permanent (brugere, kanaler, beskeder osv.)?",
  "Alert word": "Signalord",
  "Alert word <b>{alert_word}</b> removed successfully!": "Signalord <b>{alert_word}</b> blev fjernet!",
  "Alert word already exists!": "Signalord findes allerede!",
  "Alert words": "Signalord",
  "Alert words allow you to be notified as if you were @-mentioned when certain words or phrases are used in Zulip. Alert words are not case sensitive.": "Signalord underretter dig, ligesom når du bliver @-omtalt, når bestemte ord eller vendinder bliver brugt i Zulip. Signalord skelner ikke mellem små og store bogstaver.",
  "Alerted messages": "Signalbeskeder",
  "All": "Alt",
  "All channels": "Alle kanaler",
  "All groups": "Alle grupper",
  "All groups were already members.": "Alle grupper var allerede medlemmer.",
  "All messages": "Alle beskeder",
  "All messages including muted channels": "Alle beskeder inklusiv kanaler uden notifikationer",
  "All roles ({count})": "All roller ({count})",
  "All time": "Altid",
  "All topics": "Alle emner",
  "All unmuted topics": "Alle emner med lyd",
  "All unread conversations are hidden. Click on a section, folder, or channel to expand it.": "Alle ulæste samtaler er skjulte. Klik på en sektion, mappe eller kanal for at folde den ud.",
  "All unread messages": "Alle ulæste beskeder",
  "All users and groups were already members.": "Alle brugere og grupper var allerede medlemmer.",
  "All users were already members.": "Alle brugere var allerede medlemmer.",
  "All users were already subscribed.": "Alle brugere var allerede abonnenter.",
  "All your messages except those in muted channels and topics.": "Alle dine beskeder på nær dem fra kanaler og emner, som er begrænsede.",
  "All your messages.": "Alle dine beskeder.",
  "Allow creating web-public channels (visible to anyone on the Internet)": "Tillad oprettelse af web-offentlige kanaler (synlig for alle på internettet)",
  "Allow message content in message notification emails": "Tillad beskedindhold i notifikations-emails",
  "Allow message editing": "Tillad redigering af beskeder",
  "Allow messages in this channel to be edited, deleted, or moved.": "Tillad beskeder i denne kanal at blive redigeret, slettet eller flyttet.",
  "Allow other users to view read receipts": "Tillad bruger at se læst-kvitteringer",
  "Allow posting to the <z-empty-string-topic-display-name></z-empty-string-topic-display-name> topic?": "Tillad at poste om emnet <z-empty-string-topic-display-name></z-empty-string-topic-display-name>?",
  "Allow sending new messages to this channel.": "Tillad at sende nye beskeder i denne kanal.",
  "Allow subdomains": "Tillad underdomæner",
  "Allow viewing the history of a message?": "Tillad at se historikken for en besked?",
  "Allow “{empty_topic_name}”": "Tillad \"{empty_topic_name}\"",
  "Allowed domains": "Tilladte domæner",
  "Allowed domains: {domains}": "Tilladte domæner: {domains}",
  "Alphabetize choices": "Sorter udvalg alfabetisk",
  "Already a member:": "Allerede medlem:",
  "Already a subscriber:": "Allerede abonnenent:",
  "Already above recommended maximum font size ({maximum_value})": "Anbefalede maksimale skriftstørrelse allerede overskredet ({maximum_value})",
  "Already above recommended maximum line spacing": "Anbefalede maksimale linjeafstand allerede overskredet",
  "Already at default font size ({default_value})": "Standard-skriftstørrelse allerede nået ({default_value})",
  "Already at default line spacing": "Standard linjeafstand allerede nået",
  "Already at maximum font size ({maximum_value})": "Maksimale skriftstørrelse allerede nået ({maximum_value})",
  "Already at maximum line spacing": "Maksimale linjeafstand allerede nået",
  "Already at minimum font size ({minimum_value})": "Mindste skriftstørrelse allerede nået ({minimum_value})",
  "Already at minimum line spacing": "Minimums-linjeafstand allerede nået",
  "Already below recommended minimum font size ({minimum_value})": "",
  "Already below recommended minimum line spacing": "",
  "Already not subscribed.": "Allerede afmeldt som abonnent.",
  "Already subscribed to {channel}": "Er allerede abonnent på {channel}",
  ...
  "Announce new channel in": "Annoncer en ny kanal i",
  "Any time": "Ingen tidsbegrænsning",
  ...
  "App theme": "App-farvetema",
  "April": "April",
  "Archive <z-link></z-link>?": "Arkiver <z-link></z-link>?",
  "Archive channel": "Arkiver kanal",
  "Archived and non-archived": "Arkiveret og ikke-arkiveret",
  "Archived channels": "Arkiverede kanaler",
  "Archiving this channel will:": "Arkivering af denne kanal medfører:",
  ...
  "Are you sure you want to deactivate your account?": "Er du sikker på, at du vil deaktivere din konto?",
  "Are you sure you want to delete all drafts?  This action cannot be undone.": "Er du sikker på, at du vil slette alle kladder? Denne handling kan ikke fortrydes.",
  "Are you sure you want to delete your profile picture?": "Er du sikker på, at du vil slette dit profilbillede?",
  "Are you sure you want to join it directly as well?": "Er du sikker på, at du vil deltage med det samme?",
  "Are you sure you want to mark messages as unread? Messages in multiple conversations may be affected.": "Er du sikker på, at du vil markere beskederne som ulæste? Beskeder i flere samtaler kan blive påvirket.",
  "Are you sure you want to mark {count} messages as unread? Messages in multiple conversations may be affected.": "Er du sikker på, at du vil markere {count} beskeder som ulæste? Beskeder i flere samtaler kan blive påvirket.",
  "Are you sure you want to mute <z-highlight>{user_name}</z-highlight>?  Messages sent by muted users will never trigger notifications, will be marked as read, and will be hidden.": "Er du sikker på, at du vil begrænse <z-highlight>{user_name</z-highlight>}? Beskeder sendt af begrænsede brugere udløser ingen notifikationer, bliver ikke markeret som læst og bliver skjult.",
  ...
  "August": "August",
  "Authentication methods": "Godkendelsesmetoder",
  "Author": "Forfatter",
  "Automated messages and emails": "Automatiserede beskeder og mails",
  "Automatic": "Automatisk",
  "Automatic (follows system settings)": "Automatisk (følger systemindstillingerne)",
  "Automatic theme": "Automatisk farvetema",
  "Automatically follow topics based on my participation": "",
  ...
  "Available": "",
  "Available on Zulip Cloud Standard.": "Tilgængelig på Zulip Cloud Standard.",
  "Avatar": "Avatar",
  "Avatar changes are disabled in this organization": "Avatar-ændringer er deaktiveret for denne organisation",
  "Avatar from Gravatar": "Avatar fra Gravatar",
  "BROWSE 1 MORE CHANNEL": "GENNEMSØG 1 KANAL MERE",
  "BROWSE {can_subscribe_stream_count} MORE CHANNELS": "GENNEMSØG {can_subscribe_stream_count} KANALER MERE",
  "Back to channels": "Tilbage til kanaler",
  "Back to settings": "Tilbage til indstillinger",
  "Bankruptcy": "Konkurs",
  ...
  "Bot": "Bot",
  "Bot email": "Bot-email",
  "Bot email (a-z, 0-9, and dashes only)": "Bot-email (må kun indeholde a-z, 0-9 og bindestreger)",
  "Bot is deactivated": "Bot er deaktiveret",
  "Bot owner": "Bot-ejer",
  "Bot type": "Type",
  "Bots": "Bots",
  "Browse": "Gennemsøg",
  ...
  "Business": "Business",
  "Busy": "Optaget",
  "Button joy": "Synes-godt-om-knap",
  "By deactivating your account, you will be logged out immediately.": "Hvis du deaktiverer din konto, bliver du logget af med det samme.",
  "CHANNELS": "KANALER",
  "CREATE A CHANNEL": "OPRET KANAL",
  "Call provider": "Opkaldsudbyder",
  "Cancel": "Annuller",
  "Cancel compose": "Annuller oprettelse",
  "Cancel compose and save draft": "Annuller oprettelse og gem kladde",
  "Cannot add duplicate task.": "Kan ikke tilføje duplikatopgave.",
  ...
  "Cannot view channel": "Kan ikke vise kanal",
  "Card": "Kort",
  "Center the view around message ID <z-value></z-value>.": "",
  "Change": "Skift",
  "Change avatar": "Skift avatar",
  "Change color": "Skift farve",
  "Change email": "Skift mailadresse",
  "Change group info": "Rediger gruppeinformation",
  "Change language": "Skift sprog",
  "Change password": "Skift adgangskode",
  "Change setting": "Rediger indstillinger",
  "Change to default line spacing": "Skift til standard linjeafsnit",
  "Change to font size {new_value}": "Skift til skriftstørrelse {new_value}",
  "Change to {new_value_string} line spacing": "Skift til {new_value_string} linjeafstand",
  "Change your email": "Skift din mailadresse",
  "Change your password": "Skift din adgangskode",
  "Channel": "Kanal",
  "Channel <z-link>#{stream_name}</z-link> created!": "Kanal <z-link>#{stream_name}</z-link> oprettet!",
  "Channel ID": "Kanal-ID",
  "Channel color": "Kanalfarve",
  "Channel created recently": "Kanal oprettet for nyligt",
  "Channel created!": "Kanal oprettet!",
  ...
  "Channel feed": "Kanalfeed",
  "Channel folder": "Kanalmappe",
  "Channel folder name": "Kanalmappes navn",
  "Channel folders": "Kanalmapper",
  ...
  "Channels they should join": "Kanaler som bør abonneres",
  ...
  "Click here to reveal.": "Klik her for at vise.",
  ...
  "Close this dialog window": "Luk dialogvindue",
  "Code": "Kode",
  ...
  "Collapse channel": "Fold kanal sammen",
  "Collapse channel folder": "Fold kanalmappe sammen",
  "Collapse compose box": "Kollaps skriveboksen",
  ...
  "Copy link to channel": "Kopier link til kanal",
  ...
  "Default channels for this organization": "Standardkanaler for denne organisation",
  ...
  "Error creating channel": "Fejl ved oprettelse af kanal",
  ...
  "Go to channel feed": "Gå til kanalfeed",
  "Go to channel feed from topic view": "",
  "Go to channel settings": "Gå til kanalindstillinger",
  "Go to combined feed": "",
  ...
  "Hide left sidebar": "Skjul venstre panel",
  "Hide muted message again": "",
  "Hide password": "",
  "Hide starred message count": "",
  "Hide unread counter": "",
  "Hide user list": "Skjul brugerliste",
  "High contrast mode": "",
  "Hint": "",
  ...
  "Joining and viewing messages requires being invited": "",
  ...
  "No channels to show.": "Ingen kanaler at vise.",
  ...
  "Only channel administrators can edit these settings.": "",
  ...
  "Organization URL": "organisationens URL",
  ...
  "Pin channel to top": "Fastgør kanal til top",
  "Pin channel to top of left sidebar": "Fastgør kanal til venstre",
  "Plan management": "",
  "Plans and pricing": "",
  ...
  "Please select a channel.": "Specificer venligst en kanal.",
  ...
  "Reactions to your messages": "Reaktioner på din besked",
  "Reactivate bot": "",
  "Reactivate group": "",
  "Reactivate this bot": "",
  ...
  "Read receipts are disabled for this organization.": "",
  ...
  "Rename <z-stream-or-topic></z-stream-or-topic>": "",
  ...
  "Request sponsorship": "Ansøg om sponsorering",
  "Requesting user": "",
  ...
  "Scroll through channels": "Scroll gennem kanaler",
  ...
  "Subscribed channels": "Abonnerede kanaler",
  ...
  "System bot": "",
  "THIS CHANNEL": "",
  "THIS CONVERSATION": "DENNE SAMTALE",
  "Task already exists": "",
  ...
  "There are no default channels.": "Der er ingen standardkanaler.",
  ...
  "This channel does not exist or is private.": "Denne kanal eksisterer ikke eller er privat.",
  "This channel does not yet have a description.": "Denne kanal har endnu ikke en beskrivelse.",
  ...
  "Top topic in the channel": "Mest aktive emne i denne kanal",
  ...
  "Unpin channel from top": "Løsriv kanal fra top",
  "Unread": "Ulæste",
  ...
  "Welcome to Zulip!": "Velkommen til Zulip!",
