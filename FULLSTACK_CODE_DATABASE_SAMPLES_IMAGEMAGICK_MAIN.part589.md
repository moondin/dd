...
## Verbatim Content (Part 589 of 851)
...
---[FILE: cache-view.html]---
Location: ImageMagick-main/www/api/cache-view.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Cache Views, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Cache Views</h1>
    </a>
  </header>

  <main class="container">
<h1 class="text-center">Cache-view</h1>
<div class="btn-group">
<button class="btn btn-secondary dropdown-toggle" type="button" id="defaultDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
  Select API Method
</button>
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#AcquireAuthenticCacheView">AcquireAuthenticCacheView</a></li>
  <li><a href="#AcquireVirtualCacheView">AcquireVirtualCacheView</a></li>
  <li><a href="#CloneCacheView">CloneCacheView</a></li>
  <li><a href="#DestroyCacheView">DestroyCacheView</a></li>
  <li><a href="#GetCacheViewAuthenticPixels">GetCacheViewAuthenticPixels</a></li>
  <li><a href="#GetCacheViewAuthenticMetacontent">GetCacheViewAuthenticMetacontent</a></li>
  <li><a href="#GetCacheViewAuthenticPixelQueue">GetCacheViewAuthenticPixelQueue</a></li>
  <li><a href="#GetCacheViewColorspace">GetCacheViewColorspace</a></li>
  <li><a href="#GetCacheViewImage">GetCacheViewImage</a></li>
  <li><a href="#GetCacheViewStorageClass">GetCacheViewStorageClass</a></li>
  <li><a href="#GetCacheViewVirtualMetacontent">GetCacheViewVirtualMetacontent</a></li>
  <li><a href="#GetCacheViewVirtualPixelQueue">GetCacheViewVirtualPixelQueue</a></li>
  <li><a href="#GetCacheViewVirtualPixels">GetCacheViewVirtualPixels</a></li>
  <li><a href="#GetOneCacheViewAuthenticPixel">GetOneCacheViewAuthenticPixel</a></li>
  <li><a href="#GetOneCacheViewVirtualPixel">GetOneCacheViewVirtualPixel</a></li>
  <li><a href="#GetOneCacheViewVirtualPixelInfo">GetOneCacheViewVirtualPixelInfo</a></li>
  <li><a href="#GetOneCacheViewVirtualMethodPixel">GetOneCacheViewVirtualMethodPixel</a></li>
  <li><a href="#QueueCacheViewAuthenticPixels">QueueCacheViewAuthenticPixels</a></li>
  <li><a href="#SetCacheViewStorageClass">SetCacheViewStorageClass</a></li>
  <li><a href="#SetCacheViewVirtualPixelMethod">SetCacheViewVirtualPixelMethod</a></li>
</ul>
</div>
<br/>
<br/>
...
<pre class="bg-light text-dark mx-4"><samp>CacheView *AcquireAuthenticCacheView(const Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>CacheView *AcquireVirtualCacheView(const Image *image,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>CacheView *CloneCacheView(const CacheView *cache_view)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>CacheView *DestroyCacheView(CacheView *cache_view)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum *GetCacheViewAuthenticPixels(CacheView *cache_view,
...
<pre class="bg-light text-dark mx-4"><samp>void *GetCacheViewAuthenticMetacontent(CacheView *cache_view)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum *GetCacheViewAuthenticPixelQueue(CacheView *cache_view)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ColorspaceType GetCacheViewColorspace(const CacheView *cache_view)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const Image *GetCacheViewImage(const CacheView *cache_view)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ClassType GetCacheViewStorageClass(const CacheView *cache_view)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const void *GetCacheViewVirtualMetacontent(
...
<pre class="bg-light text-dark mx-4"><samp>const Quantum *GetCacheViewVirtualPixelQueue(
  const CacheView *cache_view)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const Quantum *GetCacheViewVirtualPixels(
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetOneCacheViewAuthenticPixel(
  const CacheView *cache_view,const ssize_t x,const ssize_t y,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetOneCacheViewVirtualPixel(
  const CacheView *cache_view,const ssize_t x,const ssize_t y,
  Quantum *pixel,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetOneCacheViewVirtualPixelInfo(
  const CacheView *cache_view,const ssize_t x,const ssize_t y,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetOneCacheViewVirtualMethodPixel(
  const CacheView *cache_view,
...
<pre class="bg-light text-dark mx-4"><samp>Quantum *QueueCacheViewAuthenticPixels(CacheView *cache_view,
  const ssize_t x,const ssize_t y,const size_t columns,
  const size_t rows,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetCacheViewStorageClass(CacheView *cache_view,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetCacheViewVirtualPixelMethod(CacheView *cache_view,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SyncCacheViewAuthenticPixels(CacheView *cache_view,
  ExceptionInfo *exception)
</samp></pre>
