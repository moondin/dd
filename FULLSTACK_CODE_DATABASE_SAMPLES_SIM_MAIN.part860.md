...
## Verbatim Content (Part 860 of 933)
...
---[FILE: 0059_snapshot.json]---
Location: sim-main/packages/db/migrations/meta/0059_snapshot.json

```json
{
  "id": "e60969b2-4233-4a35-8566-149c194aa732",
  "prevId": "f93564ad-632b-48e7-bdaf-01c03cd5ff91",
  "version": "7",
  "dialect": "postgresql",
  "tables": {
    "public.account": {
    ...
    "public.copilot_checkpoints": {
      "name": "copilot_checkpoints",
      "schema": "",
      "columns": {
        "id": {
          "name": "id",
      ...
      "indexes": {
        "copilot_checkpoints_user_id_idx": {
          "name": "copilot_checkpoints_user_id_idx",
          "columns": [
            {
              "expression": "user_id",
              "isExpression": false,
        ...
        "copilot_checkpoints_workflow_id_idx": {
        ...
        "copilot_checkpoints_chat_id_idx": {
          "name": "copilot_checkpoints_chat_id_idx",
          "columns": [
            {
              "expression": "chat_id",
              "isExpression": false,
        ...
        "copilot_checkpoints_user_workflow_idx": {
          "name": "copilot_checkpoints_user_workflow_idx",
          "columns": [
            {
              "expression": "user_id",
              "isExpression": false,
        ...
        "copilot_checkpoints_workflow_chat_idx": {
          "name": "copilot_checkpoints_workflow_chat_idx",
          "columns": [
            {
              "expression": "workflow_id",
              "isExpression": false,
        ...
        "copilot_checkpoints_created_at_idx": {
        ...
        "copilot_checkpoints_chat_created_at_idx": {
      ...
      "foreignKeys": {
        "copilot_checkpoints_user_id_user_id_fk": {
          "name": "copilot_checkpoints_user_id_user_id_fk",
          "tableFrom": "copilot_checkpoints",
          "tableTo": "user",
          "columnsFrom": ["user_id"],
          "columnsTo": ["id"],
          "onDelete": "cascade",
        ...
        "copilot_checkpoints_workflow_id_workflow_id_fk": {
        ...
        "copilot_checkpoints_chat_id_copilot_chats_id_fk": {
    ...
    "public.workflow_logs": {
      ...
      "indexes": {
        "workflow_logs_workflow_id_idx": {
          "name": "workflow_logs_workflow_id_idx",
          "columns": [
            {
              "expression": "workflow_id",
              "isExpression": false,
        ...
        "workflow_logs_workflow_created_idx": {
          "name": "workflow_logs_workflow_created_idx",
          "columns": [
            {
              "expression": "workflow_id",
              "isExpression": false,
