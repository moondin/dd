...
## Verbatim Content (Part 570 of 851)
...
<head>
  ...
  <!-- Canonical URL -->
  <link rel="canonical" href="magick.html" />
  ...
  <meta property="og:title" content="ImageMagick | Command-line Tools: Magick" />
  ...
  <meta property="og:url" content="../www/magick.html" />
  ...
  <meta name="twitter:title" content="ImageMagick | Command-line Tools: Magick" />
  ...
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <div class="mt-3 ms-3">
      <a href="../index.html" class="text-decoration-none">
        <h1 class="fs-2 mb-1">Command-line Tools: Magick</h1>
      </a>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary cli"><samp>magick rose.jpg rose.png </samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary cli"><samp>magick -size 320x85 canvas:none -font Bookman-DemiItalic -pointsize 72 \
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary cli"><samp>magick input.png -colorspace RGB +sigmoidal-contrast 11.6933 \
...
magick identify rose.jpg rose.png </samp></pre>

<p>You can find additional examples of using <samp>magick</samp> in <a href="../index.html">Examples of ImageMagick Usage</a>.</p>
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="command-line-options.html#integral">-integral</a></td>
  ...
  <tr>
    <td><a href="command-line-options.html#rotational-blur">-rotational-blur <var>angle</var></a></td>
  ...
  <tr>
    <td><a href="command-line-options.html#reshape">-reshape <var>geometry</var></a></td>
  ...
  <tr>
    <td><a href="command-line-options.html#word-break">-word-break <var>type</var></a></td>
...
<!-- Magick Cache 3rd October 2025 21:37 -->
```
