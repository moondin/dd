...
## Verbatim Content (Part 505 of 695)
...
---[FILE: focus-indicators.e2e.spec.ts]---
Location: payload-main/test/a11y/focus-indicators.e2e.spec.ts
...
Location: payload-main/test/a11y/payload-types.ts
