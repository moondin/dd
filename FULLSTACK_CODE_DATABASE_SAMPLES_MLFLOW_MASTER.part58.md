...
## Verbatim Content (Part 58 of 991)
...
---[FILE: index.mdx]---
Location: mlflow-master/docs/docs/classic-ml/deep-learning/transformers/index.mdx
...
---[FILE: index.mdx]---
Location: mlflow-master/docs/docs/classic-ml/deep-learning/transformers/guide/index.mdx
...
MLflow supports tracking PEFT models in the Transformers flavor. You can log and load PEFT models using the same APIs as other Transformers models, such as <APILink fn="mlflow.transformers.log_model" /> and <APILink fn="mlflow.transformers.load_model" />.
