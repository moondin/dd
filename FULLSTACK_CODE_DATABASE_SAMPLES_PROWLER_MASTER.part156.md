...
## Verbatim Content (Part 156 of 867)
...
---[FILE: c5_azure.json]---
Location: prowler-master/prowler/compliance/azure/c5_azure.json
...
```json
{
  ...
  "Requirements": [
    ...
    {
      "Id": "PSS-12.02B",
      "Description": "Processing and storage of cloud service customer data within the service organisations of the cloud service provider also adheres to the regions selected by the cloud service customer.",
      "Attributes": [
        {
          "Section": "Product Safety and Security (PSS)",
          "SubSection": "PSS-12 Security Assessment",
