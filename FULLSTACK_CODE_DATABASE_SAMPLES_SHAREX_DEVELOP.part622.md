...
## Verbatim Content (Part 622 of 650)
...
---[FILE: UploadersConfigForm.zh-TW.resx]---
Location: ShareX-develop/ShareX.UploadersLib/Forms/UploadersConfigForm.zh-TW.resx
...
<root>
  ...
  <data name="cbAmazonS3CustomCNAME.ToolTip" xml:space="preserve">
    <value>如果你有設定自訂域名的儲存桶，請使用此選項。
如果文字欄位為空，網址將為儲存桶名稱。
舉例來說，如果你的儲存桶名稱為「bucket.example.com」，網址將為「http://bucket.example.com/...」。</value>
  </data>
  ...
  <data name="lblYourlsNote.Text" xml:space="preserve">
    <value>備註：如有簽名則不需使用者名稱/密碼。</value>
  </data>
  ...
  <data name="llAdflyLink.Text" xml:space="preserve">
    <value>此處可找到你的 API 金鑰和 UID</value>
  </data>
  ...
  <data name="lblPolrAPIHostname.Text" xml:space="preserve">
    <value>API 網址：(例如 http://demo.polr.me/api/v2/action/shorten)</value>
  </data>
...
使用加密的收藏庫將停用共享。</value>
  ...
  <data name="lblLambdaInfo.Text" xml:space="preserve">
    <value>如要獲取 API 金鑰，前往 https://lambda.sx/ 登入 Lambda，點選你的使用者名稱，接著點擊管理帳戶。</value>
  </data>
  ...
  <data name="lblPhotobucketNewAlbumName.Text" xml:space="preserve">
    <value>新相簿名稱 (必須在 2-50 個字元之間，有效字元為字母、數字、底線 (_)、連字號 (-) 和空格)</value>
  </data>
  ...
  <data name="cbImgurUploadSelectedAlbum.Text" xml:space="preserve">
    <value>上傳圖片到選定的相簿</value>
  </data>
  <data name="cbImgurUseGIFV.Text" xml:space="preserve">
    <value>使用 GIFV 而非 GIF 連結</value>
  </data>
  ...
  <data name="lblGistCustomURLExample.Text" xml:space="preserve">
    <value>範例：https://api.github.com</value>
  </data>
  ...
  <data name="lblGistOAuthInfo.Text" xml:space="preserve">
    <value>備註：不支援 GitHub Enterprise。</value>
  </data>
