...
## Verbatim Content (Part 179 of 650)
...
Location: ShareX-develop/ShareX/Properties/Resources.fr.resx
...
<root>
  ...
  <data name="UploadManager_IsUploadConfirmed_Are_you_sure_you_want_to_upload__0__files_" xml:space="preserve">
    <value>Êtes-vous sûr de vouloir mettre en ligne {0} fichiers ?</value>
  </data>
...
Cliquez sur « Non » pour annuler la mise en ligne et désactiver la mise en ligne automatique.</value>
  ...
  <data name="ClipboardFormatForm_ClipboardFormatForm_Supported_variables___0__and_other_variables_such_as__1__etc_" xml:space="preserve">
    <value>Variables prises en charge : {0} et d'autres variables telles que {1}, etc.</value>
  </data>
...
ici</value>
  ...
  <data name="TaskSettingsForm_UpdateUploaderMenuNames_File_uploader___0_" xml:space="preserve">
    <value>Mise en ligne de fichiers : {0}</value>
  </data>
  ...
  <data name="Program_WritePersonalPathConfig_Cant_access_to_file" xml:space="preserve">
    <value>Impossible d'accéder au fichier « {0} ».
Veuillez exécuter ShareX en tant qu'administrateur pour changer le chemin du dossier personnel.</value>
  </data>
  <data name="ApplicationSettingsForm_cbSteamShowInApp_CheckedChanged_For_settings_to_take_effect_ShareX_needs_to_be_reopened_from_Steam_" xml:space="preserve">
    <value>Pour que les réglages prennent effets, ShareX doit être rouvert à partir de Steam.</value>
  </data>
  ...
  <data name="ApplicationSettingsForm_btnBrowsePersonalFolderPath_Click_Choose_ShareX_personal_folder_path" xml:space="preserve">
    <value>Choisir le chemin du dossier personnel pour ShareX</value>
  </data>
  <data name="HotkeyManager_ShowFailedHotkeys_Unable_to_register_hotkey" xml:space="preserve">
    <value>Impossible d'enregistrer {0} :

{1}

Veuillez sélectionner un raccourci différent ou quitter l'application en conflit et rouvrez ShareX.</value>
  </data>
  <data name="MainForm_tsmiDeleteSelectedFile_Click_File_delete_confirmation" xml:space="preserve">
    <value>Confirmation de la suppression d'un fichier</value>
  </data>
...
Voulez-vous redémarrer ShareX ?</value>
  ...
  <data name="UploadInfoManager_ShowErrors_Upload_errors" xml:space="preserve">
    <value>Erreurs de mise en ligne</value>
  </data>
...
{0}</value>
  ...
  <data name="BeforeUploadForm_BeforeUploadForm__0__is_about_to_be_uploaded_to__1___You_may_choose_a_different_destination_" xml:space="preserve">
    <value>{0} va être mis en ligne sur {1}. Vous pouvez choisir une destination différente.</value>
  </data>
...
Êtes-vous sûr de vouloir continuer ?</value>
  ...
  <data name="QuickTaskMenuEditorForm_Reset_all_quick_tasks_to_defaults_Confirmation" xml:space="preserve">
    <value>Réinitialiser les tâches rapides ?</value>
  </data>
  <data name="WorkerTask_GetInvalidConfigResult__0__configuration_is_invalid_or_missing__Please_check__Destination_settings__window_to_configure_it_" xml:space="preserve">
    <value>La configuration {0} est invalide ou manquante. Merci de vérifier les "Paramètres de destination".</value>
  </data>
  <data name="ActionsToolbar_Close" xml:space="preserve">
    <value>Fermer</value>
  </data>
  <data name="ActionsToolbar__LockPosition" xml:space="preserve">
    <value>Verrouiller la position</value>
  </data>
...
Voulez-vous redémarrer ShareX ?</value>
  ...
  <data name="ThisFeatureWillNotWorkWhenDisableUploadOptionIsEnabled" xml:space="preserve">
    <value>Cette fonctionnalité n'est pas opérationnelle quand l'option "DisableUpload" est activée !</value>
  </data>
  ...
  <data name="WouldYouLikeToEnableImageEffects" xml:space="preserve">
    <value>Voulez-vous activer les effets d'image ?

Vous pourrez les désactiver plus tard depuis le manu "Tâches après la capture".</value>
  </data>
  <data name="FailedToSaveSettings" xml:space="preserve">
    <value>Échec de l'enregistrement des paramètres</value>
  </data>
  ...
  <data name="ShareXIsMinimizedToTheSystemTray" xml:space="preserve">
    <value>ShareX est réduit dans la zone de notification.</value>
  </data>
  <data name="PinToScreen" xml:space="preserve">
    <value>Epingler à l'écran</value>
  </data>
  <data name="InspectWindow_ProcessName" xml:space="preserve">
    <value>Nom du processus</value>
  </data>
  <data name="ShareXIsUpToDate" xml:space="preserve">
    <value>ShareX est à jour !</value>
  </data>
  ...
  <data name="FFmpegOnlySupports64BitOperatingSystems" xml:space="preserve">
    <value>FFmpeg inclus dans ShareX ne support que les systèmes d'exploitation 64-bits.</value>
  </data>
  ...
  <data name="InspectWindow_ProcessFileName" xml:space="preserve">
    <value>Nom de fichier du processus</value>
  </data>
  <data name="FFmpegIsMissing" xml:space="preserve">
    <value>FFmpeg est manquant</value>
  </data>
  ...
  <data name="InspectWindow_WindowStyles" xml:space="preserve">
    <value>Style des fenêtres</value>
  </data>
  <data name="YourAntiVirusSoftwareOrTheControlledFolderAccessFeatureInWindowsCouldBeBlockingShareX" xml:space="preserve">
    <value>Votre logiciel anti-virus ou le control des répertoires Windows pourrait bloquer ShareX.</value>
  </data>
  ...
  <data name="OpticalCharacterRecognitionFeatureIsOnlyAvailableWithWindowsVersion0OrNewer" xml:space="preserve">
    <value>La reconnaissance optique de caractères est uniquement disponible avec Windows version {0} ou plus récent.</value>
  </data>
  <data name="InspectWindow_WindowTitle" xml:space="preserve">
    <value>Titre de la fenêtre</value>
  </data>
  <data name="WouldYouLikeToRetryClipboardUpload" xml:space="preserve">
    <value>Voulez-vous réessayer la mise en ligne depuis le presse-papier ?</value>
  </data>
  <data name="ShareXCannotBeClosedWhileScreenRecordingIsActive" xml:space="preserve">
    <value>ShareX ne peut être fermé lorsqu'un enregistrement d'écran est en cours.

Voulez-vous annuler l'enregistrement d'écran en cours ?</value>
  </data>
  <data name="InspectWindow_ProcessIdentifier" xml:space="preserve">
    <value>Identifiant du processus</value>
  </data>
  <data name="UnableToFindAWindowWithSpecifiedWindowTitle" xml:space="preserve">
    <value>Impossible de trouver une fenêtre correspondant au titre indiqué.</value>
  </data>
  <data name="InspectWindow_WindowHandle" xml:space="preserve">
    <value>Poignée de fenêtre</value>
  </data>
  ...
  <data name="FFmpegDoesNotExistAtTheFollowingPath" xml:space="preserve">
    <value>FFmpeg est introuvable à l'emplacement spécifié :</value>
  </data>
  <data name="ImageData_Write_Error_Message" xml:space="preserve">
    <value>Impossible d'écrire l'image à l'emplacement spécifié :</value>
  </data>
  <data name="YourSystemAdminDisabledTheUploadFeature" xml:space="preserve">
    <value>Votre administrateur système a désactivé la fonctionnalité de mise en ligne.</value>
  </data>
