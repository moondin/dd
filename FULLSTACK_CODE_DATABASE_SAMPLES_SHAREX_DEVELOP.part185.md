...
## Verbatim Content (Part 185 of 650)
...
Location: ShareX-develop/ShareX/Properties/Resources.pl.resx
...
Czy chcesz ponownie uruchomić ShareX?</value>
  ...
  <data name="ApplicationSettingsForm_cbStartWithWindows_EnabledByPolicy_Text" xml:space="preserve">
    <value>Uruchomienie zostało włączone przez Twoją organizację</value>
  </data>
...
Możesz je później wyłączyć w menu "Zadania po przechwyceniu".</value>
  ...
  <data name="OpticalCharacterRecognitionFeatureIsOnlyAvailableWithWindowsVersion0OrNewer" xml:space="preserve">
    <value>Funkcja optycznego rozpoznawania znaków jest dostępna tylko w systemie Windows w wersji {0} lub nowszej.</value>
  </data>
  ...
  <data name="FFmpegIsMissing" xml:space="preserve">
    <value>Brakuje FFmpeg</value>
  </data>
  <data name="FFmpegDoesNotExistAtTheFollowingPath" xml:space="preserve">
    <value>FFmpeg nie istnieje w następującej ścieżce:</value>
  </data>
  <data name="FFmpegOnlySupports64BitOperatingSystems" xml:space="preserve">
    <value>FFmpeg, który jest dostarczany z ShareX, obsługuje tylko 64-bitowe systemy operacyjne.</value>
  </data>
  <data name="ShareXIsUpToDate" xml:space="preserve">
    <value>ShareX jest aktualny!</value>
  </data>
  <data name="WouldYouLikeToRetryClipboardUpload" xml:space="preserve">
    <value>Czy chcesz ponowić próbę przesłania schowka?</value>
  </data>
  <data name="ShareXCannotBeClosedWhileScreenRecordingIsActive" xml:space="preserve">
    <value>ShareX nie może zostać zamknięty, gdy aktywne jest nagrywanie ekranu.

Czy chcesz przerwać aktywne nagrywanie ekranu?</value>
  </data>
