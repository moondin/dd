...
## Verbatim Content (Part 541 of 851)
...
---[FILE: compare.html]---
Location: ImageMagick-main/www/compare.html
...
<head>
  ...
  <!-- Canonical URL -->
  <link rel="canonical" href="compare.html" />
  ...
  <meta property="og:title" content="ImageMagick | Command-line Tools: Compare" />
  ...
  <meta property="og:url" content="../www/compare.html" />
  ...
  <meta name="twitter:title" content="ImageMagick | Command-line Tools: Compare" />
  ...
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <div class="mt-3 ms-3">
      <a href="../index.html" class="text-decoration-none">
        <h1 class="fs-2 mb-1">Command-line Tools: Compare</h1>
      </a>
...
<p class="lead">Use the <samp>compare</samp> program to mathematically and visually annotate the difference between an image and its reconstruction.  See <a href="command-line-processing.html">Command Line Processing</a> for advice on how to structure your <samp>compare</samp> command or see below for example usages of the command.</p>
...
<!-- Magick Cache 3rd October 2025 22:34 -->
```
