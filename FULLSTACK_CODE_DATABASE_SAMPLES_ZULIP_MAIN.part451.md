...
## Verbatim Content (Part 451 of 1290)
...
---[FILE: zulip_tools.py]---
Location: zulip-main/scripts/lib/zulip_tools.py
Signals: Django
...
---[FILE: check-rabbitmq-consumers]---
Location: zulip-main/scripts/nagios/check-rabbitmq-consumers
...
---[FILE: check-rabbitmq-queue]---
Location: zulip-main/scripts/nagios/check-rabbitmq-queue
...
---[FILE: compare-settings-to-template]---
Location: zulip-main/scripts/setup/compare-settings-to-template
...
---[FILE: configure-rabbitmq]---
Location: zulip-main/scripts/setup/configure-rabbitmq
...
Location: zulip-main/scripts/setup/create-database
...
---[FILE: create-db.sql]---
Location: zulip-main/scripts/setup/create-db.sql
Signals: PostgreSQL
...
---[FILE: create-pgroonga.sql]---
Location: zulip-main/scripts/setup/create-pgroonga.sql
...
---[FILE: flush-memcached]---
Location: zulip-main/scripts/setup/flush-memcached
...
---[FILE: generate-rabbitmq-cookie]---
Location: zulip-main/scripts/setup/generate-rabbitmq-cookie
...
---[FILE: generate-self-signed-cert]---
Location: zulip-main/scripts/setup/generate-self-signed-cert
