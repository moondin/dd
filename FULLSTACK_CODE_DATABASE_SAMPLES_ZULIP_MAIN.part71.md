...
## Verbatim Content (Part 71 of 1290)
...
---[FILE: free_trial_not_available_for_complimentary_access_customer--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/free_trial_not_available_for_complimentary_access_customer--Event.list.2.json
  ...
  "data": [
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "free_trial_not_available_for_complimentary_access_customer--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
          "payment_method_details": {
            "card": {
              "amount_authorized": 4300,
              "authorization_code": "405415",
              "brand": "visa",
              "checks": {
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "free_trial_not_available_for_complimentary_access_customer--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
    ...
    },
    {
      ...
      "data": {
        ...
        "previous_attributes": {
          ...
          "subtotal": 6300,
          "subtotal_excluding_tax": 6300,
          "total": 6300,
          "total_excluding_tax": 6300
        }
      },
      "id": "free_trial_not_available_for_complimentary_access_customer--Event.list.2.json",
      "livemode": false,
