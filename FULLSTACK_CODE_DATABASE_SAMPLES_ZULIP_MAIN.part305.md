...
## Verbatim Content (Part 305 of 1290)
...
Location: zulip-main/locale/ca/translations.json
...
```json
{
  ...
  "Add another user…": "",
  "Add channel": "Afegeix un canal",
  "Add channels": "Afegeix canals",
  "Add code playground": "",
  ...
  "All messages": "",
  "All messages including muted channels": "Tots els missatges incloent-hi els canals silenciats",
  "All roles ({count})": "",
  "All time": "",
  "All topics": "",
  "All unmuted topics": "",
  ...
  "Create link": "",
  "Create new channel": "Crea un canal nou",
  "Create new folder": "",
  ...
  "Default channels": "Canals predeterminats",
  ...
  "Mark topic as read": "Marca el tema com a llegit",
  ...
  "New channel message": "Nou missatge al canal",
  "New direct message": "",
  ...
  "One or more of these users do not exist!": "Un o més d'aquests usuaris no existeixen",
  ...
  "Personal menu": "",
  "Personal settings": "",
  "Pin channel to top": "Fixa el canal dalt de tot",
  "Pin channel to top of left sidebar": "Fixa el canal dalt de la barra lateral esquerra",
  "Plan management": "",
  ...
  "Please select a channel.": "Especifiqueu un canal.",
  ...
  "Subscribe to/unsubscribe from selected channel": "Subscriure's/donar-se de baixa del canal seleccionat",
  ...
  "This channel does not exist or is private.": "El canal no existeix o és privat.",
  ...
  "Unpin channel from top": "No fixes el canal dalt de tot",
  "Unread": "No llegits",
  ...
  "View bot card": "",
  "View channel": "",
  "View channel messages": "Mostra els missatges del canal",
  ...
  "Welcome to Zulip!": "Us donem la benvinguda a Zulip!",
  ...
  "You have no unread messages!": "No teniu missatges no llegits",
