...
## Verbatim Content (Part 495 of 695)
...
---[FILE: 20251216_194333_initial.json]---
Location: payload-main/templates/with-vercel-website/src/migrations/20251216_194333_initial.json
...
```json
{
    ...
    "public._pages_v": {
      ...
      "foreignKeys": {
        ...
        "_pages_v_version_hero_media_id_media_id_fk": {
          ...
          "tableFrom": "_pages_v",
          "tableTo": "media",
          "columnsFrom": ["version_hero_media_id"],
          "columnsTo": ["id"],
          "onDelete": "set null",
          "onUpdate": "no action"
        },
    ...
    "public.payload_locked_documents_rels": {
      ...
      "foreignKeys": {
        ...
        "payload_locked_documents_rels_payload_folders_fk": {
          ...
          "tableFrom": "payload_locked_documents_rels",
          "tableTo": "payload_folders",
          "columnsFrom": ["payload_folders_id"],
          "columnsTo": ["id"],
          "onDelete": "cascade",
          "onUpdate": "no action"
        }
  ...
  "id": "39a710ea-5b17-43d5-bf1c-6010b856e4d7",
