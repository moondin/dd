...
## Verbatim Content (Part 537 of 851)
...
---[FILE: color.html]---
Location: ImageMagick-main/www/color.html
...
<head>
  ...
  <meta name="keywords" content="Color Names, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<p>Use the <a href="https://magickstudio.imagemagick.org/scripts/color-converter.html">Color Converter</a> to supply any valid ImageMagick color specification as described below to see a color swatch of that color and to convert to all the other color models.</p>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary cli"><samp>magick -bordercolor lime -border 10 image.jpg image.png
...
magick -bordercolor 'rgb(0,100%,0)' -border 10 image.jpg image.png</samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>rgb(255, 0, 0)                 range 0 - 255
rgba(255, 0, 0, 1.0)           the same, with an explicit alpha value
rgb(100%, 0%, 0%)              range 0.0% - 100.0%
rgba(100%, 0%, 0%, 1.0)        the same, with an explicit alpha value</samp></pre>
...
gray(50%)         mid gray
graya(50%, 0.5)   semi-transparent mid gray</samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>hsb(0,   100%,  100%)    or    hsb(0,   255,   255)       full red
...
hsb(120, 50%,   50%)     or    hsb(120, 127.5, 127.5)     pastel green</samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>hsl(0,   100%,  50%)     or    hsl(0,   255,   127.5)     full red
...
hsl(120, 50%,   50%)     or    hsl(120, 127.5, 127.5)     medium green</samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>hsb(120, 100%,  100%)              full green in hsb
...
hsla(120, 255,  127.5,  1.0)       the same, with an alpha value of 1.0</samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>cielab(62.253188, 23.950124, 48.410653)</samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>$ magick xc:cyan -colorspace LAB txt:
# ImageMagick pixel enumeration: 1,1,65535,cielab
0,0: (59711,20409.5,-3632.9)  #E93F4FBA71CF  cielab(91.1132,-48.0855,-14.1358)

$ magick -size 100x100 xc:"cielab(91.1132,-48.0855,-14.1358)" -colorspace sRGB cyan.png</samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>device-gray(0.5)
device-rgb(0.5, 1.0, 0.0)
device-cmyk(0.11, 0.48, 0.83, 0.00)</samp></pre>
