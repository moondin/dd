...
## Verbatim Content (Part 462 of 650)
...
---[FILE: EditorStartupForm.uk.resx]---
Location: ShareX-develop/ShareX.ScreenCaptureLib/Forms/EditorStartupForm.uk.resx
...
<root>
  ...
  <data name="btnCreateNewImage.Text" xml:space="preserve">
    <value>Створити нове зображення...</value>
  </data>
  <data name="btnLoadImageFromClipboard.Text" xml:space="preserve">
    <value>Завантажити з буфера обміну</value>
  </data>
  ...
  <data name="btnLoadImageFromURL.Text" xml:space="preserve">
    <value>Завантажити зображення за посиланням</value>
  </data>
</root>
```
...
---[FILE: EditorStartupForm.vi-VN.resx]---
Location: ShareX-develop/ShareX.ScreenCaptureLib/Forms/EditorStartupForm.vi-VN.resx
...
---[FILE: EditorStartupForm.zh-CN.resx]---
Location: ShareX-develop/ShareX.ScreenCaptureLib/Forms/EditorStartupForm.zh-CN.resx
...
---[FILE: EditorStartupForm.zh-TW.resx]---
Location: ShareX-develop/ShareX.ScreenCaptureLib/Forms/EditorStartupForm.zh-TW.resx
...
---[FILE: FFmpegOptionsForm.ar-YE.resx]---
Location: ShareX-develop/ShareX.ScreenCaptureLib/Forms/FFmpegOptionsForm.ar-YE.resx
...
<root>
  ...
  <data name="btnResetOptions.Text" xml:space="preserve">
    <value>إعادة تعيين الخيارات...</value>
  </data>
  ...
  <data name="$this.Text" xml:space="preserve">
    <value>ShareX - إعدادات تسجيل الشاشة</value>
  </data>
  ...
  <data name="cbx264UseBitrate.Text" xml:space="preserve">
    <value>استخدام معدل البت</value>
  </data>
  <data name="cbCustomCommands.Text" xml:space="preserve">
    <value>استخدام أوامر مخصصة:</value>
  </data>
  <data name="cbUseCustomFFmpegPath.Text" xml:space="preserve">
    <value>استخدام مسارًا مخصصًا لأداة الترميز FFmpeg:</value>
  </data>
  <data name="cbGIFStatsMode.ToolTip" xml:space="preserve">
    <value>الافتراضي كامل.</value>
  </data>
  <data name="cbGIFDither.ToolTip" xml:space="preserve">
    <value>الافتراضي هو sierra2_4a.</value>
  </data>
  <data name="cbx264Preset.ToolTip" xml:space="preserve">
    <value>ترميز أسرع = ملف أكبر
ترميز أبطأ = حجم ملف أصغر
للترميز في الوقت الفعلي قم باختيار أسرع تفضيل ممكن حسب قدرات جهازك.</value>
  </data>
  <data name="pbx264PresetWarning.ToolTip" xml:space="preserve">
    <value>للترميز في الوقت الفعلي قم باختيار أسرع تفضيل ممكن حسب قدرات جهازك.
ما عدا ذلك سيحدث هبوط وفقدان في الإطارات.</value>
  </data>
  <data name="nudXvidQscale.ToolTip" xml:space="preserve">
    <value>أعلى جودة قيمتها 1 وأقل جودة قيمتها 31.</value>
  </data>
  <data name="lblQSVBitrate.Text" xml:space="preserve">
    <value>معدل البِت:</value>
  </data>
  <data name="nudGIFBayerScale.ToolTip" xml:space="preserve">
    <value>تحكم في قيمة مقياس باير، حيث سيعرض المقياس الأعلى المزيد من النطاقات. القيمة الافتراضية هي 2.</value>
  </data>
  <data name="nudx264CRF.ToolTip" xml:space="preserve">
    <value>معامل المعدل الثابت (CRF): يمكن أن تكون القيمة بين 0 و51، حيث 0 تعني عدم الخسارة في الجودة - خام، و30 هو معدل افتراضي، و51 هو أسوأ معدل ممكن.
تعني القيمة الأعلى جودة أقل، ولكن حجم الملف أصغر.</value>
  </data>
  <data name="btnInstallHelperDevices.Text" xml:space="preserve">
    <value>تثبت جهاز تسجيل...</value>
  </data>
  <data name="lblHelperDevices.Text" xml:space="preserve">
    <value>تثبيت "screen-capture-recorder" و مصدر الفيديو والصوت "virtual-audio-capturer" .</value>
  </data>
</root>
```
