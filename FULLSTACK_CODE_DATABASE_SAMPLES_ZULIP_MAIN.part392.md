...
## Verbatim Content (Part 392 of 1290)
...
Location: zulip-main/locale/pt_PT/translations.json
...
```json
{
  ...
  "Don’t allow disposable email addresses": "Não permitir endereços de email descartáveis ou temporários",
  "Download": "Transferir",
  ...
  "Mark topic as read": "Marcar tópico como lido",
  ...
  "New password is too weak!": "Nova palavra-passe demasiado fraca!",
