...
## Verbatim Content (Part 236 of 851)
...
---[FILE: distribute-cache.h]---
Location: ImageMagick-main/MagickCore/distribute-cache.h
...
---[FILE: draw-private.h]---
Location: ImageMagick-main/MagickCore/draw-private.h
  ...
  const ssize_t y,PixelInfo *fill,ExceptionInfo *exception)
{
    ...
    }
  {
    ...
    if (fabs(draw_info->fill_alpha-(double) TransparentAlpha) >= MagickEpsilon)
  ...
  const ssize_t y,PixelInfo *stroke,ExceptionInfo *exception)
{
    ...
    }
  {
    ...
    if (fabs(draw_info->stroke_alpha-(double) TransparentAlpha) >= MagickEpsilon)
