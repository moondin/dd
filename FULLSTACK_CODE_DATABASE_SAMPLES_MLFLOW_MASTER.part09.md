...
## Verbatim Content (Part 9 of 991)
...
Location: mlflow-master/.github/scripts/package-lock.json
...
---[FILE: package.json]---
Location: mlflow-master/.github/scripts/package.json
...
```json
{
  ...
  "main": "dist/bundle.js",
  "scripts": {
    "build": "tsc --noEmit && esbuild src/main.ts --bundle --platform=node --target=node20 --format=cjs --minify --outfile=dist/bundle.js"
  },
  "devDependencies": {
    "@actions/core": "^1.11.1",
    "@actions/github": "^6.0.1",
...
---[FILE: select-reviewers.js]---
Location: mlflow-master/.github/scripts/select-reviewers.js
...
---[FILE: tsconfig.json]---
Location: mlflow-master/.github/scripts/tsconfig.json
...
---[FILE: main.ts]---
Location: mlflow-master/.github/scripts/src/main.ts
