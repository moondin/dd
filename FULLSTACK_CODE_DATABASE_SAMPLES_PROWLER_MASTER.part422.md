...
## Verbatim Content (Part 422 of 867)
...
---[FILE: cis_gcp_test.py]---
Location: prowler-master/tests/lib/outputs/compliance/cis/cis_gcp_test.py
...
class TestGCPCIS:
    def test_output_transform(self):
        ...
        assert output_data.Framework == CIS_2_0_GCP.Framework
        assert output_data.Name == CIS_2_0_GCP.Name
        ...
        assert output_data_manual.Framework == CIS_2_0_GCP.Framework
        assert output_data_manual.Name == CIS_2_0_GCP.Name
    ...
    @mock.patch(
        "prowler.lib.outputs.compliance.cis.cis_gcp.timestamp", "2025-01-01 00:00:00"
    )
...
---[FILE: cis_kubernetes_test.py]---
Location: prowler-master/tests/lib/outputs/compliance/cis/cis_kubernetes_test.py
...
---[FILE: cis_m365_test.py]---
Location: prowler-master/tests/lib/outputs/compliance/cis/cis_m365_test.py
...
class TestM365CIS:
    def test_output_transform(self):
        ...
        assert output_data.Framework == CIS_4_0_M365.Framework
        assert output_data.Name == CIS_4_0_M365.Name
