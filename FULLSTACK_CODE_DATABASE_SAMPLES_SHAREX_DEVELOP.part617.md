...
## Verbatim Content (Part 617 of 650)
...
---[FILE: UploadersConfigForm.ru.resx]---
Location: ShareX-develop/ShareX.UploadersLib/Forms/UploadersConfigForm.ru.resx
...
Например, если ведро называется "bucket.example.com", то ссылка будет "http://bucket.example.com/...".</value>
  ...
  <data name="cbTwitterSkipMessageBox.Text" xml:space="preserve">
    <value>Пропускать окно твита</value>
  </data>
  <data name="lblTwitterDefaultMessage.Text" xml:space="preserve">
    <value>Твит по умолчанию:</value>
  </data>
  ...
  <data name="llAdflyLink.Text" xml:space="preserve">
    <value>Здесь можно найти ваши ключ API и UID</value>
  </data>
  ...
  <data name="lblPolrAPIHostname.Text" xml:space="preserve">
    <value>Имя хоста API: (например, http://example.com/api.php, Оставьте пустым, чтобы использовать polr.me)</value>
  </data>
  ...
  <data name="cbEmailRememberLastTo.Text" xml:space="preserve">
    <value>Помнить адрес последнего получателя</value>
  </data>
  ...
  <data name="lblSeafileAuthToken.Text" xml:space="preserve">
    <value>Ключ авторизации:</value>
  </data>
  <data name="cbSeafileCreateShareableURL.Text" xml:space="preserve">
    <value>Создать публичный URL</value>
  </data>
  ...
  <data name="grpSeafileObtainAuthToken.Text" xml:space="preserve">
    <value>Получить ключ авторизации</value>
  </data>
  ...
  <data name="grpSeafileAccInfo.Text" xml:space="preserve">
    <value>Информация об аккаунте</value>
  </data>
  <data name="lblSeafileSelectLibrary.Text" xml:space="preserve">
    <value>Выберите библиотеку:</value>
  </data>
  ...
  <data name="lblSeafileWritePermNotif.Text" xml:space="preserve">
    <value>Библиотеки без права на запись не отображаются.
Шифрование библиотеки отключает публикацию.</value>
  </data>
  ...
  <data name="lblSeafileDaysToExpire.Text" xml:space="preserve">
    <value>Дней до удаления:</value>
  </data>
  <data name="lblSeafileSharePassword.Text" xml:space="preserve">
    <value>Пароль публикации:</value>
  </data>
  ...
  <data name="lblPomfUploadURL.Text" xml:space="preserve">
    <value>Ссылка для загрузки:</value>
  </data>
  <data name="lblPomfResultURL.Text" xml:space="preserve">
    <value>Ссылка на результат:</value>
  </data>
  <data name="lblLambdaUploadURL.Text" xml:space="preserve">
    <value>URL ссылки:</value>
  </data>
  <data name="lblLambdaApiKey.Text" xml:space="preserve">
    <value>Ключ API:</value>
  </data>
  <data name="lblLambdaInfo.Text" xml:space="preserve">
    <value>Для получения ключа API, войдите в Lambda на https://lambda.sx/, затем нажмите шестеренку настроек вверху справа.</value>
  </data>
  ...
  <data name="lblJiraIssuePrefix.Text" xml:space="preserve">
    <value>Префикс запрос Jira:</value>
  </data>
  ...
  <data name="lblMegaStatus.Text" xml:space="preserve">
    <value>Настроено / Не настроено</value>
  </data>
  ...
  <data name="btnBoxRefreshFolders.Text" xml:space="preserve">
    <value>Обновить список папок</value>
  </data>
  ...
  <data name="cbBoxShare.Text" xml:space="preserve">
    <value>Создать общественную ссылку</value>
  </data>
  <data name="lblBoxFolderTip.Text" xml:space="preserve">
    <value>Заметка: Двойной клин по имени папки откроет ее.</value>
  </data>
  ...
  <data name="lblGoogleDriveFolderID.Text" xml:space="preserve">
    <value>ID папки:</value>
  </data>
  <data name="cbGoogleDriveUseFolder.Text" xml:space="preserve">
    <value>Загружать картинки в выбранную папку</value>
  </data>
  ...
  <data name="$this.Text" xml:space="preserve">
    <value>ShareX - Настройки сервисов</value>
  </data>
  <data name="lvlVgymeUserKey.Text" xml:space="preserve">
    <value>Ключ пользователя:</value>
  </data>
  <data name="llVgymeAccountDetailsPage.Text" xml:space="preserve">
    <value>Вы можете получить ключ пользователя со страницы данных аккаунта.</value>
  </data>
  ...
  <data name="cbCheveretoDirectURL.Text" xml:space="preserve">
    <value>Прямой URL</value>
  </data>
  <data name="lblCheveretoUploadURLExample.Text" xml:space="preserve">
    <value>Пример: http://example.com/api/1/upload</value>
  </data>
  ...
  <data name="lblPicasaAlbumID.Text" xml:space="preserve">
    <value>ID альбома для загрузки (Пусто = не загружать в альбом):</value>
  </data>
  ...
  <data name="gbPhotobucketAlbumPath.Text" xml:space="preserve">
    <value>Загружать картинки в</value>
  </data>
  ...
  <data name="cbImgurUploadSelectedAlbum.Text" xml:space="preserve">
    <value>Загружать картинки в выбранный альбом</value>
  </data>
  <data name="cbImgurUseGIFV.Text" xml:space="preserve">
    <value>Использовать ссылку на GIFV вместо GIF</value>
  </data>
  <data name="gbPhotobucketAlbums.Text" xml:space="preserve">
    <value>Создать новый альбом</value>
  </data>
  <data name="tpTextUploaders.Text" xml:space="preserve">
    <value>Сервисы текстов</value>
  </data>
  ...
  <data name="cbEmailAutomaticSend.Text" xml:space="preserve">
    <value>Отправлять письмо без показа диалога на этот адрес:</value>
  </data>
  ...
  <data name="cbHastebinUseFileExtension.Text" xml:space="preserve">
    <value>Использовать расширение файла для подсветки синтаксиса (кроме .txt)</value>
  </data>
  ...
  <data name="lblGistCustomURLExample.Text" xml:space="preserve">
    <value>Пример: https://api.github.com</value>
  </data>
  <data name="lblGistOAuthInfo.Text" xml:space="preserve">
    <value>Примечание: Учетные записи не поддерживаются для GitHub Enterprise.</value>
  </data>
  ...
  <data name="cbAmazonS3UsePathStyle.Text" xml:space="preserve">
    <value>Использовать запрос в виде пути</value>
  </data>
  ...
  <data name="cbKuttReuse.Text" xml:space="preserve">
    <value>Если URL с указанной ссылкой существует, вернуть его</value>
  </data>
  ...
  <data name="lblB2ApplicationKeyId.Text" xml:space="preserve">
    <value>ID ключа приложения:</value>
  </data>
  <data name="lblB2ApplicationKey.Text" xml:space="preserve">
    <value>Ключ приложения (секрет):</value>
  </data>
  <data name="lblB2Bucket.Text" xml:space="preserve">
    <value>Имя ведра:</value>
  </data>
  <data name="lblB2ManageLink.Text" xml:space="preserve">
    <value>Нажмите здесь, чтобы создать ключ приложения или управлять вашими ведрами.</value>
  </data>
  <data name="cbB2CustomUrl.Text" xml:space="preserve">
    <value>Использовать пользовательский URL (поддерживает формат шаблонов):</value>
  </data>
  ...
  <data name="cbTeknikGenDeleteKey.Text" xml:space="preserve">
    <value>Генерировать ключ для удаления</value>
  </data>
  <data name="cbTeknikEncrypt.Text" xml:space="preserve">
    <value>Шифрование на стороне клиента</value>
  </data>
  ...
  <data name="lblTeknikAuthUrl.Text" xml:space="preserve">
    <value>URL для аутентификаци:</value>
  </data>
  ...
  <data name="cbYouTubeShowDialog.Text" xml:space="preserve">
    <value>Показывать диалог параметров видео</value>
  </data>
