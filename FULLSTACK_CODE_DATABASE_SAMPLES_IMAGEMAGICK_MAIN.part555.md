...
## Verbatim Content (Part 555 of 851)
...
---[FILE: formats.html]---
Location: ImageMagick-main/www/formats.html
...
<head>
  ...
  <!-- Canonical URL -->
  <link rel="canonical" href="formats.html" />
  ...
  <meta property="og:title" content="ImageMagick | Image Formats" />
  ...
  <meta property="og:url" content="../www/formats.html" />
  ...
  <meta name="twitter:title" content="ImageMagick | Image Formats" />
  ...
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <div class="mt-3 ms-3">
      <a href="../index.html" class="text-decoration-none">
        <h1 class="fs-2 mb-1">Image Formats</h1>
      </a>
...
Imagemagick is <a href="../www/high-dynamic-range.html">HDRI</a>-enabled.  Essentially the A and
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    <td><a href="../www/motion-picture.html">DPX</a></td>
    <td>RW</td>
  ...
  <tr>
    ...
    <td>Specify the encoding options with the <a href="command-line-options.html#define">-define</a> option. See <a href="../www/jp2.html">JP2 Encoding Options</a> for more details.</td>
  </tr>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary cli"><samp>magick \( -size 15x15 canvas:black canvas:white -append \) \
  ...
  <tr>
    ...
    <td>MSL is the XML-based scripting language supported by the <a href="../www/conjure.html">conjure</a> utility. MSL requires the <a href="../index.html">libxml2</a> delegate library.</td>
  </tr>
  ...
  <tr>
    <td><a href="https://shirakumo.org/docs/sf3/">SF3</a></td>
    <td>R</td>
    <td>The SF3 image format is part of the Simple File Format Family.</td>
    <td>SF3 is designed to be lightweight and easy to parse, with a human-readable text-based structure that focuses on simplicity over compression. It’s especially useful for fast prototyping or environments where minimal overhead is key.</td>
  </tr>
  ...
  <tr>
    ...
    <td>Used to write HTML clickable image maps based on a the output of <a href="../www/montage.html">montage</a> or a format which supports tiled images such as <a href="#MIFF">MIFF</a>.</td>
  </tr>
  ...
  <tr>
    ...
    <td>Video formats such as APNG, AVI, MP4, WEBM, etc.  Refer to <a href="../www/defines.html">defines</a>  for a description of these defines: <samp>video:intermediate-format</samp>, <samp>video:pixel-format</samp>, and <samp>video:vsync</samp> defines, that can affect the operation on these video formats.</td>
    <td> </td>
  </tr>
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    ...
    <td>Returns a rendered linear or radial top-to-bottom <a href="../www/gradient.html">gradient image</a> using the specified image size.</td>
  ...
  <tr>
    ...
    <td>RW</td>
    <td>NULL image</td>
    <td>Useful for creating blank tiles with <a href="../www/montage.html">montage</a> (use <samp>NULL:</samp>). Also useful as an output format when evaluating image read performance.</td>
  </tr>
  ...
  <tr>
    ...
    <td>Returns a rendered radial top-to-bottom <a href="../www/gradient.html">gradient image</a> using the specified image size.</td>
  </tr>
  ...
  <tr>
    ...
    <td>Also see the <a href="../www/import.html">import</a> and <a href="display.html">display</a>
    programs.</td>
  </tr>
