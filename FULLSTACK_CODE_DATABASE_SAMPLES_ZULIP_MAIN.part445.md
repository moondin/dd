...
## Verbatim Content (Part 445 of 1290)
...
---[FILE: postgresql.conf.template.erb]---
Location: zulip-main/puppet/zulip/templates/postgresql/14/postgresql.conf.template.erb
...
---[FILE: email-mirror.conf.template.erb]---
Location: zulip-main/puppet/zulip/templates/supervisor/email-mirror.conf.template.erb
...
---[FILE: go-camo.conf.erb]---
Location: zulip-main/puppet/zulip/templates/supervisor/go-camo.conf.erb
...
---[FILE: smokescreen.conf.erb]---
Location: zulip-main/puppet/zulip/templates/supervisor/smokescreen.conf.erb
...
---[FILE: supervisord.conf.erb]---
Location: zulip-main/puppet/zulip/templates/supervisor/supervisord.conf.erb
...
minfds=<%= @file_descriptor_limit %> ; file descriptor limit for children
...
[include]
files = <%= @system_conf_dir %>/*.conf <%= @conf_dir %>/*.conf
```

--------------------------------------------------------------------------------

---[FILE: zulip-once.conf.template.erb]---
Location: zulip-main/puppet/zulip/templates/supervisor/zulip-once.conf.template.erb
