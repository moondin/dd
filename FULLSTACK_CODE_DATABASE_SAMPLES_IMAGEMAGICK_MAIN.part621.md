...
## Verbatim Content (Part 621 of 851)
...
---[FILE: pixel-wand.html]---
Location: ImageMagick-main/www/api/pixel-wand.html
...
<head>
  ...
  <meta name="keywords" content="MagickWand, C API: Pixel Wand Methods, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickWand, C API: Pixel Wand Methods</h1>
    </a>
  </header>

  <main class="container">
<h1 class="text-center">Pixel-wand</h1>
<div class="btn-group">
<button class="btn btn-secondary dropdown-toggle" type="button" id="defaultDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
  Select API Method
</button>
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#ClearPixelWand">ClearPixelWand</a></li>
  <li><a href="#ClonePixelWand">ClonePixelWand</a></li>
  <li><a href="#ClonePixelWands">ClonePixelWands</a></li>
  <li><a href="#DestroyPixelWand">DestroyPixelWand</a></li>
  <li><a href="#DestroyPixelWands">DestroyPixelWands</a></li>
  <li><a href="#IsPixelWandSimilar">IsPixelWandSimilar</a></li>
  <li><a href="#IsPixelWand">IsPixelWand</a></li>
  <li><a href="#NewPixelWand">NewPixelWand</a></li>
  <li><a href="#NewPixelWands">NewPixelWands</a></li>
  <li><a href="#PixelClearException">PixelClearException</a></li>
  ...
  <li><a href="#PixelGetColorAsNormalizedString">PixelGetColorAsNormalizedString</a></li>
  ...
  <li><a href="#PixelGetExceptionType">PixelGetExceptionType</a></li>
  <li><a href="#PixelGetFuzz">PixelGetFuzz</a></li>
  <li><a href="#PixelGetGreen">PixelGetGreen</a></li>
  <li><a href="#PixelGetGreenQuantum">PixelGetGreenQuantum</a></li>
  <li><a href="#PixelGetHSL">PixelGetHSL</a></li>
  ...
  <li><a href="#PixelGetMagickColor">PixelGetMagickColor</a></li>
  <li><a href="#PixelGetPixel">PixelGetPixel</a></li>
  <li><a href="#PixelGetQuantumPacket">PixelGetQuantumPacket</a></li>
  <li><a href="#PixelGetQuantumPixel">PixelGetQuantumPixel</a></li>
  ...
  <li><a href="#PixelSetPixelColor">PixelSetPixelColor</a></li>
  <li><a href="#PixelSetQuantumPixel">PixelSetQuantumPixel</a></li>
...
<pre class="bg-light text-dark mx-4"><samp>void ClearPixelWand(PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelWand *ClonePixelWand(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelWand **ClonePixelWands(const PixelWand **wands,
...
<pre class="bg-light text-dark mx-4"><samp>PixelWand *DestroyPixelWand(PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelWand **DestroyPixelWands(PixelWand **wand,
  const size_t number_wands)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType IsPixelWandSimilar(PixelWand *p,PixelWand *q,
  const double fuzz)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType IsPixelWand(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelWand *NewPixelWand(void)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelWand **NewPixelWands(const size_t number_wands)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType PixelClearException(PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>double PixelGetAlpha(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum PixelGetAlphaQuantum(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>double PixelGetBlack(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum PixelGetBlackQuantum(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>double PixelGetBlue(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum PixelGetBlueQuantum(const PixelWand *wand)
</samp></pre>
...
<p>PixelGetColorAsString() returns the color of the pixel wand as a string.</p>

<p>The format of the PixelGetColorAsString method is:</p>

<pre class="bg-light text-dark mx-4"><samp>char *PixelGetColorAsString(PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>char *PixelGetColorAsNormalizedString(PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>size_t PixelGetColorCount(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>double PixelGetCyan(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum PixelGetCyanQuantum(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>char *PixelGetException(const PixelWand *wand,ExceptionType *severity)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ExceptionType PixelGetExceptionType(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>double PixelGetFuzz(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>double PixelGetGreen(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum PixelGetGreenQuantum(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelGetHSL(const PixelWand *wand,double *hue,double *saturation,
  double *lightness)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum PixelGetIndex(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>double PixelGetMagenta(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum PixelGetMagentaQuantum(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelGetMagickColor(PixelWand *wand,PixelInfo *color)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelInfo PixelGetPixel(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelGetQuantumPacket(PixelWand *wand,PixelInfo *packet)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelGetQuantumPixel(const Image *image,const PixelWand *wand,
  Quantum *pixel)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>double PixelGetRed(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum PixelGetRedQuantum(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>double PixelGetYellow(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum PixelGetYellowQuantum(const PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetAlpha(PixelWand *wand,const double alpha)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetAlphaQuantum(PixelWand *wand,const Quantum alpha)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetBlack(PixelWand *wand,const double black)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetBlackQuantum(PixelWand *wand,const Quantum black)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetBlue(PixelWand *wand,const double blue)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetBlueQuantum(PixelWand *wand,const Quantum blue)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType PixelSetColor(PixelWand *wand,const char *color)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetColorCount(PixelWand *wand,const size_t count)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetColorFromWand(PixelWand *wand,const PixelWand *color)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetCyan(PixelWand *wand,const double cyan)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetCyanQuantum(PixelWand *wand,const Quantum cyan)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetFuzz(PixelWand *wand,const double fuzz)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetGreen(PixelWand *wand,const double green)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetGreenQuantum(PixelWand *wand,const Quantum green)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetHSL(PixelWand *wand,const double hue,
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetIndex(PixelWand *wand,const Quantum index)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetMagenta(PixelWand *wand,const double magenta)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetMagentaQuantum(PixelWand *wand,
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetPixelColor(PixelWand *wand,const PixelInfo *color)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetQuantumPixel(const Image *image,const Quantum *pixel,
  PixelWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetRed(PixelWand *wand,const double red)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetRedQuantum(PixelWand *wand,const Quantum red)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetYellow(PixelWand *wand,const double yellow)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetYellowQuantum(PixelWand *wand,const Quantum yellow)
</samp></pre>
