...
## Verbatim Content (Part 121 of 991)
...
---[FILE: index.mdx]---
Location: mlflow-master/docs/docs/genai/prompt-registry/index.mdx
...
---[FILE: log-with-model.mdx]---
Location: mlflow-master/docs/docs/genai/prompt-registry/log-with-model.mdx
...
---[FILE: manage-prompt-lifecycles-with-aliases.mdx]---
Location: mlflow-master/docs/docs/genai/prompt-registry/manage-prompt-lifecycles-with-aliases.mdx
