...
## Verbatim Content (Part 56 of 1290)
...
---[FILE: customer_minimum_licenses_for_plan--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/customer_minimum_licenses_for_plan--Event.list.2.json
      ...
      "data": {
        "object": {
          ...
          "payment_details": {
            ...
            "order_reference": "in_1SVWlwDwzgQ85STgLF0I1o"
          },
    ...
    },
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "customer_minimum_licenses_for_plan--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
          "payment_method_details": {
            "card": {
              "amount_authorized": 72000,
              "authorization_code": "058785",
              "brand": "visa",
              "checks": {
              ...
              "overcapture": {
                "maximum_amount_capturable": 72000,
                "status": "unavailable"
              },
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "customer_minimum_licenses_for_plan--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
