...
## Verbatim Content (Part 406 of 1290)
...
Location: zulip-main/locale/sr/translations.json
...
```json
{
  ...
  "Desktop notifications": "Обавештења за стоне рачунаре",
  ...
  "Mark topic as read": "Означи тему као прочитану",
  ...
  "{count, plural, one {# message} other {# messages}} will be moved.": "{count, plural, one {# порука} few {# порука} other {# порука}} will be moved.",
