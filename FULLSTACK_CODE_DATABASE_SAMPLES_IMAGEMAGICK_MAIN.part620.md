...
## Verbatim Content (Part 620 of 851)
...
---[FILE: pixel-iterator.html]---
Location: ImageMagick-main/www/api/pixel-iterator.html
...
<head>
  ...
  <meta name="keywords" content="MagickWand, C API: Pixel Iterator Methods, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickWand, C API: Pixel Iterator Methods</h1>
    </a>
  </header>

  <main class="container">
<h1 class="text-center">Pixel-iterator</h1>
<div class="btn-group">
<button class="btn btn-secondary dropdown-toggle" type="button" id="defaultDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
  Select API Method
</button>
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#ClearPixelIterator">ClearPixelIterator</a></li>
  <li><a href="#ClonePixelIterator">ClonePixelIterator</a></li>
  <li><a href="#DestroyPixelIterator">DestroyPixelIterator</a></li>
  <li><a href="#IsPixelIterator">IsPixelIterator</a></li>
  <li><a href="#NewPixelIterator">NewPixelIterator</a></li>
  <li><a href="#PixelClearIteratorException">PixelClearIteratorException</a></li>
  <li><a href="#NewPixelRegionIterator">NewPixelRegionIterator</a></li>
  <li><a href="#PixelGetCurrentIteratorRow">PixelGetCurrentIteratorRow</a></li>
  <li><a href="#PixelGetIteratorException">PixelGetIteratorException</a></li>
  <li><a href="#PixelGetIteratorExceptionType">PixelGetIteratorExceptionType</a></li>
  <li><a href="#PixelGetIteratorRow">PixelGetIteratorRow</a></li>
  <li><a href="#PixelGetNextIteratorRow">PixelGetNextIteratorRow</a></li>
  <li><a href="#PixelGetPreviousIteratorRow">PixelGetPreviousIteratorRow</a></li>
  <li><a href="#PixelResetIterator">PixelResetIterator</a></li>
  <li><a href="#PixelSetFirstIteratorRow">PixelSetFirstIteratorRow</a></li>
  <li><a href="#PixelSetIteratorRow">PixelSetIteratorRow</a></li>
  <li><a href="#PixelSetLastIteratorRow">PixelSetLastIteratorRow</a></li>
</ul>
</div>
<br/>
<br/>
...
<pre class="bg-light text-dark mx-4"><samp>void ClearPixelIterator(PixelIterator *iterator)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelIterator *ClonePixelIterator(const PixelIterator *iterator)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelIterator *DestroyPixelIterator(PixelIterator *iterator)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType IsPixelIterator(const PixelIterator *iterator)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelIterator *NewPixelIterator(MagickWand *wand)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType PixelClearIteratorException(PixelIterator *iterator)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelIterator *NewPixelRegionIterator(MagickWand *wand,const ssize_t x,
...
<pre class="bg-light text-dark mx-4"><samp>PixelWand **PixelGetCurrentIteratorRow(PixelIterator *iterator,
  size_t *number_wands)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>char *PixelGetIteratorException(const PixelIterator *iterator,
...
<pre class="bg-light text-dark mx-4"><samp>ExceptionType PixelGetIteratorExceptionType(
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType PixelGetIteratorRow(PixelIterator *iterator)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelWand **PixelGetNextIteratorRow(PixelIterator *iterator,
  size_t *number_wands)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>PixelWand **PixelGetPreviousIteratorRow(PixelIterator *iterator,
  size_t *number_wands)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelResetIterator(PixelIterator *iterator)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetFirstIteratorRow(PixelIterator *iterator)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType PixelSetIteratorRow(PixelIterator *iterator,
  const ssize_t row)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PixelSetLastIteratorRow(PixelIterator *iterator)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType PixelSyncIterator(PixelIterator *iterator)
</samp></pre>
