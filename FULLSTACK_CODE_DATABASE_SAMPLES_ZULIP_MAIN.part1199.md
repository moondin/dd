...
## Verbatim Content (Part 1199 of 1290)
...
---[FILE: view.py]---
Location: zulip-main/zerver/webhooks/gitlab/view.py
...
---[FILE: build_created.json]---
Location: zulip-main/zerver/webhooks/gitlab/fixtures/build_created.json
...
---[FILE: build_started.json]---
Location: zulip-main/zerver/webhooks/gitlab/fixtures/build_started.json
...
```json
{
   ...
   "build_started_at":"2016-09-28 20:21:04 UTC",
   "build_finished_at":null,
   "build_duration":0.159148421,
   "build_allow_failure":true,
   "project_id":1740047,
   "project_name":"Tomasz Kolek / my-awesome-project",
   "user":{
...
---[FILE: build_succeeded.json]---
Location: zulip-main/zerver/webhooks/gitlab/fixtures/build_succeeded.json
...
---[FILE: deployment_hook__canceled.json]---
Location: zulip-main/zerver/webhooks/gitlab/fixtures/deployment_hook__canceled.json

```json
{
    "object_kind": "deployment",
    "status": "canceled",
    "status_changed_at": "2025-05-02 12:36:52 +0000",
    "deployment_id": 988610373,
    "deployable_id": 9905830127,
    "deployable_url": "https://gitlab.com/vedant8600317/test/-/jobs/9905830127",
    ...
    "commit_url": "https://gitlab.com/vedant8600317/test/-/commit/c3cf29e88c1b0a8a60df37f4687dd5060955d2ae",
...
---[FILE: deployment_hook__failed.json]---
Location: zulip-main/zerver/webhooks/gitlab/fixtures/deployment_hook__failed.json

```json
{
    "object_kind": "deployment",
    "status": "failed",
    "status_changed_at": "2025-05-02 12:30:19 +0000",
    "deployment_id": 988604916,
    "deployable_id": 9905759933,
    "deployable_url": "https://gitlab.com/vedant8600317/test/-/jobs/9905759933",
    "environment": "production",
    "environment_tier": "production",
    "environment_slug": "production",
    "environment_external_url": null,
    ...
    "user_url": "https://gitlab.com/theofficialvedantjoshi",
    "commit_url": "https://gitlab.com/vedant8600317/test/-/commit/846d8de0b7b3d694954249d2fd5d87fbe8c84e4c",
    "commit_title": "Update .gitlab-ci.yml file",
    "ref": "master"
}
```
...
---[FILE: deployment_hook__running.json]---
Location: zulip-main/zerver/webhooks/gitlab/fixtures/deployment_hook__running.json

```json
{
    "object_kind": "deployment",
    "status": "running",
    "status_changed_at": "2025-05-02 11:54:46 +0000",
...
---[FILE: deployment_hook__success.json]---
Location: zulip-main/zerver/webhooks/gitlab/fixtures/deployment_hook__success.json
