...
## Verbatim Content (Part 336 of 1290)
...
Location: zulip-main/locale/fr/translations.json
...
```json
{
  ...
  "<kbd>Enter</kbd> sends when composing a message": "<kbd>Entrée</kbd> envoyer en composant un message",
  ...
  "<z-link>Learn more.</z-link>": "<z-link>En savoir plus.</z-link>",
  "<z-link>Learn more</z-link> about other data export options.": "<z-link>En savoir plus.</z-link> sur les autres options d'export de données.",
  ...
  "A deactivated user group with this name already exists.": "Un groupe d'utilisateur désactivé avec ce nom existe déjà.",
  ...
  "A public data export is a complete data export for your organization other than <z-private-channel-link>private channel</z-private-channel-link> messages and <z-direct-messages-link>direct messages</z-direct-messages-link>.": "Un export de données publiques est un export complet de votre organisation hormis <z-private-channel-link>les messages du canal privé </z-private-channel-link> <z-direct-messages-link> et les messages directs </z-direct-messages-link>.",
  "A standard export additionally includes private data accessible to users who have allowed administrators to export their private data.": "Un export standard addionnel inclus les données privées accessibles aux utilisateurs qui autorisent les administrateurs à exporter leurs données privées.",
  "A to-do list must be an entire message.": "Une liste de tâches doit être un message entier",
  ...
  "AI summaries are not available on Zulip Cloud yet.": "La concatenation AI n'est pas encore valable sur le Cloud Zulip.",
  "AI summaries are not enabled on this server.": "La concaténation AI n'est pas activée sur ce serveur.",
  "AI summaries may have errors.": "la concaténation AI peut avoir des erreurs.",
  ...
  "Active and deactivated": "Actif et désactivé",
  ...
  "Add members to {group_name}": "Ajouter des membres à {group_name}",
  ...
  "Add roles, groups or users": "Ajouter des rôles, groupes ou utilisateurs",
  "Add saved snippet": "",
  ...
  "Error editing message": "Erreur durant l\\'édition du message",
  ...
  "Error removing user from this channel.": "Erreur lors de la suppression de l'utilisateur de ce canal.",
  ...
  "Escape key navigates to home view": "La touche Echap permet de revenir à la vue d'accueil",
  ...
  "Filter default channels": "Filtrer les canaux par défaut",
  ...
  "For more examples and technical details, see the <z-link>help center documentation</z-link> on adding code playgrounds.": "Pour plus d'exemples et de détails techniques, voir la <z-link>documentation du centre d'aide</z-link> sur l'ajout de terrains de jeu de code.",
  "For more examples, see the <z-link>help center documentation</z-link> on adding linkifiers.": "Pour plus d'exemples, voir la <z-link>documentation du centre d'aide</z-link> sur l'ajout de linkifiers.",
  "Forgot it?": "Oublié ?",
  ...
  "Mark topic as read": "Marquer le sujet comme lu",
  ...
  "Narrow to direct messages that include <z-value></z-value>.": "Se limiter aux messages directs qui comprennent<z-value></z-value> .",
  ...
  "Notify topic": "Notifier le sujet",
  "November": "Novembre",
  ...
  "Only topics you follow": "Seulement les sujets que vous suivez",
  ...
  "Outgoing webhook": "Webhook sortant",
  ...
  "Pin channel to top": "Épingler le canal en haut",
  "Pin channel to top of left sidebar": "Épingler le canal en haut de la barre latérale",
  "Plan management": "",
  ...
  "Please select a channel.": "Veuillez spécifier un canal.",
  ...
  "Reply @-mentioning sender": "Réponse @-mentionner l'expéditeur",
  "Reply directly to sender": "Répondre directement à l'envoyeur",
  ...
  "Resolved topics": "",
  "Restrict email domains of new users": "Restreindre les suffixes emails des nouveaux utilisateurs",
  ...
  "Scroll through channels": "Défiler à travers les canaux",
  ...
  "Subscribe to/unsubscribe from selected channel": "S'abonner / désabonner du canal sélectionné",
  "Subscribe {full_name} to channels": "Abonner {full_name} aux canaux",
  "Subscribed": "Abonné",
  "Subscribed channels": "Canaux abonnés",
  ...
  "The channel description cannot contain newline characters.": "La description du canal ne peut pas contenir de retour à la ligne.",
  ...
  "There are no channels you can view in this organization.": "Il n'y a pas de canal que vous pouvez visualiser dans cette organisation.",
  ...
  "Time limit for moving messages between channels": "Limite de temps pour le déplacement des messages entre les canaux",
  ...
  "Topics I start": "Sujets que je commence",
  ...
  "Unpin channel from top": "Désépingler le canal du haut",
  "Unread": "Non lus",
  ...
  "Use channel settings to unsubscribe from private channels.": "Utilisez les paramètres des canaux pour vous désabonner de canaux privés.",
  ...
  "Welcome to Zulip!": "Bienvenue sur Zulip !",
  ...
  "Who can create private channels": "Qui peut créer des canaux privés",
  "Who can create public channels": "Qui peut créer des canaux publics",
  "Who can create reusable invitation links": "",
  "Who can create user groups": "",
  "Who can create web-public channels": "Qui peut créer des canaux publics Web",
  ...
  "You and": "Vous et",
  "You and <z-user-names></z-user-names>": "Vous et <z-user-names></z-user-names>",
  ...
  "You are not subscribed to any channels.": "Vous n'êtes abonné à aucun canal.",
  ...
  "You do not have permission to add other users to channels in this organization.": "Vous n'avez pas la permission d'ajouter des autres utilisateurs à ce canal.",
  ...
  "You do not have permission to post in this channel.": "Vous n'êtes pas autorisé à publier dans ce canal.",
  ...
  "You have no unread messages in followed topics.": "Vous n'avez pas de messages non lus dans les sujets suivis.",
  ...
  "You might be interested in <z-link>recent conversations</z-link>.": "Les <z-link>conversations récentes</z-link> pourraient vous intéresser.",
  ...
  "You're not subscribed to this channel. You will not be notified if other users reply to your message.": "Vous n'êtes pas abonnés à ce canal. Vous ne recevrez pas de notification en cas de réponse des autres utilisateurs à votre message.",
  ...
  "Your message was sent to a channel you have muted.": "Votre message a été envoyé à un canal que vous avez mis en sourdine.",
  ...
  "Zoom to message in conversation context": "Voir le message dans le contexte de la conversation",
  "Zulip": "Zulip",
  ...
  "general chat": "",
  "group direct messages with {recipient}": "messages directs de groupe avec {récipient}",
  "guest": "",
  "he/him": "il/lui",
  "hours": "",
  ...
  "{count, plural, one {# message} other {# messages}} will be moved.": "{count, plural, one {# message} many {# messages} other {# messages}} will be moved.",
