...
## Verbatim Content (Part 535 of 991)
...
---[FILE: parallelCoordinatesPlot.utils.ts]---
Location: mlflow-master/mlflow/server/js/src/experiment-tracking/components/runs-charts/utils/parallelCoordinatesPlot.utils.ts
...
---[FILE: runsCharts.const.ts]---
Location: mlflow-master/mlflow/server/js/src/experiment-tracking/components/runs-charts/utils/runsCharts.const.ts
...
---[FILE: parcoord-es.d.ts]---
Location: mlflow-master/mlflow/server/js/src/experiment-tracking/components/runs-compare/parcoord-es.d.ts

```typescript
declare module 'parcoord-es';
```
