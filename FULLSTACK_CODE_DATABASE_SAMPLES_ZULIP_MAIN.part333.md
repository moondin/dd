...
## Verbatim Content (Part 333 of 1290)
...
Location: zulip-main/locale/fi/translations.json
...
```json
{
  ...
  "<kbd>Enter</kbd> sends when composing a message": "<kbd>Enter</kbd> lähettää viestin kirjoitettaessa",
  ...
  "<strong>{name}</strong> <i>(guest)</i> is not subscribed to this channel. They will not be notified if you mention them.": "<strong>{name}</strong> <i>(vieras)</i> ei ole kanavalla, eikä hänelle lähetetä ilmoitusta maininnasta.",
  ...
  "A deactivated user group with this name already exists.": "Deaktivoitu käyttäjäryhmä tällä nimellä on jo olemassa.",
  ...
  "AI summaries are not enabled on this server.": "Tekoäly-yhteenvetoja ei ole tällä palvelimella.",
  "AI summaries may have errors.": "Tekoäly-yhteenvedoissa on virheitä.",
  ...
  "Action": "Toiminto",
  "Action message": "Toimintaviesti",
  "Actions": "Toiminnot",
  "Active an hour ago": "Aktiivinen tunti sitten",
  "Active and deactivated": "aktiivinen ja deaktivoitu",
  ...
  "Add a new channel folder": "Lisää uusi kanavakansio",
  ...
  "Add members to {group_name}": "Lisää jäseniä ryhmään {group_name}",
  ...
  "Add roles, groups or users": "Lisää rooleja, ryhmiä tai jäseniä",
  ...
  "Add user groups": "Lisää käyttäjäryhmiä",
  "Add users or groups. Use #channelname to add all subscribers.": "Lisää käyttäjiä tai ryhmiä. Käytä #kanavannimeä kaikille tilaajille.",
  ...
  "All unread conversations are hidden. Click on a section, folder, or channel to expand it.": "Kaikki lukemattomat keskustelut on piilotettu. Klikkaa osiota, kansiota, tai kanavaa sen laajentamiseksi.",
  ...
  "Already at default line spacing": "Jo sama kuin oletusriviväli",
  "Already at maximum font size ({maximum_value})": "Jo sama kuin suurin sallittu fontin koko ({maximum_value})",
  "Already at maximum line spacing": "Jo sama kuin suurin riviväli",
  "Already at minimum font size ({minimum_value})": "Jo sama kuin pienin sallittu fontin koko ({minimum_value})",
  "Already at minimum line spacing": "Jo sama kuin pienin riviväli",
  "Already below recommended minimum font size ({minimum_value})": "Jo pienempi kuin pienin sallittu fontin koko ({minimum_value})",
  "Already below recommended minimum line spacing": "Jo pienempi kuin pienin sallittu riviväli",
  ...
  "An archived channel with this name already exists.": "Arkistoitu kanava tällä nimellä on jo olemassa.",
  ...
  "Anyone can add more tasks after the to-do list is posted.": "Kuka tahansa voi lisätä tehtäviä todo-listaan kun se on lähetetty.",
  "Anyone on the internet can view messages; members of your organization can join.": "Kuka tahansa internetissä voi lukea viestit, organisaation jäsenet voivat liittyä.",
  "App theme": "App-teema",
  "April": "Huhtikuu",
  "Archive <z-link></z-link>?": "Arkistoi <z-link></z-link>?",
  "Archive channel": "Arkistoitu kanava",
  "Archived and non-archived": "Arkistoitu ja arkistoimaton",
  "Archived channels": "Arkistoidut kanavat",
  "Archiving this channel will:": "Kanavan arkistointi:",
  ...
  "Are you sure you want to deactivate this organization? All users will lose access to their Zulip accounts.": "Oletko varma, että haluat poistaa tämän organisaation käytöstä? Kaikki sen käyttäjät menettävät Zulip-tilinsä.",
  ...
  "Are you sure you want to mute <z-highlight>{user_name}</z-highlight>?  Messages sent by muted users will never trigger notifications, will be marked as read, and will be hidden.": "Haluatko hiljentää käyttäjän <z-highlight>{user_name}</z-highlight>?  Hiljennettyjen käyttäjien viestit eivät triggeröi notifikaatioita, ne merkitään luetuiksi ja piilotetaan.",
  ...
  "At least {count, plural, one {# message} other {# messages}} will be moved.": "Ainakin {count, plural, one {# message} other {# messages}} siirretään.",
  ...
  "Automatically follow topics based on my participation": "Automaattisesti seuraa aiheita joihin otan osaa",
  ...
  "BROWSE {can_subscribe_stream_count} MORE CHANNELS": "SELAA {can_subscribe_stream_count} KANAVAA LISÄÄ",
  ...
  "Cannot save invalid message retention period.": "Ei voida tallentaa virheellistä viestinsäulytysjaksoa.",
  ...
  "Change to default line spacing": "Vaihda oletusriviväliä",
  "Change to font size {new_value}": "Vaihda fontin kooksi {new_value}",
  "Change to {new_value_string} line spacing": "Vaihda riviväliksi {new_value_string}",
  "Change your email": "Vaihda sähköpostiasi",
  "Change your password": "Vaihda salasanaasi",
  "Channel": "Kanava",
  "Channel <z-link>#{stream_name}</z-link> created!": "Kanava <z-link>#{stream_name}</z-link> luotu!",
  "Channel ID": "Kanavan tunniste",
  "Channel color": "Kanavan väri",
  "Channel created recently": "Kanava luotiin hiljattain",
  "Channel created!": "Kanava luotu.",
  ...
  "Channels": "Kanavat",
  "Channels in this folder will become uncategorized.": "Kanavia tässä kansiossa tulee muuttumaan kategorisoimattomiksi.",
  "Channels organize conversations based on who needs to see them.": "Keskustelut on järjestetty kanaville sen perusteella ketkä voivat nähdä ne.",
  "Channels they should join": "Kanavat joille heidät liitetään",
  "Check all": "Valitse kaikki",
  "Check your email (<b>{email}</b>) to confirm the new address.": "Tarkasta sähköposti (<b>{email}</b>) ja vahvista uusi osoite.",
  ...
  "Click <z-icon-inbox></z-icon-inbox> <z-highlight>Inbox</z-highlight> in the left sidebar.": "Klikkaa <z-icon-inbox></z-icon-inbox> <z-highlight>Saapuneet</z-highlight> vasemassa palkissa.",
  "Click <z-icon-recent></z-icon-recent> <z-highlight>Recent conversations</z-highlight> in the left sidebar.": "Klikkaa <z-icon-recent></z-icon-recent> <z-highlight>Hiljattaiset keskustelut</z-highlight> vasemassa sivupalkissa.",
  ...
  "Click the name of a channel in the left sidebar, and click on any topic underneath to view one conversation at a time. You can explore discussions of changes to the design of the Zulip app in <z-highlight>#design</z-highlight>, or see ongoing issue investigations in <z-highlight>#issues</z-highlight>.": "Klikkaa kanavan nimeä vasemassa sivupalkissa, ja sitten aihetta sen alla nähdäksesi keskusteluja yksi kerrallaan. Voit tutkiskella keskusteluja Zulipin designmuutoksista kanavalla <z-highlight>#design</z-highlight> tai tuoreista ongelmista aiheessa <z-highlight>#issues</z-highlight>.",
  "Click to unmute this channel.": "Klikkaa poistaaksesi kanavan hiljennys.",
  ...
  "Complete your organization profile, which is displayed on your organization's registration and login pages.": "Täydennä organisaation profiili, josta näkyy organisaation rekisteröinti- ja kirjautumissivut.",
  "Compose a message.": "Kirjoita viesti.",
  ...
  "Configure new channel settings": "Muuta uuden kanavan asetuksia",
  "Configure new group settings": "Muuta uuden ryhmän asetuksia",
  "Configure outgoing mail": "Aseta ulosmenevä sähköposti",
  ...
  "Consider <z-link>searching all public channels that you can view</z-link>.": "Harkitse <z-link>hakua kaikilta julkisilta kanavila jotka voit nähdä</z-link>.",
  ...
  "Copy draft": "Kopioi luonnos",
  "Copy email": "Kopio sähköposti",
  "Copy email address": "Kopioi sähköpostiosoite",
  "Copy link": "Kopioi linkki",
  "Copy link to channel": "Kopioi linkki kanavaan",
  ...
  "Could not update time zone": "Ei voitu päivittää aikavyöhykkeitä",
  "Create": "Luo",
  "Create a channel": "Tee kanava",
  "Create a collaborative to-do list": "Tee yhteistyössä todo-lista",
  "Create a new saved snippet": "Luo tallennettu leike",
  ...
  "Currently viewing all direct messages.": "Näytetään kaikki yksityisviestit.",
  ...
  "DMs, mentions, and alerts": "YVt, maininnat ja hälytykset",
  ...
  "Data will be deleted after {date}": "Data poistetaan ajalla {date}",
  "Data will be deleted immediately": "Data poistetaan välittömästi",
  "Data will not be automatically deleted": "Dataa ei poisteta",
  ...
  "Deactivate group": "Deaktivoi ryhmä",
  ...
  "Deactivate {group_name}?": "Deaktivoidaanko {group_name}?",
  "Deactivate {name}?": "Deaktivoidaanko {name}?",
  "Deactivated": "Poistettu käytöstä",
  "Deactivated groups": "Deaktivoidut ryhmät",
  ...
  "Delete channel folder?": "Poistetaanko kanavakansio?",
  ...
  "Delete snippet": "Poista leike",
  "Delete topic": "Poista aihe",
  "Delete uploaded files?": "Poistetaanko ladatut tiedostot?",
  "Deleted": "Poistettu",
  ...
  "Desktop notifications": "Työpöytäilmoitukset",
  ...
  "Direct message permissions": "Yksityisviesti oikeudet",
  "Direct message to me": "Suorat viestit minulle",
  "Direct messages": "Yksityisviestit",
  "Direct messages are disabled in this organization.": "Yksityisviestit on poistettu käytöstä tässä organisaatiossa.",
  "Disable": "Poista käytöstä",
  "Disable announcements that are currently sent to this channel:": "Poista käytöstä julkaisut jotka on lähetetty tälle kanavalle:",
  ...
  "Display availability to other users": "Näytä tila muille käyttäjille",
  ...
  "Don't group channels by folder": "Älä ryhmittele kanavia kansioihin",
  ...
  "Download the latest version": "Lataa tuorein versio",
  ...
  "EDITED": "MUOKATTU",
  "Each conversation is <z-highlight>labeled with a topic</z-highlight> by the person who started it.": "Jokainen keskustelu on <z-highlight>merkitty aiheella</z-highlight> sen henkilön toimesta joka sen aloitti.",
  "Edit": "Muokkaa",
  "Edit #{channel_name}": "Muokkaa #{channel_name}",
  "Edit #{stream_name} (<i>archived</i>)": "Muokkaa kanavaa #{stream_name} (<i>arkistoitu</i>)",
  "Edit channel folder": "Muokkaa kanavakansiota",
  ...
  "Edit saved snippet": "Muokkaa tallennettu leike",
  ...
  "Embedded bot": "Sisäänrakennettu botti",
  "Emoji": "Emoji",
  "Emoji name": "Emojin nimi",
  "Emoji reactions to your messages.": "Emojireaktiot viestiisi.",
  ...
  "Error creating channel: A channel with this name already exists.": "Virhe kanavan luonnissa: Samanniminen kanava on jo olemassa.",
  ...
  "Error removing user from group {group_name}": "Virhe poistettaessa käyttäjää ryhmästä {group_name}",
  ...
  "Error sending message": "Virhe viestiä lähetettäessä",
  ...
  "Everyone": "Kaikki",
  "Everyone except guests": "Kaikki paitsi vieraat",
  "Everyone including guests": "Kaikki mukaanlukien vieraat",
  ...
  "Export permissions": "Vientioikeudet",
  "Export started. Check back in a few minutes.": "Tiedonpoiminta alkoi. Palaa takaisin tovin päästä.",
  "Export type": "Vientityyppi",
  "Exporting private data for {users_consented_for_export_count, plural, one {# user} other {# users}} ({total_users_count, plural, one {# user} other {# users}} total).": "Viedään yksityistä dataa {users_consented_for_export_count, plural, one {# user} other {# users}} ({total_users_count, plural, one {# user} other {# users}} total).",
  "External account type": "Ulkoinen tilityyppi",
  "Failed": "Epäonnistunut",
  "Failed adding one or more channels.": "Kanavien lisäys epäonnistui.",
  "Failed removing one or more channels from the folder": "Epäonnistuttiin yhden tai useamman kanavan poistamisessa kansiosta",
  ...
  "Failed: Invalid Pattern": "Epäonnistui: epäkelpo kuvio",
  ...
  "Filter invitations": "Filtteröi kutsut",
  "Filter left sidebar": "Filtteröi vasen sivupalkki",
  ...
  "Go to #{channel_name} &gt; <z-topic-display-name></z-topic-display-name>": "Siirry #{channel_name} &gt; <z-topic-display-name></z-topic-display-name>",
  "Go to #{display_recipient}": "Mene kohteeseen #{display_recipient}",
  "Go to #{display_recipient} > {topic_display_name}": "Siirry #{display_recipient} > {topic_display_name}",
  "Go to channel feed": "Mene kanavasyötteeseen",
  "Go to channel feed from topic view": "Siirry kanavasyötteeseen aihenäkymästä",
  ...
  "Go to recent conversations": "Siirry uusiin keskusteluihin",
  "Go to starred messages": "Siirry tähdellisiin viestihin",
  "Go to the conversation you are composing to": "Mene keskusteluun johon kirjoitat viestiä",
  "Go to topic or DM conversation": "Siirry aiheeseen tai YV-keskusteluun",
  "Go to your home view": "Mene kotinäkymään",
  "Go to {recipient_text}": "Siirry {recipient_text}",
  "Got it": "Ymmärsin",
  "Got it — Cancel": "Saatu – peru",
  "Got it — Confirm": "Saatu – vahvista",
  "Government": "Hallitus",
  "Granted": "Hyväksytty",
  "Group channels by folder": "Ryhmittele kanavat kansioihin",
  "Group channels by folder in the left sidebar": "Ryhmittele kanavat vasempaan sivupalkkiin",
  ...
  "If you have any questions, please post in the <z-highlight>#user questions</z-highlight> channel, and we'll be happy to help.": "Jos sinulla on kysymyksiä, niitä voi lähettää kanavalle <z-highlight>#user questions</z-highlight>, ja sieltä saanee apua.",
  ...
  "Inbox": "Saapuneet",
  "Inbox options": "Saapuneet asetukset",
  "Include DMs": "Sisällytä YVt",
  "Include content of direct messages in desktop notifications": "Sisällytä yksityisviestin sisältö työpöytäilmoituksessa",
  ...
  "Increase line spacing": "Kasvata riviväliä",
  "Information": "Informaatio",
  "Initiate a search": "Aloita haku",
  "Insecure desktop app": "Epäturvallinen työpöytäsovellus",
  ...
  "Invite to organization": "Kutsu organisaatioon",
  ...
  "Join group?": "Liitytäänkö ryhmään?",
  ...
  "Joining and viewing messages requires being invited": "Ryhmään liittyminen ja viestien lukeminen vaatii kutsua",
  ...
  "LOG IN TO BROWSE MORE": "KIRJAUDU SISÄÄN SELATAKSESI LISÄÄ",
  "Label": "Kentän nimi",
  "Language": "Kieli",
  ...
  "Last edited {edited_time_string}.": "Viimeksi muokattu {edited_time_string}.",
  "Last message": "Viimeisin viesti",
  "Last modified": "Viimeksi muokattu",
  "Last moved {moved_time_string}.": "Viimeksi siirretty {moved_time_string}.",
  "Learn more": "Lisätietoja",
  "Learn more about emoji reactions <z-link>here</z-link>.": "Opi lisää emojireaktioista <z-link>täällä</z-link>.",
  "Learn where to find everything you need to get started with this 2-minute video tour.": "Opi lisää mistä löydät kaikkea mitä tarvitset tällä 2 minuutin videokiertueella.",
  ...
  "Let administrators export my private data": "Anna ylläpitäjien exportata yksityiset tietoni",
  ...
  "Let recipients see when a user is typing direct messages": "Salli vastaanottajien nähdä kun käyttäjä kirjoittaa yksityisviestiä",
  "Let's go!": "Mennään!",
  "Light": "Vaalea",
  ...
  "Make <z-highlight>combined feed</z-highlight> my home view": "Tee <z-highlight>yhdistellystä syötteestä</z-highlight> kotinäkymä",
  "Make <z-highlight>inbox</z-highlight> my home view": "Tee <z-highlight>saapuneista</z-highlight> kotinäkymä",
  "Make <z-highlight>recent conversations</z-highlight> my home view": "Tee <z-highlight>hiljattaisista viesteistä</z-highlight> kotinäkymä",
  ...
  "Matching Zulip channel": "Täsmäävä Zulip-kanava",
  "Math (LaTeX)": "Matematiikka (LaTeX)",
  "Maximize compose box": "Maksimoi syöttölaatikko",
  "Maximum message length: {max_length} characters": "Viestin enimmäiskoko: {max_length} merkkiä",
  "Maximum message length: {max_message_length} characters": "Viestin enimmäispituus: {max_message_lenght} merkkiä",
  "Maximum password length: {max_length} characters.": "Salasanan enimmäiskoko: {max_length} merkkiä.",
  "Maximum password length: {max} characters.": "Salasanan enimmäiskoko: {max} merkkiä.",
  "May": "Toukokuu",
  "Me": "Minä",
  "Member": "Jäsen",
  "Members": "Jäsenet",
  "Members of your organization can view messages and join": "Organisaation jäsenet voivat lukea ja liittyä",
  "Members preview": "Jäsenesikatselu",
  ...
  "Message <z-recipient-label></z-recipient-label>": "Viesti <z-recipient-label></z-recipient-label>",
  "Message actions": "Viestitoiminnot",
  "Message deletion": "Viestien poisto",
  "Message edit and move history": "Viestin muokkaus- ja siirtohistoria",
  "Message edit history": "Viestin muokkaushistoria",
  "Message editing": "Viestin muokkaaminen",
  "Message feed settings": "Viestisyöteasetukset",
  ...
  "Message sender <z-user-names></z-user-names> is not subscribed to <z-stream></z-stream>.": "Viestin lähettäjä <z-user-names></z-user-names> ei ole kirjautunut kanavalle <z-stream></z-stream>.",
  "Message text": "Viestin teksti",
  ...
  "Messages in all public channels that you can view": "Viestit julkisilla kanvilla, joita voit lukea",
  "Messages in all web-public channels": "Viestit web-julkisilla kanavilla",
  ...
  "Messages with yourself": "Viestit itsellesi",
  "Messages you sent": "Lähettämäsi viestit",
  "Messaging permissions": "Viestioikeudet",
  "Mobile": "Mobiili",
  ...
  "Moderation permissions": "mYlläpito-oikeudet",
  "Moderator": "Moderaattori",
  "Moderators": "Moderaattorit",
  "Monday": "Maanantai",
  "Monday at {time}": "Maanantaina {time}",
  "Move <z-stream-or-topic></z-stream-or-topic>": "Siirrä <z-stream-or-topic></z-stream-or-topic>",
  "Move all messages in this topic": "Siirrä kaikki viestit tässä aiheessa",
  "Move history only": "Siirrä vain historia",
  "Move message": "Siirrä viesti",
  "Move messages": "Siirrä viestit",
  "Move messages from <z-stream-or-topic></z-stream-or-topic>": "Siirrä viestit kohteesta <z-stream-or-topic></z-stream-or-topic>",
  ...
  "Name the task before adding.": "Nimeä tehtävä ennen lisäystä.",
  ...
  "Narrow to messages in followed topics.": "Rahaa viesteihin seuratuissa aiheissa.",
  "Narrow to messages in resolved topics.": "Rajaa hakua viesteihin, jotka on merkitty ratkaistuksi.",
  "Narrow to messages in unresolved topics.": "Rajaa viesteihin ratkaisemattomissa aiheissa.",
  ...
  "Narrow to messages with emoji reactions.": "Rajaa viesteihin emojireaktioiden kanssa.",
  "Narrow to messages with topic <z-value></z-value>.": "Rajaa hakua viesteihin, joissa aiheena on <z-value></z-value>.",
  "Narrow to muted messages.": "Rajaa hiljennettyihin viesteihin.",
  ...
  "No DM recipients": "Ei YV-vastaanottajaa",
  "No bots match your current filter.": "Yksikään botti ei vastaa nykyistä suodatinta.",
  "No channel folders configured.": "Ei kanavakansioita asetettuna.",
  "No channel selected": "",
  ...
  "No channels match your filter.": "Ei kanavia jotka vastaavat suodatinta.",
  "No channels to show.": "Ei kanavia näytettäväksi.",
  ...
  "No deactivated users match your filters.": "Yksikään deaktivoitu käyttäjä ei vastaa filttereitäsi.",
  ...
  "No invitations match your current filter.": "Ei kutsuja jotka vastaavat suodatinta.",
  ...
  "Non-archived channels": "Arkistoimattomat kanavat",
  "Non-profit (registered)": "Ei tuota voittoa (rekisteröity)",
  "None": "Ei mikään",
  "None of the members of <z-group-pill></z-group-pill> are subscribed to this channel.": "Yksikään jäsenistä <z-group-pill></z-group-pill> ei ole tilannut tätä kanavaa.",
  "None of your messages have emoji reactions yet.": "Viesteilläsi ei ole vielä emojireaktioita.",
  "Not a member of any groups.": "Ei minkään ryhmän jäsen.",
  "Not active in the last year": "Ei aktiivinen viime vuonna",
  "Not granted": "Ei hyväksytty",
  "Note": "",
  ...
  "Notifications are based on your configuration for <z-stream-name></z-stream-name>.": "Ilmoitukset perustuvat asetuksiisi kanavalle <z-stream-name></z-stream-name>.",
  "Notifications are based on your configuration for this channel.": "Ilmoitukset perustuvat asetuksiisi tällä kanavalla.",
  ...
  "November": "Marraskuu",
  "Now following <z-link></z-link>.": "Seurataan kohdetta <z-link></z-link>.",
  ...
  "Objects": "Objektit",
  "October": "Lokakuu",
  "Offer to update to my computer's time zone": "Tarjoile tietokoneen aikavyöhykkeen päivittelyä",
  "Old password": "Vanha salasana",
  "On hover": "kun osoitin on päällä",
  "Onboarding": "",
  ...
  "One or more files could not be deleted.": "Yhtä tai useampaa tiedostoa ei voitu poistaa.",
  ...
  "Only channel administrators can edit these settings.": "Vain kanavien administraattorit voivat muokata näitä asetuksia.",
  "Only in conversation views": "Vain keskustelunäkymissä",
  "Only in image viewer": "Vain kuvannäyttimessä",
  ...
  "Organization profile incomplete": "Organisaation profiili keskeneräinen",
  ...
  "Please acknowledge the warning to send the message.": "Hyväksy varoitusviesti lähettääksesi tämän viestin.",
  ...
  "Please enter task title.": "Anna tehtävälle otsikko.",
  ...
  "Please select a valid channel.": "Valitse sopiva kanava.",
  "Political group": "Poliittinen ryhmä",
  "Popular": "Suosittu",
  "Posted by {full_name}": "Kirjoittanut {full_name}",
  "Preferences": "Asetukset",
  "Press <z-shortcut></z-shortcut> to add a new line": "Paianamalla <z-shortcut></z-shortcut> saat uuden rivin",
  "Press <z-shortcut></z-shortcut> to send": "Painamalla <z-shortcut></z-shortcut> viesti lähetetään",
  "Prevent messages in this channel from being edited, deleted, or moved.": "Estä viestejä tällä kanavalla muokkaamiselta, poistoilta ja siirroilta.",
  "Prevent new messages from being sent to this channel.": "Estä uusien viestien lähetys tälle kanavalle.",
  ...
  "Profile": "Profiili",
  "Profile missing required fields": "Profiilista puuttuu tarvittavia kenttiä",
  "Pronouns": "Pronominit",
  "Public": "Julkinen",
  "Public data": "Julkinen data",
  "Question": "Kysmysy",
  "Quote": "Lainaus",
  "Quote message": "Lainattu viesti",
  ...
  "Reactivate group": "Uudelleenaktivoi ryhmä",
  ...
  "Read receipts are disabled for this organization.": "Vastaanottoilmoitukset on poistettu käytöstä tässä organisaatiossa.",
  ...
  "Reloading…": "Ladataan uudestaan…",
  "Remind me about this": "Muistuta minua tästä",
  "Reminder scheduled": "Muistutus ajastettu",
  ...
  "Removed successfully!": "Poisto onnistui!",
  "Rename <z-stream-or-topic></z-stream-or-topic>": "Uudelleennimeä <z-stream-or-topic></z-stream-or-topic>",
  "Rename archived channel": "Uudelleennimeä arkistoitu kanava",
  "Rename deactivated user group": "Uudelleennimeä deaktivoitu käyttäjäryhmä",
  "Rename topic": "Uudelleennimeä aihe",
  "Rename {group_name} (<i>deactivated</i>)": "Uudelleennimeä {group_name} ( <i>deaktivoitu</i>)",
  ...
  "Require end-to-end encryption for push notification content": "Vaadi end-to-end-salaus push-ilmoituksille",
  ...
  "Reset to default notifications?": "Palautetaanko oletusilmoitukset?",
  ...
  "Save draft and start a new message": "Tallenna luonnos ja aloita uusi viesti",
  ...
  "Schedule reminder": "Aikataulumuistutus",
  "Scheduled messages": "Aikataulutetut viestit",
  "Scheduled reminders": "Aikataulumuistutkset",
  ...
  "Scrolling to your last message will mark <b>{num_unread}</b> unread messages as read. Would you like to scroll to that message and edit it?": "Kelaa viimeiseen viestiisi merkitsee <b>{num_unread}</b> lukematonta viestiä luetuksi. Kelataanko viestiin ja muokataan sitä?",
  "Search": "Etsi",
  "Search all public channels that you can view.": "Etsi kaikilta julkisilta kanavilta jotka voit nähdä.",
  "Search all public channels.": "Etsi kaikilta julkisilta kanavilta.",
  ...
  "Send me a direct message when my invitation is accepted": "Lähetä yksityisviesti kun kutsu on hyväksytty",
  ...
  "Starred messages options": "Tähdellisten viestien asetukset",
  "Starring messages is a good way to keep track of important messages, such as tasks you need to go back to, or useful references. To star a message, hover over a message and click the <star-icon></star-icon>. <z-link>Learn more</z-link>": "Viestin tähdittäminen on hyvä tapaa pitää tärkeät viestit saatavilla, kuten tehtävät mihin pitää palata aika ajoin, tai hyödylliset vinkit. Viestin voi tähdittää osoittamala sitä ja klikkaamalla <star-icon></star-icon>. <z-link>Opi lisää</z-link>",
  "Start a new topic or select one from the list.": "Aloita uusi aihe tai valitse yksi listalta.",
  "Start export": "Aloita vienti",
  "Start export?": "Aloitetaanko vienti?",
  ...
  "Switch to the dark theme": "Vaihda pimeään teemaan",
  "Symbols": "Symbolit",
  "System bot": "Systeemibotti",
  "THIS CHANNEL": "TÄMÄ KANAVA",
  "THIS CONVERSATION": "TÄMÄ KESKUSTELU",
  "Task already exists": "Tehtävä on jo olemassa",
  "Task description (optional)": "Tehtävän kuvaus (valinnainen)",
  "Task list": "Tehtävälista",
  "Tasks": "Tehtävät",
  "The administrators provided the following comment:": "Adminit jättivät seuraavan kommentin:",
  "The application has been updated; Reloading…": "Sovellus on päivittynyt, ladataan uudestaan…",
  ...
  "There are no channel folders configured in this organization.": "Organisaatiolle ei ole asetettu kanavia.",
  ...
  "There are no groups matching your filters.": "Mikään ryhmä ei täsmää suodattimiisi.",
  "There are no invitations.": "Ei ole kutsuja.",
  ...
  "There are no topics in this view.": "Tässä näkymässä ei ole aiheita.",
  ...
  "This bot cannot be managed.": "Tätä bottia ei voi hallita.",
  ...
  "This channel doesn't exist, or you are not allowed to view it.": "Tätä kanavaa ei ole tai sinulla ei ole lupaa nähdä sitä.",
  ...
  "This conversation also has older unread messages. Jump to first unread message?": "Tässä keskustelussa on vanhempiakin lukemattomia viestejä, siirrytäänkö ensimmäiseen lukemattomaan viestiin?",
  ...
  "This demo organization will be automatically deleted in 30 days, unless it's converted into a permanent organization.": "Tämä demo-organisaatio poistetaan 30 päivässä jollei sitä konvertoida pysyväksi organisaatioksi.",
  ...
  "This group has no assigned permissions.": "Ryhmällä ei ole oikeuksia.",
  "This group has no members.": "Tässä ryhmässä ei ole jäseniä.",
  "This group has this permission because it's a subgroup of {supergroup_name}.": "Ryhmällä on tämä oikeus koska se on ryhmän {supergroup_name} aliryhmä.",
  "This group is deactivated. It can't be mentioned or used for any permissions.": "Ryhmä on deaktivoitu. Sitä ei voi mainita tai käyttää oikeuksissa.",
  "This is a test notification from Zulip.": "Tämä on testi-ilmoitus Zulipilta.",
  ...
  "This user cannot be deactivated.": "Tätä käyttäjää ei voi deaktivoida.",
  ...
  "This user is a member of {name} because they are a member of a subgroup ({subgroups_name}).": "Tämän käyttäjä on jäsen ryhmässä {name} koska hän on aliryhmässä ({subgroup_name}).",
  "This view will show messages where you are mentioned.": "Tämä näkymä näyttää viestejä joissa olet mainitttu.",
  ...
  "Topic visibility": "Aiheen näkyvyys",
  "Topics": "Aiheet",
  ...
  "Unsubscribe from this channel": "Poista tämän kanavan tilaus",
  ...
  "User group ID": "Käyttäjäryhmän ID",
  "User group creation": "Käyttäjäryhmän luonti",
  "User group description": "Käyttäjäryhmän kuvaus",
  "User group details": "Käyttäjäryhmän tiedot",
  "User group name": "Käyttäjäryhmän nimi",
  "User group permissions": "Käyttäjäryhmän oikeudet",
  "User group settings": "Käyttäjäryhmän asetuksia",
  "User groups": "Käyttäjäryhmät",
  "User groups offer a flexible way to manage permissions in your organization.": "Käyttäjäryhmänt on joustava tapa hallita oikeuksia organisaaatiossa.",
  "User groups they should join": "Käyttäjäryhmät joihin heidät liitetään",
  ...
  "View in channel settings": "Näytä kanavan asetukset",
  ...
  "Warn when composing a DM to a guest": "Varoita kun kirjoitat yksityisviestiä vieraalle",
  ...
  "Who can add members to this group": "Kuka voi lisätä jäseniä ryhmään",
  "Who can administer all user groups": "Kuka voi hallita kaikki ryhmiä",
  ...
  "Who can create user groups": "Kuka voi luoda käyttäjäryhmiä",
  ...
  "Who can subscribe others to channels": "Kuka voi tilata toisia kanaville",
  "Who can subscribe to this channel": "Kuka voi tilata kanavan",
  "Who can unsubscribe anyone from this channel": "Kuka voi poistaa tämän kanavan tilauksen",
  "Who can use AI summaries": "Kuka voi käyttää tekoälyn yhteenvetoja",
  "Who can view all other users in the organization": "Kuka voi nähdä muita käyttäjiä tässä organisaatiossa",
  "Who should be the sender of the Zulip messages for this email address?": "Kuka on lähettäjä Zulip-viesteillä tästä sähköpostiosoitteesta?",
  ...
  "You are a member of this group because you are a member of a subgroup (<z-subgroup-names></z-subgroup-names>).": "Olet ryhmän jäsen koska olet aliryhmän jäsen (<z-subgroup-names></z-subgroup-names>).",
  "You are a member of this group.": "Olet ryhmän jäsen.",
  "You are a member of {name} because you are a member of a subgroup ({subgroups_name}).": "Olet jäsen ryhmässä {name} koska olet jäsen aliryhmässä ({subgroups_name}).",
  "You are about to disable all notifications for direct messages, @&#8209;mentions and alerts, which may cause you to miss messages that require your timely attention. If you would like to temporarily disable all desktop notifications, consider <z-link>turning on \"Do not disturb\"</z-link> instead.": "Olet poistamassa ilmoitukset käytöstä yksityisviesteille, @-viittauksille ja hälytyksille, jotka saattavat tarvita huomiotasi. Jos haluat väliaikaisesti poistaa työpöytäilmoitukset käytöstä, käytä <z-link>do not disturb -tilaa </z-link> sen sijaan.",
  "You are already a member of this group because you are a member of a subgroup": "Olet jo ryhmän jäsen koska olet aliryhmän jäsen",
  "You are moving messages to a topic that already exists. Messages from these topics will be combined.": "Siirrettävien viestien aihe on jo olemassa. Viestit yhdistellään molemmista aiheista.",
  ...
  "You are not allowed to add members to this group": "Sinulla ei ole lupaa lisätä jäseniä ryhmään",
  "You are not allowed to change this field. Contact an administrator to update it.": "Tätä kenttää ei voi muuttaa. Ota yhteyttä ylläpitoon muuttamiseksi.",
  "You are not allowed to remove this permission.": "Sinulla ei ole lupaa poistaa tätä oikeutta.",
  "You are not allowed to start direct message conversations.": "Sinulla ei ole lupaa aloittaa suoraviestejä.",
  ...
  "You can only view channels that you are subscribed to.": "Voit vain katsella kanavia joita tilaat.",
  ...
  "You cannot create a user group with no members or subgroups.": "Et voi luoda käyttäjäryhmää ilman jäseniä tai aliryhmiä.",
  "You cannot join a deactivated user group.": "Et voi liittyä deaktivoituun ryhmään.",
  "You cannot leave a deactivated user group.": "Et voi poistua deaktivoidusta ryhmästä.",
  ...
  "You do not have permission to add other users to this channel.": "Sinulla ei ole oikeuksia lisätä käyttäjiä tälle kanavalle.",
  "You do not have permission to create bots.": "Sinulla ei ole oikeuksia tehdä botteja.",
  "You do not have permission to create channels.": "Sinulla ei ole oikeuksia tehdä kanavia.",
  "You do not have permission to create user groups.": "Sinulla ei ole oikeuksia tehdä käyttäjäryhmiä.",
  "You do not have permission to edit this setting.": "Sinulla ei ole oikeuksia muokata tätä asetusta.",
  ...
  "You do not have permission to resolve topics with messages older than {N, plural, one {# minute} other {# minutes}} in this organization.": "Sinulla ei ole oikeuksia ratkaista aiheita joissa on viestejä yli {N, plural, one {# minuutin} other {# minuuttia}} tässä organisaatiossa.",
  "You do not have permission to send invite emails in this organization.": "Sinulla ei ole oikeuksia lähettää kutsuja tässä organisaatiossa.",
  "You do not have permission to unresolve topics with messages older than {N, plural, one {# day} other {# days}} in this organization.": "Sinulla ei ole oikeuksia epäratkaista aiheita jotka ovat vanhempia kuin {N, plural, one {# päivän} other {# päivää}} tässä organisaatiossa.",
  "You do not have permission to unresolve topics with messages older than {N, plural, one {# hour} other {# hours}} in this organization.": "Sinulla ei ole oikeuksia epäratkaista aiheita joissa on viestejä jotka ovat vanhempia kuin {N, plural, one {# hour} other {# hours}} tässä organisaatiossa.",
  ...
  "You do not have permission to use wildcard mentions in large streams.": "Sinulla ei ole lupaa käyttää mainintoja jokerimerkillä suuremmilla kanavilla.",
  ...
  "You have no direct messages with these users yet.": "Sinulla ei ole yksityisviestejä näiden käyttäjien kanssa vielä.",
  "You have no direct messages with these users.": "Sinulla ei ole yksityisviestejä näiden käyttäjien kanssa.",
  "You have no direct messages with {person} yet.": "Sinulla ei ole yksityisviestejä käyttäjän {person} kanssa vielä.",
  "You have no direct messages with {person}.": "Sinulla ei ole yksityisviestejä käyttäjän {person} kanssa.",
  "You have no direct messages yet!": "Sinulla ei ole yksityisviestejä vielä.",
  "You have no inactive bots.": "Sinulla ei ole yhtään käytöstä poistettua bottia.",
  "You have no messages in muted topics and channels.": "Sinulla ei ole viestejä hiljennetyissä aiheissa ja kanavissa.",
  "You have no more unread direct messages.": "Sinulla ei ole lukemattomia yksityisviestejä.",
  ...
  "You have unmuted this topic.": "Olet poistanut kanavan hiljennyksen.",
  "You have unread mentions": "Sinulla on lukemattomia mainintoja",
  "You have {display_count, plural, =0 {no drafts} one {# draft} other {# drafts}}.": "sinulla on {display_count, plural, =0 {no drafts} one {# draft} other {# drafts}}.",
  "You have {display_count, plural, =0 {no scheduled messages} one {# scheduled message} other {# scheduled messages}}.": "Sinulla on {display_count, plural, =0 {no scheduled messages} one {# scheduled message} other {# scheduled messages}}.",
  "You have {display_count, plural, =0 {no starred messages} one {# starred message} other {# starred messages}}.": "Sinulla on {display_count, plural, =0 {no starred messages} one {# starred message} other {# starred messages}}.",
  "You have {display_count, plural, =0 {no unread mentions} one {# unread mention} other {# unread mentions}}.": "Sinulla on {display_count, plural, =0 {no unread mentions} one {# unread mention} other {# unread mentions}}.",
  "You have {display_count, plural, =0 {no unread messages} one {# unread message} other {# unread messages}}.": "Sinulla on {display_count, plural, =0 {no unread messages} one {# unread message} other {# unread messages}}.",
  ...
  "You will be able to export all public data, and (optionally) private data from users who have given their permission.": "Voit viedä kaiken julkisen datan ja (valinnaisesti) yksityisen datan käyttäjiltä jotka ovat sen sallineet.",
  "You will lose access to content in this channel if you make it private. To keep access, subscribe or grant yourself permission to do so under Advanced configurations.": "Menetät pääsyn kanavan sisältöön jos teet siitä yksityisen. Säilyttääksesi pääsyn, tilaa kanava tai lisää oikeus siihen lisäasetuksista.",
  "You will no longer be prompted to update your time zone.": "Et saa enää aikavyöhykepäivityspyyntöjä.",
  ...
  "Your computer's time zone differs from your Zulip profile. Update your time zone to {browser_time_zone}?": "Tietokoneesi aikavyöhyke on eri kuin Zulip-profiilin. Päivitetäänkö aikavyöhykkeeksi {browser_time_zone}?",
  "Your groups": "Ryhmäsi",
  ...
  "Your organization will lose access content in this channel, and nobody will be able to subscribe to it in the future.": "Organisaatiosi menettää pääsyn tälle kanavalle eikä kukaan voi tilata sitä vastaisuudessa.",
  ...
  "[Configure]": "[Määritä]",
  "[Error fetching message content.]": "[Virhe viestin sisällön haussa.]",
  "[Quoting…]": "[Lainaus...]",
  "acme": "acme",
  ...
  "days": "päivää",
  "deactivated": "poistettu käytöstä",
  "direct messages with yourself": "yksityisviestit itsellesi",
  "direct messages with {recipient}": "yksityisviestit käyttäjälle {recipient}",
  "does not apply to moderators and administrators": "ei koske moderaattoreita ja administraattoreita",
  "does not apply to users who can delete any message": "ei koske käyttäjiä jotka voivat poistaa mitä vain viestejä",
  "everyone except guests can subscribe to any public channel": "kaikki paitsi vieraat voiva kirjautua julkisille kanaville",
  "general chat": "Chat",
  "group direct messages with {recipient}": "yksityiset ryhmäviestit käyttäjille {recipient}",
  "guest": "vieras",
  ...
  "{N, plural, one {Working… {N} message marked as read so far.} other {Working… {N} messages marked as read so far.}}": "{N, plural, one {Toteutetaan... {N} viesti merkitty luetuksi} other {Toteutetaan... {N} viestiä merkitty luetuiksi}}",
  ...
  "{msg_count} messages from {sender_name}": "{msg_count} viestiä käyttäjältä {sender_name}",
  "{names} are guests in this organization.": "{names} ovat vieraita tässä organisaatiossa.",
  "{name} (guest)": "{name} (vieras)",
