...
## Verbatim Content (Part 728 of 1290)
...
---[FILE: compose.css]---
Location: zulip-main/web/styles/compose.css
...
#compose_recipient_box {
    ...
    #stream_message_recipient_topic:disabled ~ .compose-new-recipient-button {
        visibility: hidden;
    }
...
.low-attention-recipient-row:not(:focus-within) {
    ...
    #compose-direct-recipient .pill-container {
        ...
        .compose-new-recipient-button:hover {
            opacity: 1;
        }
    }
