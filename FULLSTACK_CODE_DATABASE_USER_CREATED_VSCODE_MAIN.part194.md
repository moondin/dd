...
## Verbatim Content (Part 194 of 552)
...
---[FILE: src/vs/base/test/node/pfs/pfs.test.ts]---
Location: vscode-main/src/vs/base/test/node/pfs/pfs.test.ts
...
---[FILE: src/vs/base/test/node/pfs/fixtures/index.html]---
Location: vscode-main/src/vs/base/test/node/pfs/fixtures/index.html
...
---[FILE: src/vs/base/test/node/pfs/fixtures/site.css]---
Location: vscode-main/src/vs/base/test/node/pfs/fixtures/site.css
...
---[FILE: src/vs/base/test/node/pfs/fixtures/examples/company.jxs]---
Location: vscode-main/src/vs/base/test/node/pfs/fixtures/examples/company.jxs
...
---[FILE: src/vs/base/test/node/pfs/fixtures/examples/conway.jxs]---
Location: vscode-main/src/vs/base/test/node/pfs/fixtures/examples/conway.jxs
...
---[FILE: src/vs/base/test/node/pfs/fixtures/examples/employee.jxs]---
Location: vscode-main/src/vs/base/test/node/pfs/fixtures/examples/employee.jxs
...
---[FILE: src/vs/base/test/node/pfs/fixtures/examples/small.jxs]---
Location: vscode-main/src/vs/base/test/node/pfs/fixtures/examples/small.jxs
...
---[FILE: src/vs/base/test/node/processes/processes.integrationTest.ts]---
Location: vscode-main/src/vs/base/test/node/processes/processes.integrationTest.ts
...
---[FILE: src/vs/base/test/node/processes/fixtures/fork.ts]---
Location: vscode-main/src/vs/base/test/node/processes/fixtures/fork.ts
...
---[FILE: src/vs/base/test/node/processes/fixtures/fork_large.ts]---
Location: vscode-main/src/vs/base/test/node/processes/fixtures/fork_large.ts
...
---[FILE: src/vs/base/test/node/zip/zip.test.ts]---
Location: vscode-main/src/vs/base/test/node/zip/zip.test.ts
...
---[FILE: src/vs/base/test/node/__snapshots__/snapshot_cleans_up_old_snapshots.0.snap]---
Location: vscode-main/src/vs/base/test/node/__snapshots__/snapshot_cleans_up_old_snapshots.0.snap
...
hello_world_.1.snap:
  { nifty: true }
hello_world_.fourthTest.snap:
  { customName: 2 }
hello_world_.thirdTest.txt:
  { customName: 1 }
```

--------------------------------------------------------------------------------

---[FILE: src/vs/base/test/node/__snapshots__/snapshot_cleans_up_old_snapshots.1.snap]---
Location: vscode-main/src/vs/base/test/node/__snapshots__/snapshot_cleans_up_old_snapshots.1.snap

```text
hello_world_.0.snap:
  { cool: true }
hello_world_.thirdTest.snap:
  { customName: 1 }
```

--------------------------------------------------------------------------------

---[FILE: src/vs/base/test/node/__snapshots__/snapshot_creates_a_snapshot.0.snap]---
Location: vscode-main/src/vs/base/test/node/__snapshots__/snapshot_creates_a_snapshot.0.snap
...
---[FILE: src/vs/base/test/node/__snapshots__/snapshot_formats_object_nicely.0.snap]---
Location: vscode-main/src/vs/base/test/node/__snapshots__/snapshot_formats_object_nicely.0.snap
...
---[FILE: src/vs/code/browser/workbench/callback.html]---
Location: vscode-main/src/vs/code/browser/workbench/callback.html
