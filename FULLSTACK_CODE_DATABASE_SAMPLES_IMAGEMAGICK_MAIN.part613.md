...
## Verbatim Content (Part 613 of 851)
...
---[FILE: magick.html]---
Location: ImageMagick-main/www/api/magick.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Read or List Image formats, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Read or List Image formats</h1>
    </a>
  </header>

  <main class="container">
<h1 class="text-center">Magick</h1>
<div class="btn-group">
<button class="btn btn-secondary dropdown-toggle" type="button" id="defaultDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
  Select API Method
</button>
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#AcquireMagickInfo">AcquireMagickInfo</a></li>
  <li><a href="#GetMagickPrecision">GetMagickPrecision</a></li>
  <li><a href="#IsMagickCoreInstantiated">IsMagickCoreInstantiated</a></li>
  <li><a href="#MagickCoreGenesis">MagickCoreGenesis</a></li>
  <li><a href="#MagickCoreTerminus">MagickCoreTerminus</a></li>
</ul>
</div>
<br/>
<br/>
...
<pre class="bg-light text-dark mx-4"><samp>MagickInfo *AcquireMagickInfo(const char *magick_module,
...
<pre class="bg-light text-dark mx-4"><samp>int GetMagickPrecision(void)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType IsMagickCoreInstantiated(void)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void MagickCoreGenesis(const char *path,
...
<pre class="bg-light text-dark mx-4"><samp>void MagickCoreTerminus(void)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>int SetMagickPrecision(const int precision)
</samp></pre>
