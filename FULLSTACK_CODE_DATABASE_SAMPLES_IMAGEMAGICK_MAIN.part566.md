...
## Verbatim Content (Part 566 of 851)
...
---[FILE: magick-core.html]---
Location: ImageMagick-main/www/magick-core.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, Low-level C API, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-4">MagickCore, Low-level C API</h1>
    </a>
  </header>
...
<!-- Magick Cache 27th July 2025 10:46 -->
```
