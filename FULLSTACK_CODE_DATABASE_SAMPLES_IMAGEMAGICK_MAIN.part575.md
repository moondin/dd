...
## Verbatim Content (Part 575 of 851)
...
---[FILE: news.html]---
Location: ImageMagick-main/www/news.html
...
<head>
  ...
  <meta property="og:title" content="ImageMagick | News" />
  ...
  <meta property="og:url" content="../www/news.html" />
  ...
  <meta name="twitter:title" content="ImageMagick | News" />
...
<p>With recent releases of ImageMagick 7, we continue to evolve our support of <a href="multispectral-imagery.html">Multispectral imagery</a>.  PSD, TIFF, MIFF, MPC, and FTXT can now read and write multispectral images with more multispectral formats to follow.</p>

<p>We now provide <a href="download.html#windows">portable ARM Win64</a> static releases. Just copy to your host and run (no installer, no Windows registry entries).  Thanks to <a href="https://github.com/dlemstra">@dlemstra</a> for the ARM release.</p>

<p><a href="https://github.com/snibgo">@Snibgo</a> contributed a <a href="../www/fx.html">Fx</a> special-effects image operator interpreter.  It has vastly improved error checking and performance.</p>
...
<p>We recently updated Anthony's <a href="https://imagemagick.org/Usage">ImageMagick Example Usage</a> pages to support version 7 tools and options.</p>
...
<ul>
<li>add more memory to your system, see <a href="../www/architecture.html#cache#cache">the pixel cache</a>;</li>
<li>add more cores to your system, see <a href="../www/architecture.html#threads#threads">threads of execution support</a>;</li>
...
<!-- Magick Cache 17th August 2025 15:46 -->
```

--------------------------------------------------------------------------------

---[FILE: opencl.html]---
Location: ImageMagick-main/www/opencl.html
...
<head>
  ...
  <meta name="keywords" content="Parallel Execution with OpenCL, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-4">Parallel Execution with OpenCL</h1>
    </a>
  </header>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary">  blur
  contrast
  charcoal
  function
  grayscale
  motion-blur
  resize</pre>
        The following operators are OpenCL accelerated as well, but they require alpha channel to be enabled, e.g. <samp>magick sample.jpg -alpha on -despeckle null:</samp>.
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary">  despeckle
  equalize
  modulate</pre>
    </li>
</ol>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>clEnv=GetCurrentOpenCLEnv();
