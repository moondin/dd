...
## Verbatim Content (Part 773 of 867)
...
---[FILE: auth.config.ts]---
Location: prowler-master/ui/auth.config.ts
Signals: Zod
...
---[FILE: CHANGELOG.md]---
Location: prowler-master/ui/CHANGELOG.md
...
Location: prowler-master/ui/components.json
