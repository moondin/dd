...
## Verbatim Content (Part 878 of 933)
...
---[FILE: 0077_snapshot.json]---
Location: sim-main/packages/db/migrations/meta/0077_snapshot.json

```json
{
  "id": "26848621-8952-4e3c-a2b1-58e4834b4e75",
  "prevId": "8c62884e-7383-4474-8b44-1c1d41b8433f",
  "version": "7",
  "dialect": "postgresql",
  "tables": {
    "public.account": {
    ...
    "public.copilot_api_keys": {
      "name": "copilot_api_keys",
      "schema": "",
      "columns": {
        "id": {
          "name": "id",
      ...
      "indexes": {
        "copilot_api_keys_api_key_encrypted_hash_idx": {
          "name": "copilot_api_keys_api_key_encrypted_hash_idx",
          "columns": [
            {
              "expression": "api_key_encrypted",
              "isExpression": false,
              "asc": true,
              "nulls": "last"
            }
        ...
        "copilot_api_keys_lookup_hash_idx": {
          "name": "copilot_api_keys_lookup_hash_idx",
          "columns": [
            {
              "expression": "api_key_lookup",
              "isExpression": false,
              "asc": true,
              "nulls": "last"
            }
      ...
      "foreignKeys": {
        "copilot_api_keys_user_id_user_id_fk": {
          "name": "copilot_api_keys_user_id_user_id_fk",
          "tableFrom": "copilot_api_keys",
          "tableTo": "user",
          "columnsFrom": ["user_id"],
          "columnsTo": ["id"],
          "onDelete": "cascade",
