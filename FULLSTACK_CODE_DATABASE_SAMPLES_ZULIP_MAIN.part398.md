...
## Verbatim Content (Part 398 of 1290)
...
Location: zulip-main/locale/ru/translations.json
Signals: React, Next.js

```json
{
  "%'{file}' exceeds the maximum file size for attachments ({variable} MB).": "%'{file}' превышает максимальный размер файла для вложений ({variable} МБ).",
  "(attached file)": "(прикрепленный файл)",
  "(default)": "(по умолчанию)",
  "(forever)": "(навсегда)",
  "(hidden)": "(скрыто)",
  "(link to channel)": "(ссылка на канал)",
  "(no highlighting)": "(без выделения)",
  ...
  "<kbd>Enter</kbd> sends when composing a message": "<kbd>Enter</kbd> отправляет набираемое сообщение",
  ...
  "A deactivated user group with this name already exists.": "Отключённая группа пользователей с таким названием уже есть.",
  ...
  "AI summaries are not enabled on this server.": "Обобщения с помощью ИИ не включены на этом сервере.",
  "AI summaries may have errors.": "Обобщения с помощью ИИ могут содержать ошибки.",
  ...
  "Action": "Действие",
  "Action message": "Сообщение о действии",
  "Actions": "Действия",
  "Active an hour ago": "Активность: час назад",
  "Active and deactivated": "Активные и отключенные",
  ...
  "Add a new channel folder": "Добавить новую папку каналов",
  ...
  "Add roles, groups or users": "Добавить роли, группы или пользователей",
  "Add saved snippet": "Добавить сохраненный сниппет",
  "Add subscribers": "Добавить подписчиков",
  "Add subscribers to": "Добавить подписчиков в",
  "Add subscribers.": "Добавить подписчиков.",
  "Add task": "Добавить задачу",
  "Add to-do list": "Добавить список дел",
  "Add todo task list title": "Добавить заголовок списка дел",
  "Add user groups": "Добавить группы пользователей",
  "Add users or groups. Use #channelname to add all subscribers.": "Добавить пользователей или группы. Используйте #channelname для добавления всех подписчиков.",
  ...
  "After how much time should all data for this organization be permanently deleted (users, channels, messages, etc.)?": "Спустя какое время следует безвозвратно удалить все данные этой организации (пользователей, каналы, сообщения и т.п.)?",
  "Alert word": "Сигнальное слово",
  "Alert word <b>{alert_word}</b> removed successfully!": "Сигнальное слово <b>{alert_word}</b> успешно удалено!",
  ...
  "All unread conversations are hidden. Click on a section, folder, or channel to expand it.": "Все непрочитанные беседы скрыты. Нажмите на раздел, папку или канал, чтобы развернуть их.",
  ...
  "Allow messages in this channel to be edited, deleted, or moved.": "Разрешить редактировать, удалять и перемещать сообщения в этом канале.",
  "Allow other users to view read receipts": "Разрешить другим видеть подтверждения прочтения",
  "Allow posting to the <z-empty-string-topic-display-name></z-empty-string-topic-display-name> topic?": "Разрешить публикацию в теме <z-empty-string-topic-display-name></z-empty-string-topic-display-name>?",
  "Allow sending new messages to this channel.": "Разрешить отправку новых сообщений в этот канал.",
  "Allow subdomains": "Разрешать поддомены",
  "Allow viewing the history of a message?": "Разрешить просмотр истории сообщения?",
  "Allow “{empty_topic_name}”": "Разрешить “{empty_topic_name}”",
  ...
  "Already at default line spacing": "Уже установлен межстрочный интервал по умолчанию",
  "Already at maximum font size ({maximum_value})": "Уже установлен максимальный размер шрифта ({maximum_value})",
  "Already at maximum line spacing": "Уже установлен максимальный межстрочный интервал",
  "Already at minimum font size ({minimum_value})": "Уже установлен минимальный размер шрифта ({minimum_value})",
  ...
  "An archived channel with this name already exists.": "Архивный канал с таким названием уже есть.",
  ...
  "Anyone can add more tasks after the to-do list is posted.": "Каждый может добавить дела в список после его размещения.",
  ...
  "Archived and non-archived": "Архивные и актуальные",
  "Archived channels": "Архивные каналы",
  "Archiving this channel will:": "Действия при архивировании этого канала:",
  ...
  "Are you sure you want to deactivate this organization? All users will lose access to their Zulip accounts.": "Вы уверены, что хотите отключить эту организацию? Все ее пользователи потеряют доступ к своим учетным записям Zulip.",
  ...
  "Are you sure you want to mute <z-highlight>{user_name}</z-highlight>?  Messages sent by muted users will never trigger notifications, will be marked as read, and will be hidden.": "Вы уверены, что хотите заглушить <z-highlight>{user_name}</z-highlight>?  Отправленные заглушенным пользователем сообщения не будут инициировать уведомления, будут помечены как прочитанные и скрыты.",
  ...
  "Automatically follow topics based on my participation": "Автоматически отслеживать темы на основе моего участия",
  ...
  "Because you are not subscribed to <z-streams></z-streams>, messages in this channel were not marked as unread.": "Так как вы не подписаны на <z-streams></z-streams>, сообщения в этом канале не были помечены как непрочитанные.",
  ...
  "Cannot add duplicate task.": "Невозможно добавить дубликат задачи.",
  "Cannot save invalid Jitsi server URL.": "Не удается сохранить неверный URL сервера Jitsi.",
  "Cannot save invalid message retention period.": "Невозможно сохранить недействительный срок хранения сообщений.",
  "Cannot send message while files are being uploaded.": "Не удается отправить сообщение, потому что файлы в процессе отправки.",
  "Cannot subscribe to <z-stream></z-stream>": "Не удается подписаться на <z-stream></z-stream>",
  "Cannot subscribe to private channel <z-stream></z-stream>": "Не удается подписаться на закрытый канал <z-stream></z-stream>",
  ...
  "Change to default line spacing": "Установить межстрочный интервал по умолчанию",
  "Change to font size {new_value}": "Установить размер шрифта {new_value}",
  "Change to {new_value_string} line spacing": "Установить межстрочный интервал {new_value_string}",
  "Change your email": "Изменить свой email",
  "Change your password": "Сменить ваш пароль",
  "Channel": "Канал",
  "Channel <z-link>#{stream_name}</z-link> created!": "Канал <z-link>#{stream_name}</z-link> создан!",
  ...
  "Channel folder": "Папка каналов",
  "Channel folder name": "Название папки каналов",
  "Channel folders": "Папки каналов",
  ...
  "Channels": "Каналы",
  "Channels in this folder will become uncategorized.": "Каналы в этой папке станут некатегоризированными.",
  "Channels organize conversations based on who needs to see them.": "Каналы структурируют беседы в соответствии с тем, кому нужно их видеть.",
  "Channels they should join": "Каналы, к которым они должны присоединиться",
  "Check all": "Выбрать все",
  "Check your email (<b>{email}</b>) to confirm the new address.": "Проверьте вашу почту (<b>{email}</b>) для подтверждения нового адреса.",
  ...
  "Choose messages to mark as read": "Выберите сообщения, которые нужно отметить как прочитанные",
  ...
  "Click <z-icon-inbox></z-icon-inbox> <z-highlight>Inbox</z-highlight> in the left sidebar.": "Нажмите <z-icon-inbox></z-icon-inbox> <z-highlight>Входящие</z-highlight> в левой боковой панели.",
  "Click <z-icon-recent></z-icon-recent> <z-highlight>Recent conversations</z-highlight> in the left sidebar.": "Нажмите <z-icon-recent></z-icon-recent> <z-highlight>Последние беседы</z-highlight> в левой боковой панели.",
  ...
  "Click the name of a channel in the left sidebar, and click on any topic underneath to view one conversation at a time. You can explore discussions of changes to the design of the Zulip app in <z-highlight>#design</z-highlight>, or see ongoing issue investigations in <z-highlight>#issues</z-highlight>.": "Нажмите на название канала на левой боковой панели и выберите любую тему под ним, чтобы просматривать беседы по одной. Вы можете ознакомиться с обсуждениями изменений в дизайне приложения Zulip в <z-highlight>#design</z-highlight> или посмотреть ход разбора текущих проблем в <z-highlight>#issues</z-highlight>.",
  "Click to unmute this channel.": "Нажмите, чтобы включить оповещения этого канала.",
  ...
  "Combined feed options": "Настройки объединенной ленты",
  "Common words were excluded from your search:": "Из вашего поиска были исключены распространённые слова:",
  ...
  "Configure regular expression patterns that will be used to automatically transform any matching text in Zulip messages and topics into links.": "Настройте шаблоны регулярных выражений, которые будут использоваться для автоматического преобразования удовлетворяющих выражениям строк в сообщениях и темах Zulip в ссылки.",
  ...
  "Configure the authentication methods for your organization.": "Укажите способы аутентификации для вашей организации.",
  ...
  "Configure your email to access this feature.": "Настройте электронную почту для доступа к этой функции.",
  "Confirm": "Подтвердить",
  "Confirm changing access permissions": "Подтвердите изменение прав доступа",
  "Confirm new color": "Подтвердите новый цвет",
  ...
  "Convert emoticons before sending (<code>:)</code> becomes 🙂)": "Преобразовать смайлики перед отправкой (<code>:)</code> преобразуется в 🙂)",
  "Convert into permanent organization": "Преобразовать в постоянную организацию",
  "Cookie Bot": "Cookie-бот",
  "Copied!": "Скопировано!",
  "Copy URL": "Копировать URL",
  "Copy and close": "Скопировать и закрыть",
  "Copy code": "Скопировать код",
  "Copy draft": "Копировать черновик",
  ...
  "Copy link to message": "Скопировать ссылку на сообщение",
  ...
  "Could not update time zone": "Не удалось обновить часовой пояс",
  "Create": "Создать",
  "Create a channel": "Создать канал",
  "Create a collaborative to-do list": "Создать совместный список дел",
  "Create a new saved snippet": "Создать новый сохраненный сниппет",
  "Create a poll": "Создать опрос",
  "Create a user group": "Создать группу пользователей",
  "Create channel": "Создать канал",
  "Create channel folder": "Создать папку каналов",
  ...
  "Create to-do list": "Создать список дел",
  ...
  "Custom time ({min}+ days)": "Свое время ({min}+ д.)",
  "Custom time ({min}-{max} days)": "Свое время ({min}-{max} д.)",
  "Customize a channel": "Настроить канал",
  "Customize another channel": "Настроить другой канал",
  "Customize notifications": "Настроить оповещения",
  ...
  "Deactivate group": "Отключить группу",
  ...
  "Deactivate {group_name}?": "Отключить {group_name}?",
  "Deactivate {name}?": "Отключить пользователя {name}?",
  "Deactivated": "Отключены",
  "Deactivated groups": "Отключенные группы",
  "Deactivated users": "Отключенные пользователи",
  "December": "Декабрь",
  "Decrease font size": "Уменьшить размер шрифта",
  "Decrease line spacing": "Уменьшить межстрочный интервал",
  "Default": "По умолчанию",
  "Default <z-empty-string-topic-display-name></z-empty-string-topic-display-name> topic configuration for channels": "Настройка темы по умолчанию <z-empty-string-topic-display-name></z-empty-string-topic-display-name> для каналов",
  ...
  "Delete channel folder?": "Удалить папку каналов?",
  ...
  "Delete reminder": "Удалить напоминание",
  "Delete saved snippet?": "Удалить сохраненный сниппет?",
  ...
  "Delete uploaded files?": "Удалить загруженные файлы?",
  "Deleted": "Удалено",
  ...
  "Demo organization": "Демонстрационная организация",
  "Demo organization deadline": "Крайний срок демо-организации",
  "Depending on the size of your organization, an export can take anywhere from seconds to an hour.": "В зависимости от размера вашей организации, выгрузка данных может занять от нескольких секунд до часа.",
  "Deprecation notice": "Уведомление об удалении",
  "Description": "Описание",
  "Deselect draft": "Снять выделение с черновика",
  "Desktop": "Компьютер",
  "Desktop & mobile apps": "Приложения для установки",
  ...
  "Disable": "Отключить",
  "Disable announcements that are currently sent to this channel:": "Отключить объявления, отправляемые в этот канал:",
  ...
  "Don't group channels by folder": "Не группировать каналы по папкам",
  ...
  "Download the latest version": "Загрузить последнюю версию",
  ...
  "Drafts from conversation with yourself": "Черновики беседы с собой",
  "Drafts from conversation with {recipient}": "Черновики из переписки с {recipient}",
  "Drafts from {recipient}": "Черновики от {recipient}",
  "Drafts options": "Настройки черновиков",
  "Drag and drop your Slack export file here, or click to browse.": "Перетащите сюда экспортированный файл Slack или нажмите, чтобы просмотреть.",
  "EDITED": "ИЗМЕНЕНО",
  "Each conversation is <z-highlight>labeled with a topic</z-highlight> by the person who started it.": "Каждое обсуждение <z-highlight>озаглавливается темой</z-highlight>, ее задает тот, кто начинает беседу.",
  "Edit": "Изменить",
  "Edit #{channel_name}": "Редактировать #{channel_name}",
  "Edit #{stream_name} (<i>archived</i>)": "Редактировать #{stream_name} (<i>архив</i>)",
  "Edit channel folder": "Редактировать папку каналов",
  ...
  "Edit saved snippet": "Редактировать сохраненный сниппет",
  ...
  "Email invitation": "Пригласительное письмо",
  ...
  "Enable read receipts": "Включить подтверждения прочтения",
  "Enabled": "Включен",
  ...
  "Enter who should be added.": "Укажите, кого следует добавить.",
  "Error": "Ошибка",
  "Error adding subscription": "Ошибка добавления подписки",
  "Error adding user to {group_name}: {error}": "Ошибка добавления пользователя в группу {group_name}: {error}",
  "Error creating channel": "Ошибка создания канала",
  "Error creating channel: A channel with this name already exists.": "Ошибка при создании канала: канал с таким названием уже есть.",
  ...
  "Error editing message: Message was edited by another client.": "Ошибка редактирования: Сообщение было отредактировано другим клиентом.",
  "Error fetching message edit history.": "Ошибка получения истории редактирования сообщений.",
  "Error in unsubscribing from #{channel_name}": "Ошибка отмены подписки на #{channel_name}",
  "Error joining {group_name}: {error}": "Ошибка присоединения к {group_name}: {error}",
  "Error leaving group {group_name}": "Ошибка при выходе из группы {group_name}",
  "Error listing invites": "Ошибка отображения приглашений",
  "Error moving topic": "Ошибка переноса темы",
  "Error removing alert word <b>{alert_word}</b>!": "Ошибка удаления сигнального слова <b>{alert_word}</b>!",
  "Error removing subgroup from this group.": "Ошибка удаления подгруппы из этой группы.",
  ...
  "Error removing user from group {group_name}": "Ошибка при удалении пользователя из группы {group_name}",
  ...
  "Error: Cannot deactivate the only organization owner.": "Ошибка: нельзя отключить единственного владельца организации.",
  ...
  "Error: Could not resend invitation.": "Ошибка: не удалось повторно отправить приглашение.",
  "Error: Could not resolve topic.": "Ошибка: Не удалось отметить тему как решенную.",
  "Error: Could not revoke invitation.": "Ошибка: не удалось отозвать приглашение.",
  ...
  "Everyone": "Любой",
  "Everyone except guests": "Все, кроме гостей",
  "Everyone including guests": "Все, включая гостей",
  ...
  "Explore how hundreds of community participants use Zulip to brainstorm ideas, discuss technical challenges, ask questions, and give feedback:": "Узнайте, как сотни участников сообщества используют Zulip для мозгового штурма, обсуждения технических проблем, вопросов и отзывов:",
  "Export failed": "Ошибка выгрузки",
  "Export organization": "Выгрузка организации",
  "Export permission": "Разрешение выгрузки данных",
  "Export permissions": "Разрешения выгрузки данных",
  "Export started. Check back in a few minutes.": "Выгрузка данных запущена. Проверьте через несколько минут.",
  "Export type": "Тип выгрузки",
  "Exporting private data for {users_consented_for_export_count, plural, one {# user} other {# users}} ({total_users_count, plural, one {# user} other {# users}} total).": "Экспорт личных данных для {users_consented_for_export_count, plural, one {# пользователя} other {# пользователей}} (всего {total_users_count, plural, one {# пользователь} few {# пользователя} other {# пользователей}}).",
  ...
  "Failed removing one or more channels from the folder": "Не удалось удалить один или несколько каналов из папки",
  "Failed to create video call.": "Не удалось создать видеозвонок.",
  "Failed to generate preview": "Не удалось создать эскиз",
  "Failed to load read receipts.": "Не удалось загрузить подтверждения прочтения.",
  "Failed to subscribe participants": "Не удалось подписать участников",
  ...
  "Failed: Invalid Pattern": "Сбой: неверный шаблон",
  ...
  "File": "Файл",
  "File and image uploads have been disabled for this organization.": "Для данной организации отключена возможность загрузки файлов и изображений.",
  ...
  "Filter component": "Компонент фильтра",
  ...
  "Filter left sidebar": "Фильтр левой панели",
  ...
  "Go to #{channel_name} &gt; <z-topic-display-name></z-topic-display-name>": "Перейти к #{channel_name} &gt; <z-topic-display-name></z-topic-display-name>",
  "Go to #{display_recipient}": "Перейти к #{display_recipient}",
  "Go to #{display_recipient} > {topic_display_name}": "Перейти к #{display_recipient} > {topic_display_name}",
  ...
  "Go to combined feed": "Перейти к объединенной ленте",
  "Go to conversation": "Перейти к беседе",
  "Go to direct message feed": "Перейти к ленте личных сообщений",
  "Go to direct messages with yourself": "Перейти к личным сообщениям с собой",
  ...
  "Go to list of topics": "Перейти к списку тем",
  "Go to list of topics for the current channel": "Перейти к списку тем текущего канала",
  "Go to next unread direct message": "Перейти к следующему непрочитанному личному сообщению",
  "Go to next unread followed topic": "Перейти к следующей непрочитанной отслеживаемой теме",
  "Go to next unread topic": "Перейти к следующей непрочитанной теме",
  "Go to recent conversations": "Перейти к последним беседам",
  "Go to starred messages": "Перейти к отмеченным сообщениям",
  ...
  "Go to {recipient_text}": "Перейти к {recipient_text}",
  "Got it": "Понятно",
  "Got it — Cancel": "Понятно — Отменить",
  "Got it — Confirm": "Понятно — Подтвердить",
  "Government": "Правительство",
  "Granted": "Предоставлено",
  "Group channels by folder": "Группировать каналы по папкам",
  "Group channels by folder in the left sidebar": "Группировать каналы по папкам в левой боковой панели",
  "Group membership": "Членство в группах",
  "Group permissions": "Разрешения для групп",
  "Group settings": "Настройки групп",
  "Guest": "Гость",
  "Guests": "Гости",
  "Guests will be able to see <z-user-count></z-user-count> users in their channels when they join.": "При присоединении гости смогут видеть <z-user-count></z-user-count> пользователей в своих каналах.",
  "Header": "Заголовок",
  ...
  "If you have any questions, please post in the <z-highlight>#user questions</z-highlight> channel, and we'll be happy to help.": "Если у вас возникнут вопросы, пожалуйста, задайте их в канале <z-highlight>#вопросы пользователей</z-highlight>, мы будем рады помочь.",
  ...
  "Increase line spacing": "Увеличить межстрочный интервал",
  "Information": "Информация",
  "Initiate a search": "Начать поиск",
  "Insecure desktop app": "Небезопасное приложение",
  ...
  "Invalid custom time": "Неверное пользовательское время",
  "Invalid date value": "Недопустимое значение даты",
  ...
  "Invite to organization": "Пригласить в организацию",
  "Invite users": "Пригласить пользователей",
  "Invite users to organization": "Пригласить в организацию",
  "Invited as": "Приглашение в роли",
  "Invited at": "Когда приглашен",
  "Invited by": "Кто пригласил",
  "Invitee": "Кто приглашен",
  "Inviting…": "Приглашаю…",
  "Italic": "Курсив",
  "January": "Январь",
  ...
  "Joining and viewing messages requires being invited": "Для присоединения и просмотра сообщений требуется приглашение",
  "Joining and viewing messages requires being invited; users can only view messages sent while they were subscribed": "Для присоединения и просмотра сообщений требуется приглашение; пользователи могут видеть сообщения, отправленные в тот период, когда они были подписаны",
  ...
  "LOG IN TO BROWSE MORE": "ВОЙДИТЕ ДЛЯ ПРОСМОТРА",
  "Label": "Метка",
  "Language": "Язык",
  ...
  "Last edited {edited_time_string}.": "Последняя правка {edited_time_string}.",
  "Last message": "Последнее сообщение",
  "Last modified": "Последнее изменение",
  "Last moved {moved_time_string}.": "Последнее перемещение {moved_time_string}.",
  "Learn more": "Узнать больше",
  "Learn more about emoji reactions <z-link>here</z-link>.": "Узнайте больше об эмодзи-реакциях <z-link>тут</z-link>.",
  "Learn where to find everything you need to get started with this 2-minute video tour.": "Узнайте все необходимое для начала работы с помощью этого 2-минутного видеообзора.",
  ...
  "Let administrators export my private data": "Разрешить администраторам выгружать мои личные данные",
  ...
  "Make <z-highlight>combined feed</z-highlight> my home view": "Сделать <z-highlight>объединенную ленту</z-highlight> моим начальным видом",
  "Make <z-highlight>inbox</z-highlight> my home view": "Сделать <z-highlight>входящие</z-highlight> моим начальным видом",
  "Make <z-highlight>recent conversations</z-highlight> my home view": "Сделать <z-highlight>последние беседы</z-highlight> моим начальным видом",
  "Make it appear in the left sidebar for all subscribers.": "Отображать на левой боковой панели для всех подписчиков.",
  "Make organization permanent": "Сделать организацию постоянной",
  "Manage bot": "Управлять ботом",
  "Manage channel settings": "Управление настройками канала",
  "Manage this bot": "Управлять этим ботом",
  "Manage this user": "Редактировать этого пользователя",
  "Manage user": "Редактировать пользователя",
  ...
  "Mark messages as read": "Отметить сообщения как прочитанные",
  "Mark messages as unread?": "Отметить сообщения как непрочитанные?",
  "Mark topic as read": "Отметить тему как прочитанную",
  "Mark topic as resolved": "Отметить тему как решенную",
  "Matching Zulip channel": "Соответствующий канал Zulip",
  "Math (LaTeX)": "Формулы (LaTeX)",
  "Maximize compose box": "Развернуть поле ввода сообщения",
  "Maximum message length: {max_length} characters": "Предел сообщения: {max_length} симвовлов",
  "Maximum message length: {max_message_length} characters": "Предельная длина сообщения: {max_message_length} символов",
  "Maximum password length: {max_length} characters.": "Максимальная длина пароля: {max_length} символов.",
  "Maximum password length: {max} characters.": "Максимальная длина пароля: {max} символов.",
  "May": "Май",
  "Me": "Я",
  "Member": "Участник",
  "Members": "Участники",
  ...
  "Members preview": "Предварительный просмотр участников",
  ...
  "Message <z-recipient-label></z-recipient-label>": "Написать <z-recipient-label></z-recipient-label>",
  "Message actions": "Действия с сообщением",
  "Message deletion": "Удаление сообщений",
  "Message edit and move history": "История редактирования и перемещения сообщений",
  "Message edit history": "История редактирования сообщения",
  "Message editing": "Редактирование сообщений",
  "Message feed settings": "Настройки ленты сообщений",
  ...
  "Message move history": "История перемещения сообщений",
  "Message moved": "Сообщение перенесено",
  "Message moved to <z-link></z-link>.": "Сообщение перемещено в <z-link></z-link>.",
  "Message retention period": "Срок хранения сообщений",
  "Message sender <z-user-names></z-user-names> is not subscribed to <z-stream></z-stream>.": "Отправитель сообщения <z-user-names></z-user-names> не подписан на <z-stream></z-stream>.",
  ...
  "Messages in all public channels that you can view": "Сообщения во всех открытых каналах, которые вы можете просматривать",
  "Messages in all web-public channels": "Сообщения во всех веб-открытых каналах",
  "Messages in topics you follow.": "Сообщения в отслеживаемых темах.",
  "Messages in your view are faded to remind you that you are viewing a different conversation from the one you are composing to.": "Отображаемые сообщения затенены, чтобы напомнить, что вы просматриваете не ту беседу, в которой пишете.",
  "Messages must be scheduled at least {minimum_scheduled_message_delay_minutes} minutes in the future.": "Отправка сообщений должна быть запланирована не менее чем через {minimum_scheduled_message_delay_minutes} минут.",
  ...
  "Messages with yourself": "Сообщения себе",
  "Messages you sent": "Отправленные вами сообщения",
  "Messaging permissions": "Разрешения на обмен сообщениями",
  "Mobile": "Мобильный",
  ...
  "Moderation permissions": "Разрешения на модерацию",
  "Moderator": "Модератор",
  "Moderators": "Модераторы",
  "Monday": "Понедельник",
  "Monday at {time}": "В понедельник в {time}",
  "Move <z-stream-or-topic></z-stream-or-topic>": "Переместить <z-stream-or-topic></z-stream-or-topic>",
  "Move all messages in this topic": "Переместить все сообщения в данной теме",
  "Move history only": "Только история перемещений",
  "Move message": "Переместить сообщение",
  "Move messages": "Переместить сообщения",
  "Move messages from <z-stream-or-topic></z-stream-or-topic>": "Переместить сообщения из <z-stream-or-topic></z-stream-or-topic>",
  ...
  "Narrow to messages in unresolved topics.": "Показать только сообщения в нерешенных темах.",
  ...
  "Never": "Никогда",
  "Never ask on this computer": "Не предлагать на этом устройстве",
  ...
  "New password is too weak!": "Новый пароль слишком слабый!",
  ...
  "No DM recipients": "Нет получателей прямых сообщений",
  "No bots match your current filter.": "Нет ботов, соответствующих текущему фильтру.",
  "No channel folders configured.": "Папки каналов не настроены.",
  "No channel selected": "",
  ...
  "No channels match your filter.": "Нет каналов, соответствующих вашему фильтру.",
  ...
  "No custom profile fields configured.": "Дополнительные поля профиля не заданы.",
  "No deactivated users match your filters.": "Нет деактивированных пользователей, соответствующих вашим фильтрам.",
  ...
  "No reminders scheduled.": "Напоминаний не запланировано.",
  ...
  "No subscribers.": "Нет подписчиков.",
  "No topic entered": "",
  ...
  "Non-archived channels": "Актуальные каналы",
  "Non-profit (registered)": "Некоммерческое (зарегистрированное)",
  "None": "Нет",
  "None of the members of <z-group-pill></z-group-pill> are subscribed to this channel.": "Никто из участников <z-group-pill></z-group-pill> не подписан на этот канал.",
  "None of your messages have emoji reactions yet.": "Ни одно из ваших сообщений пока не получило эмодзи-реакцию.",
  "Not a member of any groups.": "Не состоит ни в одной из групп.",
  "Not active in the last year": "За последний год не было активности",
  ...
  "Notification Bot to you": "Бот для уведомлений вам",
  "Notification message cannot be sent when subscribing more than {max_users} users.": "Уведомление не может быть отправлено, если подписано более {max_users} пользователей.",
  ...
  "OTHER": "ПРОЧИЕ",
  "OTHER CHANNELS": "ПРОЧИЕ КАНАЛЫ",
  "OTHERS": "ДРУГИЕ",
  "Objects": "Объекты",
  "October": "Октябрь",
  "Offer to update to my computer's time zone": "Предложить установить в соответствии с часовым поясом компьютера",
  ...
  "One or more files could not be deleted.": "Не удалось удалить один или несколько файлов.",
  ...
  "Only the <z-empty-string-topic-display-name></z-empty-string-topic-display-name> topic is allowed in this channel.": "В этом канале разрешено использовать только тему <z-empty-string-topic-display-name></z-empty-string-topic-display-name>.",
  "Only topics you follow": "Только темы, которые вы отслеживаете",
  "Only “{empty_topic_name}” topic allowed": "Разрешена только тема “{empty_topic_name}”",
  "Open": "Открыть",
  "Open help menu": "Открыть меню справки",
  "Open message menu": "Открыть меню сообщения",
  "Open personal menu": "Открыть личное меню",
  "Open {text}": "Открыть {text}",
  ...
  "Organization administrators can automatically administer all channels.": "Администраторы организации автоматически могут управлять всеми каналами.",
  ...
  "Organization default ({org_level_topics_policy})": "Стандарт организации ({org_level_topics_policy})",
  "Organization default {org_level_message_retention_setting}": "Стандарт организации {org_level_message_retention_setting}",
  ...
  "Organization profile incomplete": "Профиль организации не заполнен",
  ...
  "PastedText": "ВставленныйТекст",
  "Pattern": "Шаблон",
  "People & Body": "Люди и части тела",
  ...
  "Please enter task title.": "Пожалуйста, введите название задачи.",
  ...
  "Prevent messages in this channel from being edited, deleted, or moved.": "Запретить редактирование, удаление и перенос сообщений в этом канале.",
  "Prevent new messages from being sent to this channel.": "Запретить отправку новых сообщений в этот канал.",
  ...
  "Profile": "Профиль",
  "Profile missing required fields": "В профиле не заполнены обязательные поля",
  "Pronouns": "Местоимения",
  "Public": "Открытый",
  "Public data": "Общедоступные данные",
  "Question": "Вопрос",
  "Quote": "Цитата",
  "Quote message": "Цитировать сообщение",
  ...
  "Reactivate group": "Возобновить группу",
  ...
  "Read receipts": "Подтверждения прочтения",
  "Read receipts are currently disabled in this organization.": "Подтверждения прочтения в настоящее время отключены в этой организации.",
  "Read receipts are disabled for this organization.": "Подтверждения прочтения отключены для этой организации.",
  "Read receipts are not available for Notification Bot messages.": "Подтверждения прочтения недоступны для сообщений бота оповещений.",
  "Recent conversations": "Последние беседы",
  "Recent conversations options": "Настройки последних бесед",
  "Reloading…": "Идёт загрузка…",
  "Remind me about this": "Напомнить мне об этом",
  "Reminder scheduled": "Запланировано напоминание",
  ...
  "Rename {group_name} (<i>deactivated</i>)": "Переименовать {group_name} (<i>deactivated</i>)",
  ...
  "Reset to default font size ({default_value})": "Вернуть шрифт к размеру по умолчанию ({default_value})",
  "Reset to default line spacing": "Вернуть к межстрочному интервалу по умолчанию",
  "Reset to default notifications": "Сбросить настройки уведомлений",
  "Reset to default notifications?": "Сбросить уведомления до настроек по умолчанию?",
  "Reset zoom": "Сбросить масштаб",
  "Resolved topics": "Решенные темы",
  ...
  "Schedule reminder": "Запланировать напоминание",
  ...
  "Scrolling": "Прокрутка",
  "Scrolling to your last message will mark <b>{num_unread}</b> unread messages as read. Would you like to scroll to that message and edit it?": "Переход к вашему последнему сообщению отметит непрочитанные сообщения - <b>{num_unread}</b> шт. - прочитанными. Хотите перейти к этому сообщению и отредактировать его?",
  "Search": "Поиск",
  ...
  "Search all web-public channels.": "Искать во всех веб-открытых каналах.",
  ...
  "See the <z-integrations>integrations</z-integrations> and <z-api>API</z-api> documentation for more information.": "Подробности смотрите в документации по <z-integrations>интеграциям</z-integrations> и <z-api>API</z-api>.",
  ...
  "Send": "Отправить",
  "Send a custom Welcome Bot message": "Отправить персонализированное сообщение приветственного бота",
  "Send a custom Welcome Bot message to new users": "Отправить персонализированное сообщение приветственного бота новым пользователям",
  ...
  "Send automated notice to new topic": "Сообщить о переносе в новой теме",
  "Send automated notice to old topic": "Сообщить о переносе в старой теме",
  ...
  "Send emails introducing Zulip to new users": "Отправлять ознакомительные письма о Zulip новым пользователям",
  ...
  "Send me a test message": "Отправить мне тестовое сообщение",
  ...
  "Send notification message to newly subscribed users": "Отправить уведомление новым подписчикам",
  "Send notifications for all branches": "Отправлять оповещения для всех веток",
  "Send options": "Варианты отправки",
  "Send the default Welcome Bot message configured for this organization": "Отправить стандартное для этой организации сообщение приветственного бота",
  "Send weekly digest emails to inactive users": "Посылать еженедельный дайджест по электронной почте неактивным пользователям",
  "Sending messages to the <z-empty-string-topic-display-name></z-empty-string-topic-display-name> topic is not allowed in this channel.": "Отправка сообщений в <z-empty-string-topic-display-name></z-empty-string-topic-display-name> не разрешена в этом канале.",
  "Sending…": "Отправка…",
  "Sent!": "Отправлено!",
  "Sent! Your message is outside your current view.": "Отправлено! Ваше сообщение вне вашей текущей области просмотра.",
  "September": "Сентябрь",
  "Server needs upgrade": "Требуется обновление сервера",
  "Set font size to default": "Вернуть к размеру шрифта по умолчанию",
  "Set line spacing to default": "Вернуть к межстрочному интервалу по умолчанию",
  ...
  "Show channel folders": "Показать папки каналов",
  "Show counts for starred messages": "Показывать счетчик отмеченных сообщений",
  "Show edits and moves": "Показать правки и перемещения",
  ...
  "Show when other users are typing": "Показывать, когда пользователи набирают текст",
  "Showing messages since {time_string}.": "Показаны сообщения начиная с: {time_string}.",
  "Sign up": "Зарегистрироваться",
  "Size": "Размер",
  "Skip the rest": "Пропустить остальное",
  "Skip video — I'm familiar with Zulip": "Пропустить видео — я знаю Zulip",
  "Skipped unsubscribed channels": "Каналы без подписки пропущены",
  "Slack-compatible": "Slack-совместимый",
  ...
  "Some topic participants <z-user-names></z-user-names> are not subscribed to <z-stream></z-stream>.": "Некоторые участники темы <z-user-names></z-user-names> не подписаны на <z-stream></z-stream>.",
  ...
  "Starred messages options": "Настройки отмеченных сообщений",
  ...
  "Subscribe all of them": "Подписать всех",
  "Subscribe them": "Подписать",
  "Subscribe to <z-stream></z-stream>": "Подписаться на <z-stream></z-stream>",
  "Subscribe to this channel": "Подписаться на этот канал",
  ...
  "Switch to the dark theme": "Переключить в темный режим",
  "Symbols": "Символы",
  "System bot": "Системный бот",
  "THIS CHANNEL": "ЭТОТ КАНАЛ",
  "THIS CONVERSATION": "ЭТА БЕСЕДА",
  "Task already exists": "Задача уже есть",
  "Task description (optional)": "Описание задачи (необязательное)",
  "Task list": "Список задач",
  "Tasks": "Задачи",
  "The administrators provided the following comment:": "Администраторы предоставили следующий комментарий:",
  "The application has been updated; Reloading…": "Приложение было обновлено; идет загрузка…",
  "The basics": "Основы",
  "The channel <z-highlight>#{channel_name}</z-highlight> does not exist. Manage your subscriptions <z-link>on your Channels page</z-link>.": "Канал <z-highlight>#{channel_name}</z-highlight> отсутствует. Управляйте подписками <z-link>на своей странице каналов</z-link>.",
  "The channel description cannot contain newline characters.": "В описании канала нельзя использовать перенос строки.",
  "The following <z-link>uploaded files</z-link> are no longer attached to any messages. They can still be accessed from this message's edit history. Would you like to delete them entirely?": "Следующие <z-link>загруженные файлы</z-link> больше не прикреплены к сообщениям. Они по-прежнему доступны в истории редактирования этого сообщения. Вы хотите удалить их полностью?",
  "The following <z-link>uploaded files</z-link> are no longer attached to any messages. Would you like to delete them entirely?": "Следующие <z-link>загруженные файлы</z-link> больше не прикреплены к сообщениям. Вы хотите удалить их полностью?",
  ...
  "The topic <z-topic-name>{topic_display_name}</z-topic-name> already exists in this channel. Are you sure you want to combine messages from these topics? This cannot be undone.": "Тема <z-topic-name>{topic_display_name}</z-topic-name> уже есть в этом канале. Вы уверены, что хотите объединить сообщения из этих тем? Это действие нельзя отменить.",
  "The topic you were composing to (<z-link></z-link>) was moved, and the destination for your message has been updated to its new location.": "Тема, в которой вы создавали сообщение (<z-link></z-link>), была перемещена, и место назначения вашего сообщения обновлено.",
  "Their password will be cleared from our systems, and any bots they maintain will be disabled.": "Пароль будет удален, а боты отключены.",
  "Theme": "Режим оформления",
  "There are no bots.": "Ботов нет.",
  "There are no channel folders configured in this organization.": "В этой организации не настроены папки каналов.",
  ...
  "There are no exports.": "Результатов выгрузки нет.",
  "There are no groups matching your filters.": "Нет групп, соответствующих вашим фильтрам.",
  "There are no invitations.": "Приглашений нет.",
  "There are no messages here.": "Тут нет сообщений.",
  "There are no messages in this topic.": "В этой теме нет сообщений.",
  "There are no messages in your combined feed.": "В вашей объединенной ленте нет сообщений.",
  "There are no messages to move.": "Нет сообщений для переноса.",
  "There are no topics in this view.": "В этом представлении нет тем.",
  ...
  "There was an error updating the setting.": "Произошла ошибка обновления настроек.",
  ...
  "This bot cannot be managed.": "Этим ботом нельзя управлять.",
  ...
  "This demo organization will be automatically deleted in 30 days, unless it's converted into a permanent organization.": "Эта демонстрационная организация будет автоматически удалена через 30 дней, если она не будет преобразована в постоянную организацию.",
  "This demo organization will be automatically deleted in {days_remaining} days, unless it's converted into a permanent organization.": "Эта демонстрационная организация будет автоматически удалена через {days_remaining} дней, если она не будет преобразована в постоянную организацию.",
  "This feature is available on Zulip Cloud Plus.": "Эта возможность доступна в Zulip Cloud Plus.",
  ...
  "This group has been deactivated.": "Эта группа была отключена.",
  "This group has no assigned permissions.": "У этой группы нет назначенных разрешений.",
  "This group has no members.": "В этой группе нет участников.",
  "This group has this permission because it's a subgroup of {supergroup_name}.": "У этой группы есть такое разрешение, потому что она является подгруппой {supergroup_name}.",
  "This group is deactivated. It can't be mentioned or used for any permissions.": "Эта группа отключена. Ее нельзя упоминать или использовать для каких-либо разрешений.",
  ...
  "This silent mention won't trigger notifications.": "Это беззвучное упоминание не вызовет оповещения.",
  "This user cannot be deactivated.": "Этого пользователя нельзя отключить.",
  ...
  "This user is a member of {name} because they are a member of a subgroup ({subgroups_name}).": "Этот пользователь является участником {name}, потому что он/а входит в подгруппу ({subgroups_name}).",
  ...
  "Time limit for moving messages between channels": "Ограничение времени для переноса сообщений в другой канал",
  "Time zone": "Часовой пояс",
  "Time zone update offer": "Предложение обновления часового пояса",
  "Time zone updated": "Часовой пояс обновлен",
  "Time's up!": "Время вышло!",
  "Tip: You can watch this video without sound.": "Совет: вы можете смотреть это видео без звука.",
  "Title": "Заголовок",
  ...
  "To deactivate this group, you must first remove all permissions assigned to it.": "Перед отключением этой группы необходимо удалить все назначенные ей разрешения.",
  "To deactivate this group, you must first remove it from all other groups. This group is currently a subgroup of: <z-supergroup-names></z-supergroup-names>.": "Чтобы деактивировать эту группу, необходимо сначала удалить её из всех других групп. В настоящее время эта группа является подгруппой: <z-supergroup-names></z-supergroup-names>.",
  "To edit or reschedule a message, click on it or press <z-shortcut></z-shortcut>.": "Чтобы отредактировать или перенести сообщение, щёлкните по нему или нажмите <z-shortcut></z-shortcut>.",
  "To enable this configuration, all messages in this channel must be in the <z-empty-string-topic-display-name></z-empty-string-topic-display-name> topic. Consider <z-link-rename>renaming</z-link-rename> other topics to <z-empty-string-topic-display-name></z-empty-string-topic-display-name>.": "Чтобы включить эту настройку, все сообщения в этом канале должны быть в теме <z-empty-string-topic-display-name></z-empty-string-topic-display-name>. Рассмотрите возможность <z-link-rename>переименования</z-link-rename> других тем в <z-empty-string-topic-display-name></z-empty-string-topic-display-name>.",
  ...
  "To view a muted topic, click <b>show all topics</b> in the left sidebar, and select one from the list. <z-link>Learn more</z-link>": "Чтобы просмотреть заглушенную тему, нажмите <b>показать все темы</b> на левой боковой панели и выберите её в списке. <z-link>Узнать больше</z-link>",
  ...
  "Topics you don't follow": "Темы, на которые вы не подписаны",
  ...
  "Upload your Slack export zip file.": "Загрузите ваш zip-файл экспорта Slack.",
  ...
  "Use or create a saved snippet": "Использовать или создать сохраненный сниппет",
  "Use the <z-highlight>back</z-highlight> button in your browser or desktop app.": "Используйте кнопку <z-highlight>назад</z-highlight> в браузере или приложении.",
  ...
  "User group ID": "ID группы пользователей",
  "User group creation": "Создание группы пользователей",
  "User group description": "Описание группы пользователей",
  "User group details": "Подробности группы пользователей",
  "User group name": "Название группы пользователей",
  "User group permissions": "Разрешения групп пользователей",
  "User group settings": "Настройки групп пользователей",
  ...
  "Users": "Пользователи",
  "Users can always disable their personal read receipts.": "Пользователи всегда могут отключить свои личные подтверждения прочтения.",
  "Users can edit this field for their own account": "Пользователи могут редактировать это поле для своей учетной записи",
  "Users can still search for messages in archived channels. You can always unarchive this channel.": "Пользователи по-прежнему смогут искать сообщения в архивных каналах. Вы всегда можете разархивировать этот канал.",
  ...
  "View all members": "Все участники",
  "View all subscribers": "Все подписчики",
  ...
  "View edit and move history": "Показать историю редактирования и перемещения",
  "View edit history": "Показать историю редактирования",
  "View file": "Показать файл",
  "View in channel settings": "Посмотреть в настройках канала",
  ...
  "View messages with yourself": "Посмотреть сообщения себе",
  "View move history": "Показать историю перемещения",
  "View original message": "Посмотреть исходный текст сообщения",
  "View permissions": "Посмотреть разрешения",
  "View profile": "Просмотр профиля",
  "View read receipts": "Показать подтверждения прочтения",
  ...
  "Viewing the conversation where you sent your message. To go back, use the <z-highlight>back</z-highlight> button in your browser or desktop app.": "Просмотр беседы, в которую вы отправили сообщение. Чтобы вернуться, нажмите кнопку <z-highlight>назад</z-highlight> в браузере или приложении.",
  "Visual": "Визуальные",
  "Visual desktop notifications": "Визуальные оповещения",
  "Waiting period (days)": "Период ожидания (дни)",
  "Waiting period before new members turn into full members": "Период ожидания, после которого новые участники становятся полноправными участниками",
  "Warn when composing a DM to a guest": "Предупреждать при составлении сообщения гостю",
  ...
  "Web-public": "Веб-открытый",
  "Webhook format": "Формат вебхука",
  "Wednesday": "Среда",
  "Week of {date}": "Неделя {date}",
  "Welcome Bot message text is required.": "Текст сообщения приветственного бота обязателен.",
  "Welcome back! You have at least {unread_msgs_count} unread messages. Do you want to mark them all as read?": "Рады видеть вас снова! У вас не менее {unread_msgs_count} непрочитанных сообщений. Хотите отметить их все как прочитанные?",
  "Welcome back! You have {unread_msgs_count} unread messages. Do you want to mark them all as read?": "Рады видеть вас снова! У вас {unread_msgs_count} непрочитанных сообщений. Хотите отметить их все как прочитанные?",
  "Welcome to Zulip!": "Добро пожаловать в Zulip!",
  "Welcome to recent conversations!": "Добро пожаловать в недавние беседы!",
  "Welcome to the Zulip development community!": "Добро пожаловать в сообщество разработчиков Zulip!",
  "Welcome to your inbox!": "Добро пожаловать во входящие сообщения!",
  "What pronouns should people use to refer to you?": "Какие местоимения следует использовать при вашем упоминании?",
  "When you deactivate <z-user></z-user>, they will be immediately logged out.": "При отключении пользователя <z-user></z-user> для него/нее немедленно будет выполнен выход из системы.",
  ...
  "Which branches should notifications be sent for?": "Для каких веток следует отправлять уведомления?",
  "Which messages do you want to mark as read? This action cannot be undone.": "Какие сообщения вы хотите отметить как прочитанные? Это действие не может быть отменено.",
  "Which messages should be moved?": "Какие сообщения следует переместить?",
  "Which parts of the emails should be included in the Zulip messages?": "Какие части электронных писем следует включать в сообщения Zulip?",
  "Who can access this channel": "У кого есть доступ к этому каналу",
  ...
  "Who can add members to this group": "Кто может добавлять участников в эту группу",
  "Who can administer all user groups": "Кто может управлять всеми группами пользователей",
  "Who can administer this channel": "Кто может управлять этим каналом",
  "Who can administer this group": "Кто может управлять этой группой",
  "Who can allow users to delete messages in channels they administer": "Кто может разрешить пользователям удалять сообщения в каналах, которые они администрируют",
  ...
  "Who can create any bot": "Кто может создавать любых ботов",
  "Who can create bots that send messages into Zulip": "Кто может создавать ботов, отправляющих сообщения в Zulip",
  ...
  "Who can create user groups": "Кто может создавать группы пользователей",
  "Who can create web-public channels": "Кто может создавать веб-открытые каналы",
  "Who can delete any message": "Кто может удалять любые сообщения",
  "Who can delete any message in this channel": "Кто может удалять любые сообщения в этом канале",
  "Who can delete their own messages everywhere": "Кто может удалять свои сообщения везде",
  "Who can delete their own messages in this channel": "Кто может удалять свои сообщения в этом канале",
  "Who can edit topics in any channel": "Кто может редактировать темы в любом канале",
  "Who can join this group": "Кто может присоединяться к этой группе",
  "Who can leave this group": "Кто может покидать эту группу",
  "Who can manage plans and billing": "Кто может управлять тарифом и расчетами",
  "Who can mention this group": "Кто может упоминать эту группу",
  "Who can move messages inside this channel": "Кто может перемещать сообщения внутри этого канала",
  "Who can move messages out of any channel": "Кто может перемещать сообщения из любого канала",
  "Who can move messages out of this channel": "Кто может перемещать сообщения из этого канала",
  ...
  "Who can post to this channel": "Кто может писать сообщения в этом канале",
  "Who can remove members from this group": "Кто может удалять участников из этой группы",
  "Who can resolve topics": "Кто может отмечать темы как решенные",
  "Who can resolve topics in this channel": "Кто может отмечать темы как решенные в этом канале",
  ...
  "Who can subscribe anyone to this channel": "Кто может подписать кого угодно на этот канал",
  "Who can subscribe others to channels": "Кто может подписать других на каналы",
  "Who can subscribe to this channel": "Кто может подписаться на этот канал",
  "Who can unsubscribe anyone from this channel": "Кто может отписать кого угодно от этого канала",
  "Who can use AI summaries": "Кто может использовать обобщения ИИ",
  ...
  "You are a member of this group because you are a member of a subgroup (<z-highlight>{associated_subgroup_names}</z-highlight>).": "Вы являетесь участником этой группы, поскольку состоите в подгруппе (<z-highlight>{related_subgroup_names}</z-highlight>).",
  "You are a member of this group because you are a member of a subgroup (<z-subgroup-names></z-subgroup-names>).": "Вы являетесь участником этой группы, потому что входите в подгруппу (<z-subgroup-names></z-subgroup-names>).",
  "You are a member of this group.": "Вы являетесь участником этой группы.",
  "You are a member of {name} because you are a member of a subgroup ({subgroups_name}).": "Вы являетесь участником {name}, потому что входите в подгруппу ({subgroups_name}).",
  ...
  "You are already a member of this group because you are a member of a subgroup": "Вы уже являетесь участником этой группы, потому что входите в ее подгруппу",
  "You are moving messages to a topic that already exists. Messages from these topics will be combined.": "Вы перемещаете сообщения в уже существующую тему. Сообщения этих тем будут объединены.",
  "You are not a member of any user groups.": "Вы не являетесь участником ни одной группы пользователей.",
  "You are not a member of this group.": "Вы не являетесь участником этой группы.",
  "You are not allowed to add members to this group": "Вам не разрешено добавлять участников в эту группу",
  "You are not allowed to change this field. Contact an administrator to update it.": "Вам не разрешено изменять это поле. Обратитесь к администратору, чтобы обновить его.",
  "You are not allowed to remove this permission.": "Вы не можете удалить это разрешение.",
  "You are not allowed to start direct message conversations.": "Вам не разрешено начинать беседу личным сообщением.",
  "You are not subscribed to <z-stream-name></z-stream-name>. <subscribe-button></subscribe-button>": "Вы не подписаны на <z-stream-name></z-stream-name>. <subscribe-button></subscribe-button>",
  ...
  "You cannot create a user group with no members or subgroups.": "Вы не можете создать группу пользователей без участников или подгрупп.",
  "You cannot join a deactivated user group.": "Вы не можете присоединиться к отключенной группе пользователей.",
  "You cannot leave a deactivated user group.": "Вы не можете покинуть отключенную группу пользователей.",
  ...
  "You do not have permission to add other users to this channel.": "У вас нет права добавлять других пользователей в этот канал.",
  "You do not have permission to create bots.": "У вас нет права создавать ботов.",
  "You do not have permission to create channels.": "У вас нет права создавать каналы.",
  "You do not have permission to create user groups.": "У вас нет права создавать группы пользователей.",
  "You do not have permission to edit this setting.": "У вас нет права редактирования этой настройки.",
  ...
  "You do not have permission to use <z-highlight>@topic</z-highlight> mentions in this topic.": "У вас нет права использования упоминаний <z-highlight>@topic</z-highlight> в этой теме.",
  "You do not have permission to use <z-highlight>@{wildcard_mention_string}</z-highlight> mentions in this channel.": "У вас нет права использования упоминаний <z-highlight>@{wildcard_mention_string}</z-highlight> в этом канале.",
  ...
  "You have muted this channel.": "Вы заглушили этот канал.",
  ...
  "You have no direct messages with these users.": "У вас нет личной переписки с этими пользователями.",
  "You have no direct messages with {person} yet.": "У вас пока нет личной переписки с пользоваталем {person}.",
  ...
  "You subscribed to <z-stream-name></z-stream-name>. <channel-settings-link></channel-settings-link>": "Вы подписались на <z-stream-name></z-stream-name>. <channel-settings-link></channel-settings-link>",
  "You type": "Вы пишете",
  "You unsubscribed from <z-stream-name></z-stream-name>. <channel-settings-link></channel-settings-link>": "Вы отменили подписку на <z-stream-name></z-stream-name>. <channel-settings-link></channel-settings-link>",
  ...
  "You will be able to export all public data, and (optionally) private data from users who have given their permission.": "Вы сможете выгрузить все общедоступные данные, а также (по желанию) личные данные пользователей, которые дали на это разрешение.",
  "You will lose access to content in this channel if you make it private. To keep access, subscribe or grant yourself permission to do so under Advanced configurations.": "Вы потеряете доступ к содержимому этого канала, если сделаете его закрытым. Чтобы сохранить доступ, подпишитесь или дайте себе разрешение на это в разделе дополнительных настроек канала.",
  "You will no longer be prompted to update your time zone.": "Вам больше не будет предлагаться изменение часового пояса.",
  "You will not receive notifications about new messages.": "Вы не будете получать оповещения о новых сообщениях.",
  "You will now see the channel you created. To go back to channel settings, you can:": "Сейчас вы увидите созданный канал. Для возврата к настройкам канала:",
  "You will receive a confirmation email at the new address you enter.": "На указанный вами новый адрес придет письмо с подтверждением.",
  "You'll see a list of <z-highlight>recent conversations</z-highlight>, where each conversation is labeled with a topic by the person who started it. Click on a conversation to view it. You can always get back to recent conversations from the left sidebar.": "Вы увидите список <z-highlight>последних бесед</z-highlight>, где каждое обсуждение озаглавлено темой, которую задал его автор. Нажмите на обсуждение, чтобы просмотреть его. Вы всегда можете вернуться к последним беседам с помощью левой боковой панели.",
  "You're done!": "Готово!",
  "You're marking the topic <z-highlight>{topic_name}</z-highlight> as resolved. This adds a ✔ at the beginning of the topic name to let everyone know that this conversation is done. <z-link>Learn more</z-link>": "Вы отмечаете тему <z-highlight>{topic_name}</z-highlight> как решённую. Это добавит ✔ в начало названия темы, чтобы все знали, что обсуждение завершено. <z-link>Узнать больше</z-link>",
  ...
  "Your Zulip account email (<z-highlight>{email}</z-highlight>) is not linked to this organization's Zoom account.": "Адрес электронной почты вашей учетной записи Zulip (<z-highlight>{email}</z-highlight>) не связан с учетной записью Zoom этой организации.",
  ...
  "Your organization is using {percent_used}% of your {upload_quota} file storage quota. Upgrade for more space.": "Ваша организация использует {percent_used}% вашей квоты хранилища файлов {upload_quota}. Обновите тариф, чтобы увеличить объем.",
  ...
  "Your organization’s data will be exported in a format designed for imports into Zulip Cloud or a self-hosted installation of Zulip.": "Данные вашей организации будут выгружены в формате, предназначенном для импорта в Zulip Cloud или в собственный сервер Zulip.",
  "Your password": "Ваш пароль",
  "Your profile is missing required fields.": "В вашем профиле не все обязательные поля заполнены.",
  "Your question": "Ваш вопрос",
  "Your reminder has been scheduled for {translated_time}.": "Напоминание установлено на {translated_time}.",
  "Your status": "Ваш статус",
  "Your time zone was updated to {time_zone}.": "Ваш часовой пояс был установлен как {time_zone}.",
  "Your time zone:": "Ваш часовой пояс:",
  "Your uploads": "Ваши загрузки",
  "You’ll see a list of <z-highlight>conversations</z-highlight> where you have <z-highlight>unread messages</z-highlight>, organized by channel.": "Вы увидите упорядоченный по каналам список <z-highlight>бесед</z-highlight>, в которых есть <z-highlight>непрочитанные сообщения</z-highlight>.",
  "You’ll see a list of <z-highlight>ongoing conversations</z-highlight>.": "Вы увидите список <z-highlight>текущих бесед</z-highlight>.",
  "Zoom to message in conversation context": "Сфокусироваться на сообщении в контексте беседы",
  "Zulip": "Zulip",
  "Zulip Desktop is not updating automatically. Please upgrade for security updates and other improvements.": "Приложение Zulip не обновляется автоматически. Пожалуйста, обновите версию для получения обновлений безопасности и других улучшений.",
  ...
  "[Quoting…]": "[Цитирование...]",
  "acme": "acme",
  "and {remaining_senders, plural, one {1 other} other {# others}}.": "и ещё {remaining_senders, plural, one {# чел.} other {# чел.}}.",
  "archived": "архив",
  "back to channels": "назад к каналам",
  "cookie": "cookie",
  "days": "дн.",
  ...
  "does not apply to users who can delete any message": "не относится к пользователям, которые могут удалять любые сообщения",
  "everyone except guests can subscribe to any public channel": "все, кроме гостей, могут подписаться на любой открытый канал",
  ...
  "{inactive_or_muted_count} inactive or muted": "{inactive_or_muted_count} неактивных или заглушенных",
  ...
  "{unsubscribed_participants_count} topic participants are not subscribed to <z-stream></z-stream>.": "{unsubscribed_participants_count} участников темы не подписаны на <z-stream></z-stream>.",
