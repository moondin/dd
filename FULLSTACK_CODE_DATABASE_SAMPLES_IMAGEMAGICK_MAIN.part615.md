...
## Verbatim Content (Part 615 of 851)
...
---[FILE: mime.html]---
Location: ImageMagick-main/www/api/mime.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Mime Methods, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Mime Methods</h1>
    </a>
  </header>

  <main class="container">
<h1 class="text-center">Mime</h1>
<div class="btn-group">
<button class="btn btn-secondary dropdown-toggle" type="button" id="defaultDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
  Select API Method
</button>
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#AcquireMimeCache">AcquireMimeCache</a></li>
  <li><a href="#GetMimeInfoList">GetMimeInfoList</a></li>
  <li><a href="#GetMimeList">GetMimeList</a></li>
  <li><a href="#GetMimeDescription">GetMimeDescription</a></li>
...
<pre class="bg-light text-dark mx-4"><samp>LinkedListInfo *AcquireMimeCache(const char *filename,
...
<pre class="bg-light text-dark mx-4"><samp>const MimeInfo **GetMimeInfoList(const char *pattern,
...
<pre class="bg-light text-dark mx-4"><samp>char **GetMimeList(const char *pattern,size_t *number_aliases,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const char *GetMimeDescription(const MimeInfo *mime_info)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const char *GetMimeType(const MimeInfo *mime_info)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType ListMimeInfo(FILE *file,ExceptionInfo *exception)
</samp></pre>
