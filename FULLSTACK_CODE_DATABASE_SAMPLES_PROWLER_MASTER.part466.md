...
## Verbatim Content (Part 466 of 867)
...
---[FILE: cloudtrail_log_file_validation_enabled_test.py]---
Location: prowler-master/tests/providers/aws/services/cloudtrail/cloudtrail_log_file_validation_enabled/cloudtrail_log_file_validation_enabled_test.py
...
class Test_cloudtrail_log_file_validation_enabled:
    ...
    def test_no_logging_validation(self):
        ...
        with (
            ...
            assert (
                ...
                == f"Single region trail {trail_name_us} has log file validation disabled."
            )
            ...
            for report in result:
                if report.resource_id == trail_name_us:
                    ...
                    assert (
                        ...
                        == f"Single region trail {trail_name_us} has log file validation enabled."
                    )
                    ...
                    assert (
                        report.status_extended
                        == f"Single region trail {trail_name_eu} has log file validation disabled."
                    )
    ...
    def test_trail_multi_region_auditing_other_region(self):
        ...
        with (
            ...
            assert (
                result[0].status_extended
                == f"Multiregion trail {trail_name_us} has log file validation disabled."
            )
            assert result[0].region == AWS_REGION_US_EAST_1
            assert result[0].resource_tags == []
```
...
---[FILE: cloudtrail_multi_region_enabled_fixer_test.py]---
Location: prowler-master/tests/providers/aws/services/cloudtrail/cloudtrail_multi_region_enabled/cloudtrail_multi_region_enabled_fixer_test.py
...
---[FILE: cloudtrail_multi_region_enabled_test.py]---
Location: prowler-master/tests/providers/aws/services/cloudtrail/cloudtrail_multi_region_enabled/cloudtrail_multi_region_enabled_test.py
