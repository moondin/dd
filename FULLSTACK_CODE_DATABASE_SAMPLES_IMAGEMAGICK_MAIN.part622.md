...
## Verbatim Content (Part 622 of 851)
...
---[FILE: profile.html]---
Location: ImageMagick-main/www/api/profile.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Dealing with Image Profiles, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Dealing with Image Profiles</h1>
    </a>
  </header>
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#CloneImageProfiles">CloneImageProfiles</a></li>
  <li><a href="#DeleteImageProfile">DeleteImageProfile</a></li>
  <li><a href="#DestroyImageProfiles">DestroyImageProfiles</a></li>
  <li><a href="#GetImageProfile">GetImageProfile</a></li>
  <li><a href="#GetNextImageProfile">GetNextImageProfile</a></li>
  <li><a href="#ProfileImage">ProfileImage</a></li>
  <li><a href="#RemoveImageProfile">RemoveImageProfile</a></li>
  <li><a href="#ResetImageProfileIterator">ResetImageProfileIterator</a></li>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType CloneImageProfiles(Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType DeleteImageProfile(Image *image,const char *name)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void DestroyImageProfiles(Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const StringInfo *GetImageProfile(const Image *image,const char *name)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>char *GetNextImageProfile(const Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType ProfileImage(Image *image,const char *name,
...
<pre class="bg-light text-dark mx-4"><samp>void *RemoveImageProfile(Image *image,const char *name)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void ResetImageProfileIterator(const Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SetImageProfile(Image *image,const char *name,
...
<p>SyncImageProfiles() synchronizes image properties with the image profiles.</p>

<p>The format of the SyncImageProfiles method is:</p>

<pre class="bg-light text-dark mx-4"><samp>void SyncImageProfiles(Image *image)
</samp></pre>
