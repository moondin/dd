...
## Verbatim Content (Part 628 of 851)
...
---[FILE: statistic.html]---
Location: ImageMagick-main/www/api/statistic.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Image Statistics, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Image Statistics</h1>
    </a>
  </header>
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#EvaluateImage">EvaluateImage</a></li>
  <li><a href="#FunctionImage">FunctionImage</a></li>
  <li><a href="#GetImageEntropy">GetImageEntropy</a></li>
  <li><a href="#GetImageExtrema">GetImageExtrema</a></li>
  <li><a href="#GetImageKurtosis">GetImageKurtosis</a></li>
  <li><a href="#GetImageMean">GetImageMean</a></li>
  <li><a href="#GetImageMedian">GetImageMedian</a></li>
  <li><a href="#GetImageMoments">GetImageMoments</a></li>
  <li><a href="#GetImagePerceptualHash">GetImagePerceptualHash</a></li>
  <li><a href="#GetImageRange">GetImageRange</a></li>
  <li><a href="#GetImageStatistics">GetImageStatistics</a></li>
  <li><a href="#PolynomialImage">PolynomialImage</a></li>
</ul>
</div>
<br/>
<br/>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType EvaluateImage(Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType FunctionImage(Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetImageEntropy(const Image *image,double *entropy,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetImageExtrema(const Image *image,size_t *minima,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetImageKurtosis(const Image *image,double *kurtosis,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetImageMean(const Image *image,double *mean,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetImageMedian(const Image *image,double *median,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ChannelMoments *GetImageMoments(const Image *image,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ChannelPerceptualHash *GetImagePerceptualHash(const Image *image,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetImageRange(const Image *image,double *minima,
...
<pre class="bg-light text-dark mx-4"><samp>channel_statistics=GetImageStatistics(image,exception);
...
<pre class="bg-light text-dark mx-4"><samp>ChannelStatistics *GetImageStatistics(const Image *image,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *PolynomialImage(const Image *images,const size_t number_terms,
...
<pre class="bg-light text-dark mx-4"><samp>Image *StatisticImage(const Image *image,const StatisticType type,
...
---[FILE: stream.html]---
Location: ImageMagick-main/www/api/stream.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: The Pixel FIFO, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
  <meta name="description" content="ImageMagick is a powerful, open-source software suite for creating, editing, converting, and manipulating images in over 200 formats. Ideal for web developers, graphic designers, and researchers, it offers versatile tools for image processing, including batch processing, format conversion, and complex image transformations." />
  <meta name="application-name" content="ImageMagick" />
  <meta name="application-url" content="https://imagemagick.org" />
  <meta name="copyright" content="Copyright (c) 1999 ImageMagick Studio LLC" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: The Pixel FIFO</h1>
    </a>
  </header>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType StreamImageCommand(ImageInfo *image_info,int argc,
