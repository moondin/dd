...
## Verbatim Content (Part 607 of 851)
...
---[FILE: layer.html]---
Location: ImageMagick-main/www/api/layer.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Dealing with Image Layers, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Dealing with Image Layers</h1>
    </a>
  </header>

  <main class="container">
<h1 class="text-center">Layer</h1>
<div class="btn-group">
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  ...
  <li><a href="#DisposeImages">DisposeImages</a></li>
  <li><a href="#CompareImagesLayers">CompareImagesLayers</a></li>
  <li><a href="#OptimizeImageLayers">OptimizeImageLayers</a></li>
  <li><a href="#OptimizeImagePlusLayers">OptimizeImagePlusLayers</a></li>
  <li><a href="#OptimizeImageTransparency">OptimizeImageTransparency</a></li>
  <li><a href="#RemoveDuplicateLayers">RemoveDuplicateLayers</a></li>
  <li><a href="#RemoveZeroDelayLayers">RemoveZeroDelayLayers</a></li>
  <li><a href="#CompositeLayers">CompositeLayers</a></li>
</ul>
</div>
<br/>
<br/>
...
<pre class="bg-light text-dark mx-4"><samp>Image *CoalesceImages(Image *image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *DisposeImages(Image *image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *CompareImagesLayers(const Image *images,
...
<pre class="bg-light text-dark mx-4"><samp>Image *OptimizeImageLayers(const Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>Image *OptimizePlusImageLayers(const Image *image,
         ExceptionInfo *exception)
</samp></pre>
...
<p>The format of the OptimizeImageTransparency method is:</p>

<pre class="bg-light text-dark mx-4"><samp>void OptimizeImageTransparency(Image *image,ExceptionInfo *exception)
</samp></pre>
...
<p>No check is made with regards to image disposal setting, though it is the dispose setting of later image that is kept.  Also any time delays are also added together. As such coalesced image animations should still produce the same result, though with duplicate frames merged into a single frame.</p>

<p>The format of the RemoveDuplicateLayers method is:</p>

<pre class="bg-light text-dark mx-4"><samp>void RemoveDuplicateLayers(Image **image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void RemoveZeroDelayLayers(Image **image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void CompositeLayers(Image *destination, const CompositeOperator
...
<pre class="bg-light text-dark mx-4"><samp>Image *MergeImageLayers(Image *image,const LayerMethod method,
  ExceptionInfo *exception)
</samp></pre>
