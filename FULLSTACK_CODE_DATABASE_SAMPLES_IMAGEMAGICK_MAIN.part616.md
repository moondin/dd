...
## Verbatim Content (Part 616 of 851)
...
---[FILE: module.html]---
Location: ImageMagick-main/www/api/module.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Loadable Modules, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Loadable Modules</h1>
    </a>
  </header>
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#AcquireModuleInfo">AcquireModuleInfo</a></li>
  <li><a href="#DestroyModuleList">DestroyModuleList</a></li>
  <li><a href="#GetModuleInfo">GetModuleInfo</a></li>
  <li><a href="#GetModuleInfoList">GetModuleInfoList</a></li>
  <li><a href="#GetModuleList">GetModuleList</a></li>
  <li><a href="#GetMagickModulePath">GetMagickModulePath</a></li>
  <li><a href="#IsModuleTreeInstantiated">IsModuleTreeInstantiated</a></li>
  <li><a href="#InvokeDynamicImageFilter">InvokeDynamicImageFilter</a></li>
  <li><a href="#ListModuleInfo">ListModuleInfo</a></li>
  <li><a href="#OpenModule">OpenModule</a></li>
  <li><a href="#OpenModules">OpenModules</a></li>
  <li><a href="#RegisterModule">RegisterModule</a></li>
  <li><a href="#TagToCoderModuleName">TagToCoderModuleName</a></li>
  <li><a href="#TagToFilterModuleName">TagToFilterModuleName</a></li>
  <li><a href="#TagToModuleName">TagToModuleName</a></li>
</ul>
</div>
<br/>
<br/>
...
<pre class="bg-light text-dark mx-4"><samp>ModuleInfo *AcquireModuleInfo(const char *path,const char *tag)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void DestroyModuleList(void)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ModuleInfo *GetModuleInfo(const char *tag,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const ModuleInfo **GetModuleInfoList(const char *pattern,
...
<pre class="bg-light text-dark mx-4"><samp>char **GetModuleList(const char *pattern,const MagickModuleType type,
  size_t *number_modules,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetMagickModulePath(const char *filename,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType IsModuleTreeInstantiated(void)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType InvokeDynamicImageFilter(const char *tag,Image **image,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType ListModuleInfo(FILE *file,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType OpenModule(const char *module,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType OpenModules(ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ModuleInfo *RegisterModule(const ModuleInfo *module_info,
...
<pre class="bg-light text-dark mx-4"><samp>char *TagToCoderModuleName(const char *tag,char *name)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void TagToFilterModuleName(const char *tag,char name)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void TagToModuleName(const char *tag,const char *format,char *module)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType UnregisterModule(const ModuleInfo *module_info,
  ExceptionInfo *exception)
</samp></pre>
...
---[FILE: mogrify.html]---
Location: ImageMagick-main/www/api/mogrify.html
...
<head>
  ...
  <meta name="keywords" content="MagickWand, C API: Command-line Interface, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
  <meta name="description" content="ImageMagick is a powerful, open-source software suite for creating, editing, converting, and manipulating images in over 200 formats. Ideal for web developers, graphic designers, and researchers, it offers versatile tools for image processing, including batch processing, format conversion, and complex image transformations." />
  <meta name="application-name" content="ImageMagick" />
  <meta name="application-url" content="https://imagemagick.org" />
  <meta name="copyright" content="Copyright (c) 1999 ImageMagick Studio LLC" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickWand, C API: Command-line Interface</h1>
    </a>
  </header>

  <main class="container">
<h1 class="text-center">Mogrify</h1>
<div class="btn-group">
<button class="btn btn-secondary dropdown-toggle" type="button" id="defaultDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
  Select API Method
</button>
