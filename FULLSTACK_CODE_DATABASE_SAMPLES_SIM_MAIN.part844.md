...
## Verbatim Content (Part 844 of 933)
...
---[FILE: 0043_snapshot.json]---
Location: sim-main/packages/db/migrations/meta/0043_snapshot.json

```json
{
  "id": "05e26e13-3a24-4e29-b48b-e70b156e7434",
  "prevId": "5a104de1-5afa-46be-bbe8-5a8759024b15",
  "version": "7",
  "dialect": "postgresql",
  "tables": {
    "public.account": {
    ...
    "public.embedding": {
      ...
      "indexes": {
        ...
        "emb_chunk_hash_idx": {
          "name": "emb_chunk_hash_idx",
          "columns": [
            {
              "expression": "chunk_hash",
              "isExpression": false,
              "asc": true,
              "nulls": "last"
            }
    ...
    "public.workflow_edges": {
      ...
      "indexes": {
        ...
        "workflow_edges_source_block_fk_idx": {
          "name": "workflow_edges_source_block_fk_idx",
          "columns": [
            {
              "expression": "source_block_id",
              "isExpression": false,
        ...
        "workflow_edges_target_block_fk_idx": {
          "name": "workflow_edges_target_block_fk_idx",
          "columns": [
            {
              "expression": "target_block_id",
              "isExpression": false,
