...
## Verbatim Content (Part 107 of 991)
...
---[FILE: chat-model-tool-calling.ipynb]---
Location: mlflow-master/docs/docs/genai/flavors/chat-model-guide/chat-model-tool-calling.ipynb
