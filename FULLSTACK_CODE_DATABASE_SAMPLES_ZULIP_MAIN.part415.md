...
## Verbatim Content (Part 415 of 1290)
...
Location: zulip-main/locale/tl/translations.json
...
```json
{
  ...
  "About Zulip": "",
  "Account": "Kwenta",
  "Account & privacy": "Kwenta at Pananatiling mag-isa",
  "Action": "Kilos",
  "Action message": "",
  "Actions": "Mga Kilos",
  "Active an hour ago": "",
  ...
  "Active bots": "",
  "Active groups": "",
  "Active now": "Masugid ngayon",
  "Active users": "Masugid na mga tagagamit",
  "Active yesterday": "",
  ...
  "Add a new emoji": "Dagdagan ng bagong emoji",
  "Add a new linkifier": "Dagdagan ng bagong linkifier",
  "Add a new profile field": "",
  "Add alert word": "Idagdag ang salitang pang-alerto",
  ...
  "Add option": "",
  "Add poll": "",
  "Add question": "Idagdag ang tanong",
  "Add roles, groups or users": "",
  "Add saved snippet": "",
  "Add subscribers": "",
  "Add subscribers to": "",
  "Add subscribers.": "",
  "Add task": "Idagdag ang alituntunin",
  "Add to-do list": "",
  "Add todo task list title": "",
  "Add user groups": "",
  "Add users or groups. Use #channelname to add all subscribers.": "",
  "Add video call": "Idagdag ang tawag na pang-bidyo",
  "Add voice call": "",
  ...
  "Admins": "Mga Tagapamahala",
  "Admins and moderators": "Mga Tagapamahala at Mga Pangulo ng Talakayan",
  "Admins only": "Tanging Mga Tagapamahala lamang",
  ...
  "Alert word": "Salitang pang-alerto",
  "Alert word <b>{alert_word}</b> removed successfully!": "",
  "Alert word already exists!": "Salitang pang-alerto ay naidagdag na!",
  "Alert words": "",
  ...
  "Allow subdomains": "Payagan ang mababang larangan",
  "Allow viewing the history of a message?": "",
  "Allow “{empty_topic_name}”": "",
  "Allowed domains": "Pinayagan na mga larangan",
  ...
  "Already not subscribed.": "Hindi na sumusubaybay.",
  ...
  "Are you sure you want to resend the invitation to <z-email></z-email>?": "Ikaw ba ay panatag na magpadala ng paanyaya sa <z-email></z-email>?",
  "Are you sure you want to reset notifications for <z-stream></z-stream>?": "",
  "Are you sure you want to revoke the invitation to <strong>{email}</strong>?": "Ikaw ba ay panatag na tanggalin ang paanyaya sa <strong>{email}</strong>?",
  "Are you sure you want to revoke this invitation link created by <strong>{referred_by}</strong>?": "Ikaw ba ay panatag na tanggalin ang kawing na paanyayang ginawa ni <strong>{referred_by}</strong>?",
  ...
  "August": "Agosto",
  "Authentication methods": "Pamamaraan ng pagpapatunay ng katauhan",
  "Author": "Akda",
  ...
  "Large number of subscribers": "Malaking bilang ng mga taga-sunod",
  "Last 10 days": "Huling 10 araw",
  "Last 2 months": "Huling 2 buwan",
  ...
  "Mark as unresolved": "Tatakan bilang hindi nalutas",
  ...
  "Moderator": "Pangulo ng Talakayan",
  "Moderators": "Mga Pangulo ng Talakayan",
  "Monday": "Lunes",
  "Monday at {time}": "",
  ...
  "New password": "Bagong kontrasenya",
  ...
  "No, I'll catch up.": "Hindi, hahabol ako.",
  "No, don't ask again.": "",
  ...
  "Owners": "Mga May-ari",
  "PINNED CHANNELS": "",
  "Participants": "Mga Makikilahok",
  "Participated": "Mga Nakilahok",
  ...
  "You and {recipients}": "Ikaw at {recipients}",
  ...
  "You have no unread messages!": "Wala kang hindi nabasang mga mensahe!",
