...
## Verbatim Content (Part 765 of 867)
...
---[FILE: identity_password_policy_minimum_length_14_test.py]---
Location: prowler-master/tests/providers/oraclecloud/services/identity/identity_password_policy_minimum_length_14/identity_password_policy_minimum_length_14_test.py
...
---[FILE: identity_password_policy_prevents_reuse_test.py]---
Location: prowler-master/tests/providers/oraclecloud/services/identity/identity_password_policy_prevents_reuse/identity_password_policy_prevents_reuse_test.py
...
---[FILE: identity_service_level_admins_exist_test.py]---
Location: prowler-master/tests/providers/oraclecloud/services/identity/identity_service_level_admins_exist/identity_service_level_admins_exist_test.py
...
class Test_identity_service_level_admins_exist:
    def test_no_resources(self):
        """identity_service_level_admins_exist: No resources to check"""
        identity_client = mock.MagicMock()
        identity_client.audited_compartments = {OCI_COMPARTMENT_ID: mock.MagicMock()}
        identity_client.audited_tenancy = OCI_TENANCY_ID
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.oraclecloud.services.identity.identity_service_level_admins_exist.identity_service_level_admins_exist.identity_client",
                new=identity_client,
            ),
        ):
            from prowler.providers.oraclecloud.services.identity.identity_service_level_admins_exist.identity_service_level_admins_exist import (
    ...
    def test_resource_compliant(self):
        """identity_service_level_admins_exist: Resource passes the check (PASS)"""
        identity_client = mock.MagicMock()
        identity_client.audited_compartments = {OCI_COMPARTMENT_ID: mock.MagicMock()}
        identity_client.audited_tenancy = OCI_TENANCY_ID
    ...
    def test_resource_non_compliant(self):
        """identity_service_level_admins_exist: Resource fails the check (FAIL)"""
        identity_client = mock.MagicMock()
        identity_client.audited_compartments = {OCI_COMPARTMENT_ID: mock.MagicMock()}
        identity_client.audited_tenancy = OCI_TENANCY_ID
