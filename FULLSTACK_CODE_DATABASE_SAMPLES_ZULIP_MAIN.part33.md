...
## Verbatim Content (Part 33 of 1290)
...
---[FILE: add_minimum_licenses--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/add_minimum_licenses--Event.list.2.json
      ...
      "data": {
        "object": {
          ...
          "payment_details": {
            ...
            "order_reference": "in_1SVWxVDwzgQ85STgwcmLVM"
          },
    ...
    },
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "add_minimum_licenses--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "add_minimum_licenses--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
