...
## Verbatim Content (Part 68 of 1290)
...
---[FILE: fixed_price_plans--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/fixed_price_plans--Event.list.2.json
  ...
  "data": [
    {
      ...
      "data": {
        "object": {
          ...
          "currency": "usd",
          "custom_fields": null,
          "customer": "fixed_price_plans--Customer.create.1.json",
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "fixed_price_plans--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
    ...
    },
    {
      ...
      "data": {
        "object": {
          ...
          "id": "fixed_price_plans--Customer.create.1.json",
