...
## Verbatim Content (Part 572 of 851)
...
---[FILE: mogrify.html]---
Location: ImageMagick-main/www/mogrify.html
...
<head>
  ...
  <!-- Canonical URL -->
  <link rel="canonical" href="mogrify.html" />
  ...
  <meta property="og:title" content="ImageMagick | Command-line Tools: Mogrify" />
  ...
  <meta property="og:url" content="../www/mogrify.html" />
  ...
  <meta name="twitter:title" content="ImageMagick | Command-line Tools: Mogrify" />
  ...
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <div class="mt-3 ms-3">
      <a href="../index.html" class="text-decoration-none">
        <h1 class="fs-2 mb-1">Command-line Tools: Mogrify</h1>
      </a>
...
<p>You can find additional examples of using <samp>mogrify</samp> in <a href="../index.html">Examples of ImageMagick Usage</a>.</p>
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="command-line-options.html#path">-path <var>path</var></a></td>
...
<!-- Magick Cache 3rd October 2025 21:39 -->
```
