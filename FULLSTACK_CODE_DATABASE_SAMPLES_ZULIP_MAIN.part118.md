...
## Verbatim Content (Part 118 of 1290)
...
---[FILE: migrate_customer_server_to_realms_and_upgrade--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/migrate_customer_server_to_realms_and_upgrade--Event.list.2.json
  ...
  "data": [
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "migrate_customer_server_to_realms_and_upgrade--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
          "payment_method_details": {
            "card": {
              "amount_authorized": 176000,
              "authorization_code": "336350",
              "brand": "visa",
              "checks": {
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "migrate_customer_server_to_realms_and_upgrade--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
