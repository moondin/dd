...
## Verbatim Content (Part 418 of 1290)
...
Location: zulip-main/locale/tr/translations.json
...
```json
{
  ...
  "(to you and {other_participant_names})": "(sana ve {other_participant_names})",
  "(to you and {participants_count} more)": "(sana ve {participants_count} fazla)",
  "(to you)": "(sana)",
  "(you)": "(sen)",
  ...
  "<kbd>Enter</kbd> sends when composing a message": "<kbd>Gir tuşu </kbd> bir mesaj oluştururken gönderir",
  ...
  "<strong>{name}</strong> <i>(guest)</i> is not subscribed to this channel. They will not be notified if you mention them.": "<strong>{name}</strong> <i>(guest)</i> bu Kanal'a üye değil. Kendilerinden bahsederseniz bildirim gitmeyecektir.",
  "<strong>{name}</strong> <i>(guest)</i> is not subscribed to this channel. They will not be notified unless you subscribe them.": "<strong>{name}</strong> <i>(guest)</i> bu Kanal'a üye değil. Onları üye yapmadığınız sürece kendilerine bildirim gitmeyecektir.",
  "<strong>{name}</strong> is not subscribed to this channel. They will not be notified if you mention them.": "<strong>{name}</strong> bu Kanal'a üye değil. Kendilerinden bahsederseniz bilgilendirilmezler.",
  "<strong>{name}</strong> is not subscribed to this channel. They will not be notified unless you subscribe them.": "<strong>{name}</strong> bu Kanal'a üye değil. Onları üye yapmadığınız sürece kendilerine bildirim gitmeyecektir.",
  ...
  "<z-link>Learn more.</z-link>": "<z-link>Daha fazla bilgi.</z-link>",
  "<z-link>Learn more</z-link> about other data export options.": "<z-link>Daha fazla bilgi.</z-link> diğer veri dışa aktarma seçenekleri hakkında.",
  "<z-user></z-user> will have the same properties as it did prior to deactivation, including role, owner and channel subscriptions.": "<z-user></z-user> rol, sahip ve kanal aboneliği dahil olmak üzere devre dışı bırakılmadan önce sahip olduğu aynı özelliklere sahip olacak.",
  "<z-user></z-user> will have the same role, channel subscriptions, user group memberships, and other settings and permissions as they did prior to deactivation.": "<z-user></z-user> devre dışı bırakılmadan önce sahip oldukları rol, kanal abonelikleri, kullanıcı grubu üyelikleri ve diğer ayarlar ile izinlere sahip olacaklar.",
  ...
  "A public data export is a complete data export for your organization other than <z-private-channel-link>private channel</z-private-channel-link> messages and <z-direct-messages-link>direct messages</z-direct-messages-link>.": "Genel veri dışa aktarımı, Organizasyonunuz için şunlar dışında eksiksiz bir veri aktarımıdır <z-private-channel-link>özel kanal</z-private-channel-link> mesajlar ve<z-direct-messages-link>özel mesajlar </z-direct-messages-link>.",
  "A standard export additionally includes private data accessible to users who have allowed administrators to export their private data.": "Standart bir dışa aktarma ayrıca, yöneticilerin özel verilerini dışa aktarmalarına izin veren kullanıcıların erişebildiği özel verileri de içerir.",
  ...
  "Add members to {group_name}": "Üyeleri şuraya ekle {group_name}",
  "Add one or more users": "Bir veya daha fazla kullanıcı ekle",
  "Add option": "Seçenek ekle",
  "Add poll": "Anket ekle",
  "Add question": "Soru ekle",
  "Add roles, groups or users": "Rol, gruplar veya kullanıcılar ekleyin",
  "Add saved snippet": "Kaydedilmiş kod parçası ekle",
  "Add subscribers": "Abone ekle",
  "Add subscribers to": "Aboneleri şuraya ekleyin",
  "Add subscribers.": "",
  "Add task": "Görev ekle",
  "Add to-do list": "",
  "Add todo task list title": "Yapılacaklar görev listesi başlığı ekle",
  "Add user groups": "",
  "Add users or groups. Use #channelname to add all subscribers.": "Kullanıcı veya grup ekleyin. Tüm aboneleri eklemek için #kanal adı kullanın.",
  ...
  "All messages": "",
  "All messages including muted channels": "Sessize alınan kanallar dahil tüm mesajlar",
  "All roles ({count})": "Tüm roller ({count})",
  "All time": "Tüm zaman",
  ...
  "All your messages except those in muted channels and topics.": "Sessiz kanallardaki ve konulardaki mesajlarınız hariç tüm mesajlarınız.",
  "All your messages.": "Tüm mesajlarınız.",
  "Allow creating web-public channels (visible to anyone on the Internet)": "Web'de herkese açık kanallar oluşturmaya izin verin (İnternet'teki herkes tarafından görülebilir)",
  ...
  "Already subscribed to {channel}": "Zaten {channel} 'a aboneyim",
  ...
  "An archived channel with this name already exists.": "Bu isimde arşivlenmiş bir kanal zaten mevcut.",
  "An hour ago": "1 saat önce",
  "An unknown error occurred.": "Bilinmeyen bir hata oluştu.",
  "Animals & Nature": "",
  "Announce new channel in": "Yeni kanalı şurada duyurun",
  ...
  "Anyone on the internet can view messages; members of your organization can join.": "İnternetteki herkes mesajları görüntüleyebilir; Organizasyonunuzun üyeleri de dahil olabilir.",
  ...
  "Archived channels": "",
  "Archiving this channel will:": "Bu kanalın arşivlenmesi:",
  "Are you sure you want to continue?": "Devam etmek istediğine emin misin?",
  "Are you sure you want to create channel ''''{channel_name}'''' and subscribe {count} users to it?": "''''{channel_name}'''' kanalını oluşturmak ve bu kanala {count} kullanıcı abone etmek istediğinizden emin misiniz?",
  ...
  "Are you sure you want to resend the invitation to <z-email></z-email>?": "Davetiyeyi yeniden göndermek istediğinizden emin misiniz <z-email></z-email> ?",
  ...
  "Automatically go to conversation where you sent a message": "Mesajı gönderdiğiniz sohbete otomatik olarak gidin",
  ...
  "Automatically unmute topics in muted channels": "Sessiz kanallardaki konuların sesini otomatik olarak aç",
  "Available": "",
  ...
  "BROWSE 1 MORE CHANNEL": "1 KANALA DAHA GÖZ AT",
  "BROWSE {can_subscribe_stream_count} MORE CHANNELS": "DAHA FAZLA KANALA {can_subscribe_stream_count} GÖZ ATIN",
  "Back to channels": "Kanallara geri dön",
  "Back to settings": "Ayarlara geri dön",
  "Bankruptcy": "",
  ...
  "CHANNELS": "KANALLAR",
  "CREATE A CHANNEL": "BIR KANAL OLUŞTURUN",
  ...
  "Cannot save invalid Jitsi server URL.": "Geçersiz Jitsi sunucu URL kaydedilemiyor.",
  ...
  "Cannot subscribe to private channel <z-stream></z-stream>": "Özel kanala abone olunamıyor <z-stream></z-stream>",
  ...
  "Change language": "Dil değiştirme",
  ...
  "Change your email": "E-postanızı değiştirin",
  ...
  "Channel feed": "Kanal akışı",
  "Channel folder": "",
  "Channel folder name": "",
  "Channel folders": "",
  "Channel links in the left sidebar go to": "Sol kenar çubuğundaki kanal bağlantıları şuraya gider",
  ...
  "Channels organize conversations based on who needs to see them.": "Kanallar, konuşmaları kimlerin görmesi gerektiğine göre düzenler.",
  ...
  "Click on a conversation to view it. To return here, you can:": "Görüntülemek için bir sohbete tıklayın. Buraya geri dönmek için:",
  ...
  "Collapse compose box": "Oluştur kutusunu daralt",
  ...
  "Configure new channel settings": "Yeni kanal ayarlarını konfigüre etme",
  "Configure new group settings": "Yeni grup ayarlarını konfigüre etme",
  ...
  "Configure topic notifications": "Konu bildirimlerini konfigüre etme",
  ...
  "Content": "İçerik",
  "Continue": "Devam et",
  "Continue to add members": "Üye eklemeye devam edin",
  "Continue to add subscribers": "Abone eklemeye devam edin",
  "Convert": "Çevir",
  ...
  "Copy draft": "",
  "Copy email": "E-posta kopyala",
  "Copy email address": "",
  "Copy link": "Bağlantıyı kopyala",
  "Copy link to channel": "Linki kanala kopyala",
  ...
  "Create a collaborative to-do list": "Ortak bir yapılacaklar listesi oluşturun",
  ...
  "Create link": "Bağlantı Link'i oluştur",
  ...
  "Deactivate group": "Grubu devre dışı bırak",
  ...
  "Delete reminder": "",
  "Delete saved snippet?": "Kaydedilen kod parçası silinsin mi?",
  "Delete scheduled message": "Zamanlanmış mesajı sil",
  "Delete selected draft": "Seçili taslağı sil",
  "Delete snippet": "Kaydedilen kod parçasını sil",
  "Delete topic": "Konuyu sil",
  "Delete uploaded files?": "Yüklenen dosyalar silinsin mi?",
  "Deleted": "Silindi",
  ...
  "Direct message feed": "Direkt mesaj akışı",
  ...
  "Mark topic as read": "Konuyu okundu işaretle",
  ...
  "New password is too weak!": "Yeni parola zayıf!",
  "New task": "Yeni görev",
  "New topic": "Yeni konu",
  ...
  "Please select a channel.": "Lütfen bir kanal belirtin.",
  ...
  "Welcome to Zulip!": "Zulip'e hoşgeldiniz!",
