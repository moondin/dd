...
## Verbatim Content (Part 55 of 650)
...
---[FILE: ApplicationSettingsForm.cs]---
Location: ShareX-develop/ShareX/Forms/ApplicationSettingsForm.cs
    ...
    public partial class ApplicationSettingsForm : Form
    {
        ...
        private async void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (exportSettings || exportHistory)
            {
                ...
                {
                    sfd.DefaultExt = "sxb";
                    string pcName = FileHelpers.SanitizeFileName(Environment.MachineName);
                    sfd.FileName = $"ShareX-{Helpers.GetApplicationVersion()}-{pcName}-backup.sxb";
