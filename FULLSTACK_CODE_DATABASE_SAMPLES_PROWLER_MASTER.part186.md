...
## Verbatim Content (Part 186 of 867)
...
---[FILE: cis_1.11_kubernetes.json]---
Location: prowler-master/prowler/compliance/kubernetes/cis_1.11_kubernetes.json
Signals: Docker
      ...
      "Attributes": [
        {
          ...
          "ImpactStatement": "None",
          "RemediationProcedure": "Run the following command to modify the file permissions of the `--client-ca-file`  ``` chmod 644 <filename> ```",
