...
## Verbatim Content (Part 558 of 851)
...
---[FILE: history.html]---
Location: ImageMagick-main/www/history.html
...
<head>
  ...
  <meta name="keywords" content="History, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<p class="lead">ImageMagick started with a request from my DuPont supervisor, Dr. David Pensak, to display computer-generated images on a monitor only capable of showing 256 unique colors simultaneously.</p>
...
<!-- Magick Cache 1st March 2025 16:40 -->
```
