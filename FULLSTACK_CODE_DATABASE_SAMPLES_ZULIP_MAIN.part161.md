...
## Verbatim Content (Part 161 of 1290)
...
---[FILE: stripe_billing_portal_urls_for_remote_server--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/stripe_billing_portal_urls_for_remote_server--Event.list.2.json
  ...
  "data": [
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "stripe_billing_portal_urls_for_remote_server--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
          "payment_method_details": {
            "card": {
              "amount_authorized": 176000,
              "authorization_code": "939138",
              "brand": "visa",
              "checks": {
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "stripe_billing_portal_urls_for_remote_server--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
