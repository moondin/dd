...
## Verbatim Content (Part 753 of 1290)
...
---[FILE: portico_signin.css]---
Location: zulip-main/web/styles/portico/portico_signin.css
...
#slack-import-dashboard-wrapper {
    width: 100%;
    margin: 10px 0 0 5px;

    #slack-import-dashboard {
        margin-right: 5px;
    }
...
#slack-import-dashboard .uppy-DragDrop-container {
...
#demo-realm-creation .new-organization-button,
#new-realm-creation .new-organization-button {
    margin-bottom: 0;
}

#demo-realm-creation #demo-submit-button-container,
...
---[FILE: portico_variables.css]---
Location: zulip-main/web/styles/portico/portico_variables.css
