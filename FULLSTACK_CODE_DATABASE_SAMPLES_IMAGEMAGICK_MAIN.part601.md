...
## Verbatim Content (Part 601 of 851)
...
---[FILE: exception.html]---
Location: ImageMagick-main/www/api/exception.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Dealing with Exceptions, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Dealing with Exceptions</h1>
    </a>
  </header>
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#AcquireExceptionInfo">AcquireExceptionInfo</a></li>
  <li><a href="#ClearMagickException">ClearMagickException</a></li>
  <li><a href="#CatchException">CatchException</a></li>
  <li><a href="#CloneExceptionInfo">CloneExceptionInfo</a></li>
  ...
  <li><a href="#InitializeExceptionInfo">InitializeExceptionInfo</a></li>
  <li><a href="#MagickError">MagickError</a></li>
  <li><a href="#MagickFatalError">MagickFatalError</a></li>
...
<pre class="bg-light text-dark mx-4"><samp>ExceptionInfo *AcquireExceptionInfo(void)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void ClearMagickException(ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void CatchException(ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ExceptionInfo *CloneException(ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ExceptionInfo *DestroyExceptionInfo(ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>char *GetExceptionMessage(const int error)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const char *GetLocaleExceptionMessage(const ExceptionType severity,
  const char *tag)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void InheritException(ExceptionInfo *exception,const ExceptionInfo *relative)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void InitializeExceptionInfo(ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void MagickError(const ExceptionType error,const char *reason,
...
<pre class="bg-light text-dark mx-4"><samp>void MagickFatalError(const ExceptionType error,const char *reason,
  const char *description)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void MagickWarning(const ExceptionType warning,const char *reason,
  const char *description)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ErrorHandler SetErrorHandler(ErrorHandler handler)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ErrorHandler SetWarningHandler(ErrorHandler handler)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType ThrowException(ExceptionInfo *exception,
