...
## Verbatim Content (Part 431 of 1290)
...
---[FILE: django.po]---
Location: zulip-main/locale/zh_TW/LC_MESSAGES/django.po
...
#
# Translators:
# Brian Chang <exee25@gmail.com>, 2024
...
"users to join."
msgstr ""
"您的組織已無剩餘 Zulip 授權，無法再新增使用者。請[增加授權數量]"
...
msgstr ""
"新使用者 ({email}) 無法加入，因為您的組織沒有足夠的 Zulip 授權。若要允許新使"
...
msgstr ""
"您的組織申請贊助託管已獲得批准！您已免費升級至 {plan_name} 方案。{emoji}\n"
"\n"
...
msgstr ""
"請改為<a href=\"https://zulip.com/help/self-hosted-billing#manage-billing\">"
...
msgstr ""
"或是從 <a href=\"/help/import-from-slack\">Slack</a>、<a href=\"/help/import-"
...
msgstr ""
"此頁面將自動重新導向至 <a href=\"%(auto_redirect_to)s\" id=\"deactivated-org-"
...
msgstr ""
"恭喜，您已建立了一個新的 Zulip 示範組織。請注意 此組織將在 30 天後自動刪除。"
"了解更多 示範組織相關資訊請<a href=\"%(demo_organizations_help_link)s\">點此"
"</a>！"
...
msgstr ""
"恭喜，您已建立了一個新的 Zulip 示範組織。請注意此組織將在 30 天後自動刪除。了"
"解更多示範組織資訊請點此：%(demo_organizations_help_link)s！"
...
msgstr ""
"與您的團隊<a href=\"%(trying_out_zulip)s\"><b>進行為期一週的試用</b></a>，不"
...
"about…?”"
msgstr ""
"要開始一個新對話，只需選擇一個頻道並開始一個新議題。這樣，新的對話議題就不會"
...
msgstr ""
"不要為您的議題挑選完美名稱而感到壓力。如果有任何內容放錯位置，您可以輕鬆地<a "
"href=\"%(move_messages_link)s\">移動訊息</a>、<a "
...
msgstr ""
"不要為您的議題挑選完美名稱而感到壓力。如果有任何內容放錯位置，您可以輕鬆地移"
...
msgstr ""
"還有透過 <a href=\"/integrations/doc/zapier\">Zapier</a> 和 <a href=\"/"
"integrations/doc/ifttt\">IFTTT</a> 提供的數百個整合。"
...
msgstr ""
"請嘗試不同的網址、<a href=\"%(root_domain_url)s/accounts/find/\">取得您的 "
...
msgstr ""
"請嘗試不同的網址、<a href=\"%(root_domain_url)s/accounts/find/\">取得您在此伺"
...
"or misconfiguration."
msgstr ""
"看起來您是意外到達這個頁面。這個網站 是認證流程中的中繼步驟， 不應該手動存"
...
msgstr ""
"在此伺服器上建立新組織需要有效的組織建立連結。 請參閱 <a href=\"https://"
...
msgstr ""
"在匯入的資料中沒有帳號符合您在 Zulip 中已驗證的電子郵件地址"
...
msgstr ""
"請按照<a href=\"https://zulip.com/help//import-from-slack#export-your-slack-"
"data:~:text=Export%%20user%%20data%%20and%%20custom%%20emoji\" "
...
msgstr "或<a href=\"#\" id=\"cancel-slack-import\">建立組織</a>而不匯入資料。"
...
msgstr "{reporting_user_mention} 回報了由 {reported_user_mention} 發送的私訊。"
...
msgstr ""
"{reporting_user_mention} 回報了由 {reported_user_mention} 發送給 "
"{recipient_mentions} 和 {last_user_mention} 的私訊。"
...
msgstr ""
"{reporting_user_mention} 回報了由 {reported_user_mention} 發送的 "
...
msgstr "**由 {reported_user_mention} 發送的訊息**"
...
"除非[轉換為永久組織]({convert_demo_organization_help_url})，\n"
"否則將會在 30 天後**自動刪除**。\n"
...
msgstr ""
"\n"
"前往[個人檔案設定](#settings/profile)來新增[個人照片](/help/change-your-"
"profile-picture)\n"
...
msgstr ""
"\n"
"您可以在[喜好設定](#settings/preferences)中切換[亮色和暗色議題](/help/dark-"
"theme)、\n"
...
msgstr ""
"\n"
"若有任何內容位置不當，您可以輕易地 [移動訊息]"
"({move_content_another_topic_help_url}),\n"
"[重新命名]({rename_topic_help_url}) and [分割]"
...
msgstr "{user_silent_mention} [發送了]({conversation_url})一個投票。"
...
msgstr "{webhook} webhook 預期時間以毫秒為單位。"
...
msgstr "請確保至少有一位組織擁有者同意此匯出，或聯繫 {email} 尋求協助。"
...
msgstr ""
"請確認至少有一位組織擁有者允許其他管理員查看其電子郵件地址，或聯絡 {email} 尋"
"求協助"
...
msgstr "正在轉換 Slack 資料… 這可能需要一些時間。"
...
msgstr "連接 BigBlueButton 伺服器時發生錯誤。"
...
#~ msgstr "您只能邀請其他 Zephyr 鏡像使用者到封閉頻道。"
...
#~ msgstr "此組織不允許 Zephyr 鏡像"

#~ msgid "Could not find Kerberos credential"
#~ msgstr "找不到 Kerberos 憑證"

#~ msgid "Webathena login not enabled"
#~ msgstr "未啟用 Webathena 登入"

#~ msgid "Invalid Kerberos cache"
#~ msgstr "無效的 Kerberos 快取"
