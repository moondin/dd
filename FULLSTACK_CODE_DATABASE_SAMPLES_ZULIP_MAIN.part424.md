...
## Verbatim Content (Part 424 of 1290)
...
Location: zulip-main/locale/vi/translations.json
...
```json
{
  ...
  "<z-user></z-user> will have the same role, channel subscriptions, user group memberships, and other settings and permissions as they did prior to deactivation.": "<z-user></z-user>sẽ có cùng vai trò, đăng ký Stream, tư cách thành viên nhóm người dùng cũng như các cài đặt và quyền khác như họ đã làm trước khi hủy kích hoạt.",
  "@{name} (guest)": "",
  "A channel with this name already exists.": "Tên này đã được sử dụng trong một stream khác.",
  ...
  "Add another user…": "",
  "Add channel": "Thêm stream",
  "Add channels": "Thêm stream",
  ...
  "Alerted messages": "",
  "All": "",
  "All channels": "Tất cả các dòng hội thoại",
  "All groups": "",
  "All groups were already members.": "",
  "All messages": "",
  "All messages including muted channels": "Tất cả tin nhắn bao gồm cả Stream bị tắt tiếng",
  "All roles ({count})": "",
  "All time": "",
  "All topics": "",
  "All unmuted topics": "",
  ...
  "Archive channel": "Lưu trữ stream",
  ...
  "Back to channels": "Quay lại Stream",
  "Back to settings": "",
  "Bankruptcy": "",
  ...
  "Channel ID": "",
  "Channel color": "Màu Stream",
  "Channel created recently": "Stream được tạo gần đây",
  "Channel created!": "",
  "Channel creation": "Tạo Stream",
  "Channel description": "Mô tả Stream",
  "Channel details": "",
  ...
  "Channel name": "Tên Stream",
  "Channel permissions": "Stream cho phép",
  "Channel settings": "Cài đặt stream",
  "Channels": "Streams",
  "Channels in this folder will become uncategorized.": "",
  "Channels organize conversations based on who needs to see them.": "",
  "Channels they should join": "Hội nhóm nên tham gia",
  ...
  "Consider <z-link>searching all public channels</z-link>.": "Xem xét<z-link>tìm kiếm tất cả các stream công khai</z-link>.",
  ...
  "Create": "Tạo",
  "Create a channel": "Tạo stream",
  "Create a collaborative to-do list": "",
  "Create a new saved snippet": "",
  "Create a poll": "",
  "Create a user group": "",
  "Create channel": "Tạo Stream",
  "Create channel folder": "",
  "Create link": "",
  "Create new channel": "Tạo stream mới",
  "Create new folder": "",
  ...
  "Currently viewing the entire channel.": "Hiện đang xem toàn bộ stream.",
  ...
  "Default channels": "Stream mặc định",
  ...
  "Error creating channel": "Lỗi khi tạo Stream",
  ...
  "Error removing user from this channel.": "Lỗi khi xóa người dùng khỏi dòng hội thoại.",
  ...
  "Filter default channels": "Lọc các Stream mặc định",
  ...
  "Narrow to messages on channel <z-value></z-value>.": "Thu hẹp các tin nhắn trên Stream<z-value></z-value>.",
  ...
  "New channel message": "Tin nhắn mới trên hội",
  "New direct message": "",
  ...
  "No channel subscriptions.": "Không có đăng ký luồng.",
  "No channels": "Không có Streams",
  ...
  "On hover": "",
  "Onboarding": "",
  "Once you leave this channel, you will not be able to rejoin.": "Sau khi rời khỏi luồng này, bạn sẽ không thể tham gia lại.",
  ...
  "Only in conversation views": "Chỉ trong chế độ xem cuộc trò chuyện",
  ...
  "Pin channel to top": "Ghim Stream lên đầu",
  "Pin channel to top of left sidebar": "Ghim Stream lên đầu thanh bên trái",
  "Plan management": "",
  ...
  "Please select a channel.": "Vui lòng chỉ định một stream.",
  ...
  "Scroll through channels": "Cuộn qua các Streams",
  ...
  "Subscribe to/unsubscribe from selected channel": "Đăng ký / hủy đăng ký khỏi Stream đã chọn",
  "Subscribe {full_name} to channels": "",
  "Subscribed": "Đã đăng ký",
  "Subscribed channels": "Streams đã tham gia",
  "Subscribed successfully!": "Đã bật theo dõi!",
  "Subscribed:": "",
  ...
  "The channel description cannot contain newline characters.": "Mô tả Stream không được chứa các ký tự dòng mới.",
  ...
  "This channel does not exist or is private.": "Dòng hội thoại này không tồn tại hoặc được để riêng tư.",
  "This channel does not yet have a description.": "Stream này chưa có mô tả.",
  ...
  "Unknown author": "",
  "Unknown channel": "Không xác định được Stream",
  "Unknown user": "",
  "Unmute": "Bật tiếng",
  ...
  "Unpin channel from top": "Bỏ ghim luồng khỏi đầu",
  "Unread": "Chưa đọc",
  ...
  "Use channel settings to unsubscribe from private channels.": "Sử dụng cài đặt Stream để hủy đăng ký các Stream riêng tư.",
  ...
  "View all users": "",
  "View bot card": "",
  "View channel": "Xem Stream",
  "View channel messages": "Xem tin nhắn Stream",
  ...
  "Who can create private channels": "Ai có thể tạo Stream riêng tư",
  "Who can create public channels": "Ai có thể tạo Stream công khai",
  "Who can create reusable invitation links": "",
  "Who can create user groups": "",
  "Who can create web-public channels": "Ai có thể tạo Stream công khai trên web",
  ...
  "You're not subscribed to this channel. You will not be notified if other users reply to your message.": "Bạn chưa theo dõi dòng hội thoại này. Bạn sẽ không được thông báo khi người dùng khác trả lời tin nhắn của bạn.",
