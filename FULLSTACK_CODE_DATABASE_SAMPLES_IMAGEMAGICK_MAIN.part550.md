...
## Verbatim Content (Part 550 of 851)
...
---[FILE: display.html]---
Location: ImageMagick-main/www/display.html
...
<head>
  ...
  <meta property="og:title" content="ImageMagick | Command-line Tools: Display" />
  ...
  <meta property="og:url" content="../www/display.html" />
  ...
  <meta name="twitter:title" content="ImageMagick | Command-line Tools: Display" />
  ...
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <div class="mt-3 ms-3">
      <a href="../index.html" class="text-decoration-none">
        <h1 class="fs-2 mb-1">Command-line Tools: Display</h1>
      </a>
...
<p class="lead">Use the <samp>display</samp> program to display an image or image sequence on any X server.  See <a href="command-line-processing.html">Command Line Processing</a> for advice on how to structure your <samp>display</samp> command or see below for example usages of the command.</p>
...
<p>You can find additional examples of using <samp>display</samp> in <a href="../index.html">Examples of ImageMagick Usage</a>.</p>
