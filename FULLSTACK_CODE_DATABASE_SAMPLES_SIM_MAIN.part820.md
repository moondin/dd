...
## Verbatim Content (Part 820 of 933)
...
---[FILE: 0018_snapshot.json]---
Location: sim-main/packages/db/migrations/meta/0018_snapshot.json

```json
{
  "id": "bbb44f3f-89b6-4280-8844-c450e0338cdf",
  "prevId": "f71b2569-b14c-40aa-aae2-a65fd1c1978e",
  "version": "7",
  "dialect": "postgresql",
  "tables": {
    "public.account": {
    ...
    "public.marketplace_execution": {
      "name": "marketplace_execution",
      "schema": "",
      "columns": {
        "id": {
          "name": "id",
      ...
      "indexes": {},
      "foreignKeys": {
        "marketplace_execution_marketplace_id_marketplace_id_fk": {
          "name": "marketplace_execution_marketplace_id_marketplace_id_fk",
          "tableFrom": "marketplace_execution",
          "tableTo": "marketplace",
        ...
        "marketplace_execution_user_id_user_id_fk": {
          "name": "marketplace_execution_user_id_user_id_fk",
          "tableFrom": "marketplace_execution",
          "tableTo": "user",
          "columnsFrom": ["user_id"],
          "columnsTo": ["id"],
    ...
    "public.marketplace_star": {
      "name": "marketplace_star",
      "schema": "",
      "columns": {
        "id": {
          "name": "id",
      ...
      "indexes": {
        "user_marketplace_idx": {
          "name": "user_marketplace_idx",
          "columns": [
            {
              "expression": "user_id",
              "isExpression": false,
      ...
      "foreignKeys": {
        "marketplace_star_marketplace_id_marketplace_id_fk": {
        ...
        "marketplace_star_user_id_user_id_fk": {
