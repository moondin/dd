...
## Verbatim Content (Part 334 of 1290)
...
---[FILE: django.po]---
Location: zulip-main/locale/fi/LC_MESSAGES/django.po
...
# Flammie <flammie@iki.fi>, 2020,2022,2024-2025
# Heidi Ahlberg, 2022
# Jari Winberg <winjar@autistici.org>, 2018
# Matti R, 2020
# Matti R, 2020-2021,2025
...
"PO-Revision-Date: 2025-09-23 14:28+0000\n"
...
"users to join."
msgstr ""
"Organisaatiollasi ei ole enää Zulip-lisenssejä, eikä se voi enää ottaa "
"vastaan uusia käyttäjiä. [Lisää lisenssien määrää]({billing_page_link}) tai "
...
msgstr ""
"Organisaatiollasi on vain yksi Zulip-lisenssiä jäljellä. Voit [lisätä "
"lisenssien määrää]({billing_page_link}) tai [poistaa käytöstä ei-aktiiviset "
...
msgstr ""
"Organisaatiollasi on vain kaksi Zulip-lisenssiä jäljellä. Voit [lisätä "
"lisenssien määrää]({billing_page_link}) tai [poistaa käytöstä ei-aktiiviset "
"käyttäjät]({deactivate_user_help_page_link}) mahdollistaaksesi useamman kuin "
...
msgstr ""
"Organisaatiollasi on vain kolme Zulip-lisenssiä jäljellä. Voit [lisätä "
"lisenssien määrää]({billing_page_link}) tai [poistaa käytöstä ei-aktiiviset "
"käyttäjät]({deactivate_user_help_page_link}) mahdollistaaksesi useamman kuin "
...
msgstr ""
"Uusi käyttäjä ({email}) ei voinut liittyä, koska organisaatiolla ei ole "
"tarpeeksi Zulip-lisenssejä. Jotta uusia käyttäjiä voi liittyä, varmista että "
...
msgstr ""
"Laskutuksia, joissa on yli {max_licenses} lisenssiä ei voi käsitellä tämän "
...
msgstr ""
"Organisaatiosi pyyntä sponsoroidulle hostaukselle on hyväksytty. Tilaus on "
"päivitetty tasolle {plan_name} makustta. {emoji}\n"
"\n"
...
msgstr ""
"Kokeile toista URLia. <a href=\"%(root_domain_url)s/accounts/find/\">hae "
...
msgstr ""
"\n"
"Sillä välin voit <a href=\"mailto:%(support_email)s\">ottaa yhteyttä "
"palvelimen\n"
...
"server."
msgstr ""
"Maksusuunnitelmaa ei le saatavilla tälle organisaatiolle koska Zulip-"
"palvelimella on jo %(server_plan_name)s -suunnitelma joka kattaa kaikki "
"organisaatiot palvelimella. Katos <b>Palvelimen laskutus</b> -välilehti <a "
...
"from Zulip."
msgstr ""
"Viimeistele rekisteröitymisesi seuramalla sähköpostiin (<span "
...
msgstr ""
"Tätä asetusta voi myös muuttaa <a href=\"%(root_domain_url)s/help/configure-"
...
msgstr ""
"tai tuo <a href=\"/help/import-from-slack\">Slack</a>, <a href=\"/help/"
...
msgstr ""
"\n"
"Sillä välin voit <a href=\"mailto:%(support_email)s\">ottaa yhteyttä Zulipin "
"tukeen</a>."
...
msgstr ""
"Jos olet organisaation omistaja, voit <a href=\"mailto:"
"%(support_email)s\">ottaa yhteyttä Zulipin tukeen</a> "
...
"reactivate it."
msgstr ""
"Jos olet omistaja tässä organisaatiossa, voit <a href=\"mailto:"
...
msgstr ""
"Olet nyt luonut Zulipin demo-organisaation. Huomaathan että tämä "
"organisaatio poistetaan automaattisesti 30 päivän kuluttua. Lue lisää demo-"
"organisaatioista <a href=\"%(demo_organizations_help_link)s\">täältä</a>."
...
msgstr ""
"Olet nyt luonut uuden Zulipin demo-organisaaation. Tämä organisaatio "
"poistetaan automaattisesti 30 päivän päästä. Lue lisää demo-organisaatioista "
"täältä: %(demo_organizations_help_link)s."
...
"at %(support_email)s."
msgstr ""
"Jos on kysmyksiä niin kannattaa ottaa yhteyttä tämän Zulip-palvelimen "
...
msgstr ""
"Saimme pyynnön sähköpostiosoitteesta %(new_email)sZulipin demo-"
...
msgstr ""
"Tämä sähköposti ei sisällä viestin sisältöä, koska organisaatiosi on estänyt "
"<a class=\"content_disabled_help_link\" href=\"%(help_url)s\">viestien "
"sisällön näyttämisen sähköposti-ilmoituksissa</a>."
...
"content</a> in email notifications."
msgstr ""
"Tämä sähköposti ei sisällä viestin sisältöä, koska olet estänyt <a "
"class=\"content_disabled_help_link\" href=\"%(alert_notif_url)s\">viestien "
"sisällön näyttämisen sähköposti-ilmoituksissa</a>."
...
msgstr ""
"\n"
"Tämä sähköposti ei sisällä viestin sisältöä, koska organisaatiosi on "
"poistanut viestin sisällön näkymisen sähköposti-ilmoituksissa.\n"
...
msgstr ""
"\n"
"Tämä sähköposti ei sisällä viestin sisältöä, koska olet estänyt viestien "
"sisällön näyttämisen sähköposti-ilmoituksissa.\n"
...
msgstr ""
"Tästä pääset kirjautumaan Zulipiiin ja selaamaan lukemattomia viestejä: "
"%(organization_url)s."
...
msgstr ""
"Voit <a href = \"%(find_accounts_link)s\" >hakea tilejä</a> toisella "
...
msgstr ""
"%(referrer_name)stoivoo, että liittyisit seuraan Zulipissa &mdash; "
...
"productivity."
msgstr ""
"Ystävällinen muistutus: %(referrer_name)s (%(referrer_email)s) toivoo, että "
...
"preferences</a>."
msgstr ""
"Vastaa tähän sähköpostiin suoraan <a href=\"%(narrow_url)s\">katso sitä "
...
msgstr ""
"Zulip-tunnukseen määritelty sähköpostiosoiteeksi vaihdettiin äskettäin "
...
"immediately at <%(support_email)s>."
msgstr ""
"Zulip-tiliisi yhdistetty sähköpostiosoite muutettiin äskettäin muotoon "
...
msgstr ""
"Jos et tunnista tätä kirjautumistunnusta tai uskot, että tilisi on "
...
msgstr ""
"<a href=\"%(trying_out_zulip)s\"><b>Tee viikon mittainen koeajo</b></a> "
...
"team communicate."
msgstr ""
"Tee viikon mittainen koeajo työryhmäsi kanssa, ilman muita "
...
"about…?”"
msgstr ""
"Uuden keskustelun voi aloittaa valitsemalla kanavan ja aloittamalla uuden "
...
msgstr ""
"Aiheen nimeämistä ei tarvitse murehtia, jos jokin on vialla niin <a "
"href=\"%(move_messages_link)s\">viestien siirtäminen</a>, <a "
"href=\"%(rename_topics_link)s\">aiheiden uudelleennimeäminen</a> tai <a "
...
msgstr ""
"Aiheen nimeämistä ei tarvitse murehtia, jos jokin on vialla niin viestien "
"siirtäminen (%(move_messages_link)s), aiheiden uudelleennimeäminen "
...
msgstr ""
"Sinulla oli aiemmin tili osoitteessa %(organization_url)s, mutta se on "
...
msgstr ""
"Organisaatio johon yritit kirjautua <a "
...
msgstr ""
"Uusia jäseniä ei voi liittyä palvelimelle <a "
...
"or misconfiguration."
msgstr ""
"Päädyit tänne sattumalta. Tämän sivun pitäisi olla osa vahvistusprosessia "
...
msgstr ""
"Uuden organisaation luonti tällä palvelimella vaatii "
"organisaationluontilinkin. Lue lisää <a href=\"https://zulip.readthedocs.io/"
...
msgstr ""
"Zulip-organisaatios on rekisteröity toiselle Zulip-palvelimelle. <a "
...
"\n"
"tai tuo <a href=\"/help/import-from-slack\">Slack</a>, <a href=\"/help/"
"import-from-mattermost\">Mattermost</a>,\n"
...
"away!"
msgstr ""
"Varmista että verkko-osoite on väärä ja kokeile uudesraan tai <a "
...
msgstr ""
"{user} muutti kanavan [lähetysoikeudet]({help_link}):\n"
"\n"
...
"{summary_line}"
msgstr ""
"{user} on muuttanut tämän kanavan [viestin säilytysjaksoa]({help_link}):\n"
...
"number of licenses, then try again."
msgstr ""
"Uudet jäsenet eivät voi liittyä tähän organisaatioon, koska kaikki Zulip-"
...
msgstr ""
"Yrität kirjautua sisään liian monta kertaa. Yritä uudelleen {seconds} "
"sekunnin kuluttua tai ota yhteyttä organisaatiosi järjestelmänvalvojaan "
"saadaksesi apua."
...
"{error_message}"
msgstr ""
"Virhe lähetettäessä viestiä kanavalle {channel_name} viestin ilmoitus "
"sähköpostin vastaus:\n"
"{error_message}"
...
msgstr "vanha arvo ei vastaa odotuksenmukaista"
...
msgstr ""
"\n"
"Huomaathan että tämä on [demo-organisaatio]({demo_organization_help_url}) "
"ja \n"
...
msgstr ""
"\n"
"Siirry kohtaan [Profiiliasetukset](#settings/profile), lisää [profiilikuva](/"
...
msgstr ""
"\n"
"[aiheet](/help/introduction-to-topics) näyttävät yhteenvedon mitä keskustelu "
"sisältää.\n"
...
"\n"
"Kun aloitat keskustelun, anna sille aihe. Esimerkiksi: ”Hei, voimmeko "
"puhua ... aiheesta”?\n"
"\n"
...
msgstr ""
"\n"
"Voit lukea Zulipin keskusteluja yksi kerrallaan. Näet joka keskustelun "
"aiheyhteydessään, \n"
...
msgstr ""
"\n"
"Aloita uusi keskustelu. Valitse ensin kanava vasemmalta sivupaneelista ja "
"klikkaa \n"
...
"MiB)."
msgstr "Tiedosto on einimmäiskokoa suurempi {max_file_size} MiB"
...
#~ msgstr ""
#~ "Voit vain kutsua muita Zephyr-peilikäyttäjiä yksityisille kanaville."
...
#~ msgstr "Viallinen sähköpostisoite."
...
#~ msgstr ""
#~ "\n"
#~ "Zulip ei voi ladata koska palvelimella on teknisiä ongelmia."
...
#~ msgstr ""
#~ "\n"
#~ "Sivun latautuu automaattisesti kun palvelin on palautettu."
...
#~ msgstr ""
#~ "\n"
#~ "Organisaatio on poistettu käytöstä."
...
#~ "%(localized_date)s. "
#~ msgstr ""
#~ "Olet deaktivoinut Zulip-organisaatiosi %(realm_name)s%(localized_date)s."
...
#~ "%(deactivating_owner)s toiumesta %(localized_date)s."
...
#~ "%(localized_date)s. "
#~ msgstr ""
#~ "Zulip-organisaatios %(realm_name)s on deaktivioitu %(localized_date)s"
...
#~ msgstr ""
#~ "\n"
#~ "Napsauta nappia alta sisään kirjautumiseksi."
...
#~ msgstr ""
#~ "\n"
#~ "Tämä linkki vanhenee %(validity_in_hours)s tunnissa."
...
#~ msgstr "Et voi raktaista aiheita."
