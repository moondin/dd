...
## Verbatim Content (Part 106 of 991)
...
---[FILE: responses-agent-intro.mdx]---
Location: mlflow-master/docs/docs/genai/flavors/responses-agent-intro.mdx
...
- <APILink fn="mlflow.types.responses.create_reasoning_item" />
- <APILink fn="mlflow.types.responses.create_text_output_item" />
- <APILink fn="mlflow.types.responses.create_function_call_item" />
- <APILink fn="mlflow.types.responses.create_function_call_output_item" />
- <APILink fn="mlflow.types.responses.create_mcp_approval_request_item" />
- <APILink fn="mlflow.types.responses.create_mcp_approval_response_item" />
- <APILink fn="mlflow.types.responses.create_text_delta" /> (only for streaming)
- <APILink fn="mlflow.types.responses.create_annotation_added" /> (only for streaming)
...
### Simple Chat Example with a ChatCompletions LLM

Here's an example of an agent that calls OpenAI's gpt-5 model with the ChatCompletions API:
