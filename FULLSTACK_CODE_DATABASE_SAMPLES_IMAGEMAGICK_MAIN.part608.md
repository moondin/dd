...
## Verbatim Content (Part 608 of 851)
...
---[FILE: list.html]---
Location: ImageMagick-main/www/api/list.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Working with Image Lists, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Working with Image Lists</h1>
    </a>
  </header>
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  ...
  <li><a href="#CloneImages">CloneImages</a></li>
  <li><a href="#DeleteImageFromList">DeleteImageFromList</a></li>
  <li><a href="#DeleteImages">DeleteImages</a></li>
  <li><a href="#DestroyImageList">DestroyImageList</a></li>
  <li><a href="#DuplicateImages">DuplicateImages</a></li>
  ...
  <li><a href="#RemoveImageFromList">RemoveImageFromList</a></li>
  ...
  <li><a href="#ReplaceImageInListReturnLast">ReplaceImageInListReturnLast</a></li>
...
<pre class="bg-light text-dark mx-4"><samp>void AppendImageToList(Image **images,const Image *append)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *CloneImageList(const Image *images,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *CloneImages(const Image *images,const char *scenes,
...
<pre class="bg-light text-dark mx-4"><samp>void DeleteImageFromList(Image **images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void DeleteImages(Image **images,const char *scenes,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *DestroyImageList(Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *DuplicateImages(Image *images,const size_t number_duplicates,
...
<pre class="bg-light text-dark mx-4"><samp>Image *GetFirstImageInList(const Image *images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *GetImageFromList(const Image *images,const ssize_t index)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>ssize_t GetImageIndexInList(const Image *images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>size_t GetImageListLength(const Image *images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *GetLastImageInList(const Image *images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *GetNextImageInList(const Image *images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *GetPreviousImageInList(const Image *images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image **ImageListToArray(const Image *images,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void InsertImageInList(Image **images,Image *insert)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *NewImageList(void)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void PrependImageToList(Image **images,Image *prepend)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *RemoveImageFromList(Image **images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *RemoveFirstImageFromList(Image **images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *RemoveLastImageFromList(Image **images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void ReplaceImageInList(Image **images,Image *replace)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void ReplaceImageInListReturnLast(Image **images,Image *replace)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void ReverseImageList(Image **images)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *SpliceImageIntoList(Image **images,const size_t,
  const Image *splice)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *SplitImageList(Image *images)
</samp></pre>
