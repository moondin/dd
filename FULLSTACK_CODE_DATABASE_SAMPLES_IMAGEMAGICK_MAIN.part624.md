...
## Verbatim Content (Part 624 of 851)
...
---[FILE: quantize.html]---
Location: ImageMagick-main/www/api/quantize.html
...
<pre class="bg-light text-dark mx-4"><samp>void GetQuantizeInfo(QuantizeInfo *quantize_info)
</samp></pre>
