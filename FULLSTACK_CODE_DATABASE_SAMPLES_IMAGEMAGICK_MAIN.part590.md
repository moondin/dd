...
## Verbatim Content (Part 590 of 851)
...
---[FILE: cache.html]---
Location: ImageMagick-main/www/api/cache.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Get or Set Image Pixels, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Get or Set Image Pixels</h1>
    </a>
  </header>
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#AcquirePixelCacheNexus">AcquirePixelCacheNexus</a></li>
  <li><a href="#AcquirePixelCachePixels">AcquirePixelCachePixels</a></li>
  <li><a href="#GetAuthenticMetacontent">GetAuthenticMetacontent</a></li>
  <li><a href="#GetAuthenticPixelQueue">GetAuthenticPixelQueue</a></li>
  <li><a href="#GetAuthenticPixels">GetAuthenticPixels</a></li>
  <li><a href="#GetOneAuthenticPixel">GetOneAuthenticPixel</a></li>
  <li><a href="#GetOneVirtualPixel">GetOneVirtualPixel</a></li>
  <li><a href="#GetOneVirtualPixelInfo">GetOneVirtualPixelInfo</a></li>
  <li><a href="#GetVirtualMetacontent">GetVirtualMetacontent</a></li>
  <li><a href="#GetVirtualPixelQueue">GetVirtualPixelQueue</a></li>
  <li><a href="#GetVirtualPixels">GetVirtualPixels</a></li>
  <li><a href="#QueueAuthenticPixels">QueueAuthenticPixels</a></li>
  <li><a href="#ReshapePixelCache">ReshapePixelCache</a></li>
  <li><a href="#SetPixelCacheVirtualMethod">SetPixelCacheVirtualMethod</a></li>
</ul>
</div>
<br/>
<br/>
...
<pre class="bg-light text-dark mx-4"><samp>NexusInfo **AcquirePixelCacheNexus(const size_t number_threads)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>void *AcquirePixelCachePixels(const Image *image,size_t *length,
...
<pre class="bg-light text-dark mx-4"><samp>void *GetAuthenticMetacontent(const Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum *GetAuthenticPixelQueue(const Image image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum *GetAuthenticPixels(Image *image,const ssize_t x,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetOneAuthenticPixel(const Image image,const ssize_t x,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetOneVirtualPixel(const Image image,const ssize_t x,
  const ssize_t y,Quantum *pixel,ExceptionInfo exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType GetOneVirtualPixelInfo(const Image image,
...
<pre class="bg-light text-dark mx-4"><samp>const void *GetVirtualMetacontent(const Image *image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const Quantum *GetVirtualPixelQueue(const Image image)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>const Quantum *GetVirtualPixels(const Image *image,const ssize_t x,
  const ssize_t y,const size_t columns,const size_t rows,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Quantum *QueueAuthenticPixels(Image *image,const ssize_t x,
  const ssize_t y,const size_t columns,const size_t rows,
  ExceptionInfo *exception)
</samp></pre>
...
<h2><a href="../../api/MagickCore/cache_8c.html" id="ReshapePixelCache">ReshapePixelCache</a></h2>

<p>ReshapePixelCache() reshapes an existing pixel cache.</p>

<p>The format of the ReshapePixelCache() method is:</p>

<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType ReshapePixelCache(Image *image,const size_t columns,
...
<dd> </dd>
<dt>columns</dt>
<dd>the number of columns in the reshaped pixel cache. </dd>

<dd> </dd>
<dt>rows</dt>
<dd>number of rows in the reshaped pixel cache. </dd>
...
<pre class="bg-light text-dark mx-4"><samp>VirtualPixelMethod SetPixelCacheVirtualMethod(Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType SyncAuthenticPixels(Image *image,
  ExceptionInfo *exception)
</samp></pre>
