...
## Verbatim Content (Part 594 of 991)
...
---[FILE: en.json]---
Location: mlflow-master/mlflow/server/js/src/lang/default/en.json
Signals: Next.js
...
```json
{
  ...
  "+Wd9fs": {
    "defaultMessage": "The groundedness LLM judge returns a binary evaluation and written rationale on whether the generated response is factually consistent with the agent's retrieved context.",
  ...
  "+hQbnS": {
    "defaultMessage": "Span",
    "description": "Label for the associated span of an assessment"
  },
  "+hZB4c": {
  ...
  "/gqx4n": {
    "defaultMessage": "The safety LLM judge returns a binary rating and a written rationale on whether the generated response has harmful or toxic content.",
  ...
  "128VYg": {
    "defaultMessage": "User",
    "description": "Label for the user id section"
  },
  "13vJft": {
  ...
  "1VD7Gl": {
    ...
    "description": "Create judge button text"
  },
  "1YGQOY": {
  ...
  "1i/Bac": {
    "defaultMessage": "Edit",
    "description": "Edit button for judge"
  },
  "1jPG5D": {
  ...
  "4Tg5Vr": {
    "defaultMessage": "The guideline adherence LLM judge determines whether the response adheres to the guidelines provided.",
  ...
  "7hHw+R": {
    ...
    "description": "Section header for judge instructions"
  },
  "7jsqqe": {
  ...
  "AGi/De": {
    ...
    "description": "Loading traces message"
  },
  "AM8DuO": {
  ...
  "AX7L9r": {
    "defaultMessage": "Error",
    "description": "Error assessment status in the evaluations table."
  },
  "AdlJNW": {
  ...
  "Ay8rPx": {
    "defaultMessage": "Save",
    "description": "Save judge button text"
  },
  "AyceYA": {
  ...
  "B1Upnc": {
    "defaultMessage": "Relevant",
    "description": "Evaluation results > chunk relevancy assessment > positive value label. Displayed if evaluation result is considered as relevant to the query."
  },
  "B5K1Ix": {
  ...
  "BdV0qk": {
    ...
    "description": "Label for human judge in the tooltip for the assessment in the evaluation metrics."
  },
  "BfMFME": {
    "defaultMessage": "Attributes",
  ...
  "BkDhmT": {
    "defaultMessage": "Chat",
    "description": "Label for the chat tab of the model trace explorer."
  },
  "Bnruyp": {
    "defaultMessage": "500",
  ...
  "E+x0F4": {
    "defaultMessage": "Gateway",
    "description": "Header title for the gateway configuration page"
  },
  "E4Te7L": {
  ...
  "FWEOg2": {
    "defaultMessage": "Relevance to Query",
  ...
  "HdEgbb": {
    "defaultMessage": "Error",
    "description": "Error status in the evaluations table."
  },
  "HeNa8H": {
    "defaultMessage": "All",
  ...
  "Hq/vjk": {
    "defaultMessage": "All",
    "description": "Evaluation review > sidebar list of evaluation results > filter control > option for filtering evaluation results with no filter"
  },
  "HrDWRj": {
    "defaultMessage": "Compare",
    "description": "Compare traces button"
  },
  "Hvznjh": {
  ...
  "LhxSrc": {
    ...
    "description": "Evaluation results > correctness assessment > negative value label. Displayed if evaluation result is considered as incorrect."
  },
  "Li72QU": {
    "defaultMessage": "Add",
  ...
  "M+HfWb": {
    "defaultMessage": "Irrelevant",
    "description": "Evaluation results > chunk relevancy assessment > negative value label. Displayed if evaluation result is considered as irrelevant to the query."
  },
  "M+iC03": {
    "defaultMessage": "Save",
    "description": "Button label for saving an edit to an assessment"
  },
  "M/c4l0": {
  ...
  "M8cEQy": {
    "defaultMessage": "No",
    "description": "Label for an assessment with a 'no' value"
  },
  "M8pHqP": {
  ...
  "Me7xpG": {
    "defaultMessage": "Create",
    "description": "Button label for creating an assessment"
  },
  "MgFOU5": {
    "defaultMessage": "Inputs",
  ...
  "MhOmZG": {
    "defaultMessage": "Yes",
    "description": "Label for an assessment with a 'yes' value"
  },
  "MhtxHm": {
  ...
  "N4wIiU": {
    "defaultMessage": "New judge",
    "description": "Button text to create a new judge"
  },
  "N79Rdb": {
  ...
  "O3q/U1": {
    ...
    "description": "Home page quick action section title"
  },
  "O5FKCr": {
  ...
  "OLornd": {
    "defaultMessage": "New judge",
    "description": "Button text to add a judge from empty state"
  },
  "ONIiUE": {
    "defaultMessage": "Show first 20",
  ...
  "QEL+JO": {
    ...
    "description": "Root cause assessment hint that explains that this assessment is causing the overall assessment to fail."
  },
  "QGiy9C": {
  ...
  "QravWY": {
    "defaultMessage": "Optimize Prompt",
  ...
  "RGKRP9": {
    "defaultMessage": "Feedback",
    "description": "Label for the value of an feedback assessment"
  },
  "RJenO+": {
  ...
  "RgVN+O": {
    ...
    "description": "Home page news section view more link"
  },
  "RlBbjb": {
  ...
  "UQhorr": {
    "defaultMessage": "Edit",
    "description": "Edit assessment menu item"
  },
  "UWHfmZ": {
  ...
  "VO1DnR": {
    "defaultMessage": "Model",
    "description": "Section header for model input"
  },
  "VP+qFF": {
    "defaultMessage": "Show diff only",
  ...
  "WELl8J": {
    ...
    "description": "Message for the popover trigger to show more items in the categorical aggregate chart."
  },
  "WGN2f3": {
    "defaultMessage": "Register model",
  ...
  "a6bpXQ": {
    "defaultMessage": "{numRootCause}/{numEvals} ({percentage}%) runs failed due to the {assessment} judge failing for the current run \"{currentRun}\".",
  ...
  "bK3O8b": {
    "defaultMessage": "Edit judge",
    "description": "Title for edit judge modal"
  },
  "bKSd3c": {
  ...
  "bkWot5": {
    "defaultMessage": "The context sufficiency LLM judge determines whether the retrieved context is sufficient to generate the expected response.",
  ...
  "c4OuCI": {
    "defaultMessage": "Compare traces",
    "description": "Compare traces modal title"
  },
  "c5AQYh": {
  ...
  "e2AObB": {
    "defaultMessage": "Value",
    "description": "Field label for assessment value in an edit form"
  },
  "e515YD": {
    "defaultMessage": "Grounded",
    "description": "Evaluation results > retrieval grounded assessment > positive value label. Displayed if evaluation result is considered as grounded."
  },
  "e6reUn": {
    "defaultMessage": "Failed",
  ...
  "eSxQmg": {
    ...
    "description": "Evaluation results > correctness assessment > positive value label. Displayed if evaluation result is considered as correct."
  },
  "eUUNCv": {
  ...
  "ffIouW": {
    ...
    "description": "Evaluation results > known type of evaluation result assessment > retrieval sufficiency assessment. Used to indicate if the retrieved context is sufficient to generate the expected response. Label displayed if user provided custom value, e.g. \"Retrieval sufficiency: mostly sufficient\""
  },
  "ffema5": {
    "defaultMessage": "Experiment ID",
    "description": "Run page > Overview > experiment ID section label"
  ...
  "fwxkdN": {
    "defaultMessage": "The retrieval sufficiency LLM judge determines whether the retrieved context is sufficient to generate the expected response.",
  ...
  "gBzvDD": {
    "defaultMessage": "Create judge",
    "description": "Title for new judge modal"
  },
  "gC2Kxm": {
  ...
  "gFYM0j": {
    "defaultMessage": "Cancel",
    "description": "Delete assessment modal cancel button text"
  },
  "gIc8Lp": {
  ...
  "hW5ehW": {
    ...
    "description": "Evaluation results > known type of evaluation result assessment > overall assessment > description of overall assessment"
  },
  "hW7XxH": {
  ...
  "iDqqcA": {
    "defaultMessage": "{numRootCause}/{numEvals} ({percentage}%) runs failed due to the {assessment} judge failing for run \"{otherRunDisplayName}\".",
    "description": "Tooltip for the root cause metrics bar on the LLM evaluation page."
  },
  "iF1UfU": {
  ...
  "j77+aP": {
    "defaultMessage": "Fail",
    "description": "Evaluation results > overall assessment > fail value label. Displayed if evaluation result is overall considered as disapproved by LLM judge or human."
  },
  "j7cj5r": {
  ...
  "jPW0Lj": {
    "defaultMessage": "Groundedness assessment is missing. This is likely because your agent is not returning retrieved_context.",
    "description": "Evaluation results > known type of evaluation result assessment > groundedness assessment. Used to indicate if the result is grounded in context of LLMs evaluation. Label displayed if user provided custom value, e.g. \"Groundedness: moderately grounded\""
  },
  "jTqRO+": {
    "defaultMessage": "None",
  ...
  "lfe8zE": {
    "defaultMessage": "Evaluate if the response in '{{ outputs }}' correctly answers the question in '{{ inputs }}'. The response should be accurate, complete, and professional.",
    "description": "Example placeholder text for instructions textarea"
  },
  "lhFnAG": {
    "defaultMessage": "Insufficient",
    "description": "Evaluation results > retrieval sufficiency assessment > negative value label. Displayed if retrieved context is insufficient to generate the expected response."
  },
  "llVQ2r": {
  ...
  "ls3868": {
    ...
    "description": "Evaluation results > known type of evaluation result assessment > guidelines assessment. Used to indicate if the result adheres to the guidelines in context of LLMs evaluation. Label displayed if user provided custom value, e.g. \"Guidelines: moderate\""
  },
  "ltqNpe": {
  ...
  "luV/3W": {
    "defaultMessage": "Adheres to guidelines",
    "description": "Evaluation results > guidelines assessment > positive value label. Displayed if evaluation result adheres to the guidelines."
  },
  "lxGVDu": {
  ...
  "m1Nb7W": {
    "defaultMessage": "Save",
    "description": "Evaluation review > assessments > save button"
  },
  "m4159e": {
    "defaultMessage": "Metrics ({length})",
  ...
  "mILU5r": {
    "defaultMessage": "Delete",
    "description": "Delete judge button"
  },
  "mIk1MU": {
    "defaultMessage": "Create Model",
  ...
  "md81Lo": {
    "defaultMessage": "Error",
    "description": "MLflow trace notebook output > error state title"
  },
  "mdzFsD": {
    "defaultMessage": "Retrieval sufficiency",
    "description": "Evaluation results > known type of evaluation result assessment > retrieval sufficiency assessment. Used to indicate if the retrieved context is sufficient to generate the expected response. Label displayed if user provided custom value, e.g. \"Retrieval sufficiency: mostly sufficient\""
  ...
  "mqqEUj": {
    ...
    "description": "Delete assessments modal title"
  },
  "mrGpVQ": {
  ...
  "ms+6Z2": {
    "defaultMessage": "Value",
    "description": "Field label for assessment value in a creation form"
  },
  "msYDmK": {
  ...
  "nRsCQz": {
    "defaultMessage": "Agents-as-a-judge",
    "description": "Home page news card title three"
  },
  "nVndit": {
  ...
  "oDwj2g": {
    "defaultMessage": "The relevance_to_query LLM judge determines whether the response is relevant to the input request.",
  ...
  "opUoF8": {
    "defaultMessage": "Retrieval relevance",
    "description": "Evaluation results > known type of evaluation result assessment > retrieval relevance assessment. Used to indicate if the result is relevant to source data chunk in context of LLMs evaluation. Label displayed if user provided custom value, e.g. \"Retrieval relevance: moderate\""
  },
  "oqBCfB": {
  ...
  "p5xut2": {
    ...
    "description": "Title for providers list"
  },
  "pBUaAK": {
  ...
  "q90jVU": {
    "defaultMessage": "End:",
    "description": "Label for the end time of a span"
  },
  "qAdWdK": {
    "defaultMessage": "Error",
  ...
  "qnMgLj": {
    ...
    "description": "Evaluation results > known type of evaluation result assessment > chunk relevance assessment. Used to indicate if the result is relevant to source data chunk in context of LLMs evaluation. Label displayed if user provided custom value, e.g. \"Chunk relevance: moderate\""
  },
  "qr7dhT": {
    "defaultMessage": "None",
  ...
  "rBIGDf": {
    ...
    "description": "Evaluation results > retrieval sufficiency assessment > positive value label. Displayed if retrieved context is sufficient to generate the expected response."
  },
  "rBydei": {
    "defaultMessage": "The retrieval-relevance LLM judge determines whether the chunks returned by the retriever are relevant to the input request. Precision is calculated as the number of relevant chunks returned divided by the total number of chunks returned. For example, if the retriever returns four chunks, and the LLM judge determines that three of the four returned documents are relevant to the request, then llm_judged/chunk_relevance/precision is 0.75.",
  ...
  "rZyNgx": {
    ...
    "description": "Evaluation results > global guideline adherence assessment > negative value label. Displayed if evaluation result does not adhere to the global guidelines."
  },
  "raa3Ij": {
    "defaultMessage": "Registered Models",
  ...
  "uAv9Zs": {
    "defaultMessage": "Home",
    "description": "Sidebar link for home page"
  },
  "uB7rmB": {
  ...
  "xV6NWF": {
    ...
    "description": "Evaluation results > known type of evaluation result assessment > guideline adherence assessment. Used to indicate if the result adheres to the guidelines in context of LLMs evaluation. Label displayed if user provided custom value, e.g. \"Guideline adherence: moderate\""
  },
  "xVBx+a": {
    "defaultMessage": "Next",
  ...
  "zZ9sIi": {
    "defaultMessage": "The global guideline adherence LLM judge determines whether the response adheres to the global guidelines provided. All responses must adhere to global guidelines.",
