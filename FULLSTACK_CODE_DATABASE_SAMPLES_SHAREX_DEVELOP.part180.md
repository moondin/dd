...
## Verbatim Content (Part 180 of 650)
...
Location: ShareX-develop/ShareX/Properties/Resources.he-IL.resx
...
לחץ על 'לא' כדי לבטל את ההעלאה הנוכחית ולהשבית את ההעלאה האוטומטית של צילום מסך.</value>
  ...
  <data name="BeforeUploadForm_BeforeUploadForm__0__is_about_to_be_uploaded_to__1___You_may_choose_a_different_destination_" xml:space="preserve">
    <value>{0} יועלה אל {1}. ניתן לבחור יעד אחר.</value>
  </data>
...
מאוחר יותר תוכל להשבית אותם מתפריט "משימות לאחר צילום מסך".</value>
  ...
  <data name="TaskSettingsForm_UpdateWindowTitle_Task_settings_for__0_" xml:space="preserve">
    <value>הגדרות מטלה עבור {0}</value>
  </data>
...
{0}</value>
  ...
  <data name="WouldYouLikeToRetryClipboardUpload" xml:space="preserve">
    <value>האם תרצה לנסות להעלות את לוח הגזירה שוב?</value>
  </data>
  <data name="ShareXCannotBeClosedWhileScreenRecordingIsActive" xml:space="preserve">
    <value>לא ניתן לסגור את ShareX בזמן שהקלטת מסך פעילה.

האם ברצונך לבטל את הקלטת המסך הפעילה?</value>
  </data>
  <data name="ShareXIsUpToDate" xml:space="preserve">
    <value>ShareX מעודכן עם הגרסה החדשה ביותר!</value>
  </data>
</root>
```
