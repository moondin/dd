...
## Verbatim Content (Part 735 of 1290)
...
---[FILE: popovers.css]---
Location: zulip-main/web/styles/popovers.css
...
#user-profile-modal {
    .modal__body {
        ...
        height: var(--user-profile-modal-body-height);
        padding-left: 16px;
        padding-right: 16px;
    ...
    #user-profile-streams-tab {
        ...
        .stream-list-bottom-section,
        .group-list-bottom-section {
            grid-area: bottom;
        }
...
.gif-grid-in-popover {
    /* 300px of GIF grid + 5px is the extra gutter space
     * + 1px for outline + 4px padding.
     * between gif columns. */
    width: 310px;
    border: 0;
    padding: 0;
    ...
    .clear-search-button {
        position: absolute;
        /* The 60% instead of the usual 50% makes this
        `x` button appear vertically centered inside the
        input instead of the wrapper. */
        top: 60%;
...
#move_topic_modal {
    ...
    #report_type_options_widget_wrapper,
