...
## Verbatim Content (Part 629 of 851)
...
---[FILE: transform.html]---
Location: ImageMagick-main/www/api/transform.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Transform an Image, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Transform an Image</h1>
    </a>
  </header>
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#AutoOrientImage">AutoOrientImage</a></li>
  <li><a href="#ChopImage">ChopImage</a></li>
  <li><a href="#CropImage">CropImage</a></li>
  <li><a href="#CropImageToTiles">CropImageToTiles</a></li>
  <li><a href="#ExcerptImage">ExcerptImage</a></li>
  <li><a href="#ExtentImage">ExtentImage</a></li>
  ...
  <li><a href="#SpliceImage">SpliceImage</a></li>
  <li><a href="#TransformImage">TransformImage</a></li>
  <li><a href="#TransposeImage">TransposeImage</a></li>
  <li><a href="#TransverseImage">TransverseImage</a></li>
</ul>
</div>
<br/>
<br/>
...
<pre class="bg-light text-dark mx-4"><samp>Image *AutoOrientImage(const Image *image,
...
<pre class="bg-light text-dark mx-4"><samp>Image *ChopImage(const Image *image,const RectangleInfo *chop_info,
...
<pre class="bg-light text-dark mx-4"><samp>Image *CropImage(const Image *image,const RectangleInfo *geometry,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *ExcerptImage(const Image *image,const RectangleInfo *geometry,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *ExtentImage(const Image *image,const RectangleInfo *geometry,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *FlipImage(const Image *image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *FlopImage(const Image *image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *RollImage(const Image *image,const ssize_t x_offset,
...
<pre class="bg-light text-dark mx-4"><samp>Image *ShaveImage(const Image *image,const RectangleInfo *shave_info,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *SpliceImage(const Image *image,const RectangleInfo *geometry,
  ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>MagickBooleanType TransformImage(Image **image,const char *crop_geometry,
...
<pre class="bg-light text-dark mx-4"><samp>Image *TransposeImage(const Image *image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *TransverseImage(const Image *image,ExceptionInfo *exception)
</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>Image *TrimImage(const Image *image,ExceptionInfo *exception)
</samp></pre>
...
---[FILE: version.html]---
Location: ImageMagick-main/www/api/version.html
...
<head>
  ...
  <meta name="keywords" content="MagickCore, C API: Get the Version and Copyrights, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
  <meta name="description" content="ImageMagick is a powerful, open-source software suite for creating, editing, converting, and manipulating images in over 200 formats. Ideal for web developers, graphic designers, and researchers, it offers versatile tools for image processing, including batch processing, format conversion, and complex image transformations." />
  <meta name="application-name" content="ImageMagick" />
  <meta name="application-url" content="https://imagemagick.org" />
  <meta name="copyright" content="Copyright (c) 1999 ImageMagick Studio LLC" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-3">MagickCore, C API: Get the Version and Copyrights</h1>
    </a>
  </header>
...
<ul class="dropdown-menu pre-scrollable" aria-labelledby="defaultDropdown">
  <li><a href="#GetMagickCacheCopyright">GetMagickCacheCopyright</a></li>
</ul>
</div>
<br/>
<br/>
<div class="magick-header">
<h2><a href="MagickCache/version_8c.html" id="GetMagickCacheCopyright">GetMagickCacheCopyright</a></h2>

<p>GetMagickCacheCopyright() returns the MagickCache API copyright as a string.</p>

<p>The format of the GetMagickCacheCopyright method is:</p>

<pre class="bg-light text-dark mx-4"><samp>const char *GetMagickCacheCopyright(void)
</samp></pre>

<h2><a href="MagickCache/version_8c.html" id="GetMagickCacheVersion">GetMagickCacheVersion</a></h2>

<p>GetMagickCacheVersion() returns the MagickCache API version as a string and as a number.</p>

<p>The format of the GetMagickCacheVersion method is:</p>

<pre class="bg-light text-dark mx-4"><samp>const char *GetMagickCacheVersion(size_t *version)
</samp></pre>
...
<dl class="dl-horizontal">
<dt>version</dt>
<dd>The MagickCache version is returned as a number. </dd>
