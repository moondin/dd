...
## Verbatim Content (Part 636 of 991)
...
---[FILE: TraceUtils.test.ts]---
Location: mlflow-master/mlflow/server/js/src/shared/web-shared/genai-traces-table/utils/TraceUtils.test.ts
