...
## Verbatim Content (Part 178 of 650)
...
---[FILE: Resources.es.resx]---
Location: ShareX-develop/ShareX/Properties/Resources.es.resx
...
¿Quieres reiniciar ShareX?</value>
  ...
  <data name="TaskSettingsForm_UpdateUploaderMenuNames_URL_sharing_service___0_" xml:space="preserve">
    <value>Servicio para compartir URL: {0}</value>
  </data>
  ...
  <data name="TaskSettingsForm_UpdateUploaderMenuNames_Image_uploader___0_" xml:space="preserve">
    <value>Cargador de imágenes: {0}</value>
  </data>
...
Location: ShareX-develop/ShareX/Properties/Resources.fa-IR.resx
...
{0}</value>
  ...
  <data name="Program_WritePersonalPathConfig_Cant_access_to_file" xml:space="preserve">
    <value>نمی توان به فایل «{0}» دسترسی پیدا کرد. 
لطفا برای تغییر مسیر پوشه شخصی نرم افزار را در حالت ادمین اجرا کنید.</value>
  </data>
  <data name="QuickTaskMenuEditorForm_Reset_all_quick_tasks_to_defaults_Confirmation" xml:space="preserve">
    <value>آیا می خواهید تمام تنظیمات وظایف سریع را به حالت پیش فرض برگردانید؟</value>
  </data>
  <data name="RecentManager_UpdateRecentMenu_Left_click_to_copy_URL_to_clipboard__Right_click_to_open_URL_" xml:space="preserve">
    <value>برای کپی کردن آدرس به کلیپ بورد چپ کلیک کنید. برای بازکردن آدرس راست کلیک کنید.</value>
  </data>
  <data name="SwitchToListView" xml:space="preserve">
    <value>سوییچ کردن به حالت نمایش لیستی</value>
  </data>
  <data name="TaskSettingsForm_UpdateUploaderMenuNames_After_capture___0_" xml:space="preserve">
    <value>بعد از ضبط: {0}</value>
  </data>
</root>
```
