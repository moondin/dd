...
## Verbatim Content (Part 390 of 851)
...
---[FILE: quantum.xs.in]---
Location: ImageMagick-main/PerlMagick/quantum/quantum.xs.in
...
#define PackageName   "Image::Magick::@MAGICK_ABI_SUFFIX@"
#if PERL_VERSION <= 6
#define PerlIO  FILE
...
typedef void
  *Image__Magick__@MAGICK_ABI_SUFFIX@;  /* data type for the Image::Magick::@MAGICK_ABI_NAME@ package */

/*
  Static declarations.
*/
...
%
*/
MODULE = Image::Magick::@MAGICK_ABI_SUFFIX@ PACKAGE = Image::Magick::@MAGICK_ABI_SUFFIX@
