...
## Verbatim Content (Part 369 of 1290)
...
Location: zulip-main/locale/ml/translations.json
...
```json
{
  ...
  "Call provider": "",
  "Cancel": "റദ്ദാക്കുക",
  "Cancel compose": "രചിക്കൽ വേണ്ടെന്ന് വെക്കൂ",
  ...
  "Last message": "അവസാനത്തെ സന്ദേശം",
  "Last modified": "",
  ...
  "Message editing": "സന്ദേശം തിരുത്തുൽ",
