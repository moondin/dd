...
## Verbatim Content (Part 1230 of 1290)
...
---[FILE: work_package_created.json]---
Location: zulip-main/zerver/webhooks/openproject/fixtures/work_package_created.json
...
---[FILE: work_package_updated.json]---
Location: zulip-main/zerver/webhooks/openproject/fixtures/work_package_updated.json
...
```json
{
    ...
    "work_package": {
      ...
      "description": {
        "format": "markdown",
        "raw": "dxvdsvds",
        "html": "<p class=\"op-uc-p\">dxvdsvds</p>"
      },
      "scheduleManually": false,
      "startDate": null,
      "dueDate": null,
...
---[FILE: doc.md]---
Location: zulip-main/zerver/webhooks/opensearch/doc.md
...
---[FILE: tests.py]---
Location: zulip-main/zerver/webhooks/opensearch/tests.py
