...
## Verbatim Content (Part 575 of 867)
...
---[FILE: iam_policy_allows_privilege_escalation_test.py]---
Location: prowler-master/tests/providers/aws/services/iam/iam_policy_allows_privilege_escalation/iam_policy_allows_privilege_escalation_test.py
...
class Test_iam_policy_allows_privilege_escalation:
    ...
    @mock_aws
    def test_iam_policy_allows_privilege_escalation_iam_put_using_wildcard(
        self,
    ):
        aws_provider = set_mocked_aws_provider([AWS_REGION_US_EAST_1])
        iam_client = client("iam", region_name=AWS_REGION_US_EAST_1)
