...
## Verbatim Content (Part 22 of 695)
...
Location: payload-main/docs/configuration/collections.mdx
...
---[FILE: environment-vars.mdx]---
Location: payload-main/docs/configuration/environment-vars.mdx
