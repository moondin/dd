...
## Verbatim Content (Part 94 of 1290)
...
---[FILE: invoice_initial_remote_server_upgrade--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/invoice_initial_remote_server_upgrade--Event.list.2.json
  ...
  "data": [
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "invoice_initial_remote_server_upgrade--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
          "payment_method_details": {
            "card": {
              "amount_authorized": 4300,
              "authorization_code": "116061",
              "brand": "visa",
              "checks": {
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "invoice_initial_remote_server_upgrade--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
