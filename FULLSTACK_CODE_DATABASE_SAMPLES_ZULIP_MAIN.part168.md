...
## Verbatim Content (Part 168 of 1290)
...
---[FILE: switch_from_monthly_plan_to_annual_plan_for_automatic_license_management--Event.list.1.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/switch_from_monthly_plan_to_annual_plan_for_automatic_license_management--Event.list.1.json
  ...
  "data": [
    {
      ...
      "id": "switch_from_monthly_plan_to_annual_plan_for_automatic_license_management--Event.list.1.json",
      "livemode": false,
      "object": "event",
      "pending_webhooks": 0,
      "request": {
...
---[FILE: switch_from_monthly_plan_to_annual_plan_for_automatic_license_management--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/switch_from_monthly_plan_to_annual_plan_for_automatic_license_management--Event.list.2.json
      ...
      "data": {
        "object": {
          ...
          "payment_details": {
            ...
            "order_reference": "in_1SVWpIDwzgQ85STg7FPEGM"
          },
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "switch_from_monthly_plan_to_annual_plan_for_automatic_license_management--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
