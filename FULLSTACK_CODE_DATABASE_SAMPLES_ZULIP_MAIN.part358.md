...
## Verbatim Content (Part 358 of 1290)
...
---[FILE: django.po]---
Location: zulip-main/locale/ja/LC_MESSAGES/django.po
...
"users to join."
msgstr ""
"Zulip ライセンスが残っておらず、新しいユーザーを受け入れることができません。"
"[ライセンス数を増やす]({billing_page_link})か、[最近利用していないユーザーを"
...
msgstr ""
"残りの Zulipライセンスが１件になりました。 [ライセンス数を増やす]"
"({billing_page_link})か、[最近利用していないユーザーを非アクティブ化]"
...
msgstr ""
"残りの Zulipライセンスが２件になりました。 [ライセンス数を増やす]"
"({billing_page_link})か、[最近利用していないユーザーを非アクティブ化]"
"({deactivate_user_help_page_link})すると、複数のユーザーを追加できるようにな"
"ります。"
...
msgstr ""
"残りの Zulipライセンスが3件になりました。 [ライセンス数を増やす]"
"({billing_page_link})か、[最近利用していないユーザーを非アクティブ化]"
"({deactivate_user_help_page_link})すると、複数のユーザーを追加できるようにな"
"ります。"
...
msgstr ""
"組織で<a class=\"content_disabled_help_link\" href=\"%(help_url)s\">メール通"
...
"content</a> in email notifications."
msgstr ""
"あなたが<a class=\"content_disabled_help_link\" href=\"%(alert_notif_url)s\">"
...
msgstr ""
"\n"
"組織でメール通知にメッセージ内容を表示しないように設定されているため、この"
...
msgstr ""
"\n"
"あなたがメール通知にメッセージ内容を表示しないように設定されているため、この"
"メールにメッセージの内容は含まれていません。\n"
...
msgstr ""
"%(referrer_full_name)s (%(referrer_email)s)があなたがZulipに参加することを望"
"んでいます\n"
...
msgstr ""
"これはリマインダーです。%(referrer_name)sがあなたがZulip に参加することを望ん"
"でいます\n"
"Zulip &mdash; 生産性のために設計されたチームコミュニケーションツール"
...
"productivity."
msgstr ""
"これはリマインダーです。%(referrer_name)s (%(referrer_email)s)があなたが"
...
msgstr ""
"Zulipアカウントに紐付けられているメールアドレスは最近%(new_email)sに変更され"
...
"immediately at <%(support_email)s>."
msgstr ""
"Zulipアカウントに紐付けられているメールアドレスは最近 %(new_email)s に変更さ"
...
msgstr ""
"このログインについて身に覚えがない場合、またはアカウントが侵害された可能性が"
...
msgstr ""
"あなたは以前に%(organization_url)sでアカウントを持っていましたが無効化されて"
...
msgstr ""
"{user_full_name} があなたを {channel_name} のチャンネル登録者に追加しました。"
...
#~ msgstr ""
#~ "\n"
#~ "    この招待は２日後に有効期限が切れます。有効期限が切れた場合は\n"
