...
## Verbatim Content (Part 468 of 867)
...
---[FILE: cloudtrail_s3_dataevents_read_enabled_test.py]---
Location: prowler-master/tests/providers/aws/services/cloudtrail/cloudtrail_s3_dataevents_read_enabled/cloudtrail_s3_dataevents_read_enabled_test.py
...
class Test_cloudtrail_s3_dataevents_read_enabled:
    ...
    @mock_aws
    def test_trail_multi_region_in_other_region_with_read_dataevents(self):
        ...
        with (
            ...
            # FAIL since this trail is multi-region and in another region so Prowler audit is out of scope
            check = cloudtrail_s3_dataevents_read_enabled()
            result = check.execute()
            assert len(result) == 1
            assert result[0].resource_id == AWS_ACCOUNT_NUMBER
