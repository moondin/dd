...
## Verbatim Content (Part 109 of 1290)
...
---[FILE: invoice_plans_as_needed_server--Event.list.3.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/invoice_plans_as_needed_server--Event.list.3.json
  ...
  "data": [
    {
      ...
      "id": "invoice_plans_as_needed_server--Event.list.3.json",
      "livemode": false,
      "object": "event",
      "pending_webhooks": 0,
      "request": {
    ...
    },
    {
      ...
      "data": {
        "object": {
          ...
          "latest_charge": "invoice_plans_as_needed_server--Event.list.3.json",
          "livemode": false,
          "metadata": {},
          "next_action": null,
          ...
          "payment_details": {
            ...
            "order_reference": "in_1SVWvbDwzgQ85STgwLYp8j"
          },
    ...
    },
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "invoice_plans_as_needed_server--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
          "payment_method_details": {
            "card": {
              "amount_authorized": 4300,
              "authorization_code": "665396",
              "brand": "visa",
              "checks": {
...
---[FILE: invoice_plans_as_needed_server--Event.list.4.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/invoice_plans_as_needed_server--Event.list.4.json
...
---[FILE: invoice_plans_as_needed_server--Invoice.create.1.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/invoice_plans_as_needed_server--Invoice.create.1.json
...
---[FILE: invoice_plans_as_needed_server--Invoice.create.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/invoice_plans_as_needed_server--Invoice.create.2.json
