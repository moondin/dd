...
## Verbatim Content (Part 738 of 1290)
...
---[FILE: rendered_markdown.css]---
Location: zulip-main/web/styles/rendered_markdown.css
...
.rendered_markdown {
    ...
    .message-media-inline-image:not(.message-media-gallery-image) {
...
.message_edit_form textarea:read-only,
.rendered_markdown pre {
