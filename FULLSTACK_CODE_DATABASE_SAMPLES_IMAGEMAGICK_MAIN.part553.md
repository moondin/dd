...
## Verbatim Content (Part 553 of 851)
...
---[FILE: escape.html]---
Location: ImageMagick-main/www/escape.html
...
<head>
  ...
  <meta name="keywords" content="Format and Print Image Properties, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>%[artifact:<var>setting</var>]
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>-> identify -format "%m:%f %wx%h" bird.miff
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    ...
    <td>return the dominate image color in hex.  Precede usage with <a href="command-line-options.html#kmeans" >-kmeans</a>.</td>
  </tr>
  <tr>
    <td>%[entropy]</td>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary cli"><samp>magick ... \
...
<p>Use <a href="command-line-options.html#define">-define</a> to specify the color compliance (e.g. <samp>-define pixel:compliance=css</samp>)</p>.
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>%[EXIF:<var>tag</var>] </samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>%[IPTC:<var>dataset</var>:<var>record</var>] </samp></pre>

<p>Select <var>dataset</var> and <var>record</var> from the following:</p>

<pre class="pre-scrollable p-3 mb-2 text-body-secondary bg-body-tertiary text-body-secondary bg-body-tertiary:"><samp>
  Envelope Record
  1:00  Model Version
  1:05  Destination
  1:20  File Format
