...
## Verbatim Content (Part 100 of 867)
...
Location: prowler-master/docs/user-guide/tutorials/v2_to_v3_checks_mapping.mdx
...
---[FILE: example_output_aws.csv]---
Location: prowler-master/examples/output/example_output_aws.csv
