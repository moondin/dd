...
## Verbatim Content (Part 345 of 991)
...
---[FILE: storage.py]---
Location: mlflow-master/mlflow/optuna/storage.py
...
---[FILE: __init__.py]---
Location: mlflow-master/mlflow/optuna/__init__.py
...
---[FILE: _paddle_autolog.py]---
Location: mlflow-master/mlflow/paddle/_paddle_autolog.py
...
def patched_fit(original, self, *args, **kwargs):
    ...
    model_id = None
    if log_models:
        model_id = _initialize_logged_model("model", flavor=mlflow.paddle.FLAVOR_NAME).model_id
