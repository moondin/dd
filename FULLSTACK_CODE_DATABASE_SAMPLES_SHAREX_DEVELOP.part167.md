...
## Verbatim Content (Part 167 of 650)
...
---[FILE: TaskSettingsForm.zh-CN.resx]---
Location: ShareX-develop/ShareX/Forms/TaskSettingsForm.zh-CN.resx
...
<root>
  ...
  <data name="cbClipboardUploadAutoIndexFolder.Text" xml:space="preserve">
    <value>如果剪贴板包含一个文件夹路径，自动索引该文件夹并上传索引</value>
  </data>
  <data name="cbClipboardUploadShareURL.Text" xml:space="preserve">
    <value>如果剪贴板包含一个网址，使用网址分享服务分享它</value>
  </data>
  ...
  <data name="lblImageEffectsNote.Text" xml:space="preserve">
    <value>您可以在"截图后的动作 -&gt;添加图像特效"启用/禁用图像特效。</value>
  </data>
  ...
  <data name="cbImageAutoUseJPEG.Text" xml:space="preserve">
    <value>如果图像大于指定大小，则使用 JPEG 格式:</value>
  </data>
  ...
  <data name="lblActionsNote.Text" xml:space="preserve">
    <value>注意：您可以从“截图后 -&gt; 执行操作”中启用或禁用动作。</value>
  </data>
