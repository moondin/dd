...
## Verbatim Content (Part 580 of 851)
...
---[FILE: resources.html]---
Location: ImageMagick-main/www/resources.html
...
<head>
  ...
  <meta name="keywords" content="Resources, Image Processing, Digital Image Editing, Image Conversion, Open-Source Software, Image Manipulation, Command-Line Image Tools" />
...
<div class="col-lg-8 mx-auto p-4 py-md-5 text-body-secondary">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="../index.html" class="d-flex align-items-center text-decoration-none">
      <h1 class="mt-5 fs-4">Resources</h1>
    </a>
  </header>
...
<dt class="col-md-4"><a href="https://imagemagick.org/source/delegates.xml">delegates.xml</a></dt>
  ...
  ImageMagick relies on a number of delegate programs to support certain image formats such as <a href="../index.html">darktable</a> to read raw camera formats or <a href="http://www.cs.wisc.edu/~ghost/">Ghostscript</a> to read Postscript images.  Use this configuration file to map an input or output format to an external delegate program.
  </dd>
...
<dt class="col-md-4"><a href="https://imagemagick.org/source/policy-open.xml">policy.xml</a></dt>
  <dd class="col-md-8">Configure ImageMagick <a href="security-policy.html">security policies</a>.
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>&lt;policy domain="resource" name="area" value="100MP"/></samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>&lt;policy domain="resource" name="width" value="8KP"/></samp></pre>

To limit the elapsed time of any ImageMagick command to 5 minutes, use this policy:

<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>&lt;policy domain="resource" name="time" value="300"/></samp></pre>
...
&lt;<var>current directory</var>&gt;</samp></pre>
...
&lt;<var>client path</var>&gt;</samp></pre>

<p>Above, $PREFIX is the default install path, typically <samp>c:\\Program Files\\ImageMagick-7.1.2</samp>.</p>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>$MAGICK_HOME/lib/ImageMagick-7.1.2/modules-Q16/coders
&lt;<var>client path</var>&gt;/../lib/ImageMagick-7.1.2/modules-Q16/coders
$MAGICK_HOME/lib/ImageMagick-7.1.2/modules-Q16/coders
$MAGICK_HOME/share/ImageMagick-7.1.2/modules-Q16/coders
$XDG_CACHE_HOME/ImageMagick
$HOME/.config/ImageMagick
&lt;<var>client path</var>&gt;/lib/ImageMagick-7.1.2/modules-Q16/coders</samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>$MAGICK_HOME/lib/ImageMagick-7.1.2/modules-Q16/filters
&lt;<var>client path</var>&gt;/../lib/ImageMagick-7.1.2/modules-Q16/filters
$MAGICK_HOME/lib/ImageMagick-7.1.2/modules-Q16/filters
$MAGICK_HOME/share/ImageMagick-7.1.2/modules-Q16/filters
$XDG_CACHE_HOME/ImageMagick
$HOME/.config/ImageMagick
&lt;<var>client path</var>&gt;/lib/ImageMagick-7.1.2/modules-Q16/filters</samp></pre>
...
<!-- Magick Cache 27th July 2025 09:41 -->
```
