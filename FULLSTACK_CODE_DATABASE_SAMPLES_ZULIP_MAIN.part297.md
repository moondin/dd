...
## Verbatim Content (Part 297 of 1290)
...
Location: zulip-main/locale/bg/translations.json
...
```json
{
  ...
  "Don’t allow disposable email addresses": "Забрани еднократните имейл адреси",
  "Download": "Изтегли",
  ...
  "Welcome to Zulip!": "Добре дошли в Zulip!",
  ...
  "Who can notify a large number of users with a wildcard mention": "Кой може да известява голям брой потребители с групово споменаване",
  ...
  "{count, plural, one {# message} other {# messages}} will be moved.": "{count, plural, one {# съобщение} other {# съобщения}} will be moved.",
