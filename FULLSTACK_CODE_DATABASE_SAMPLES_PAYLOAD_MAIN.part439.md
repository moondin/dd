...
## Verbatim Content (Part 439 of 695)
...
---[FILE: home.ts]---
Location: payload-main/templates/ecommerce/src/endpoints/seed/home.ts
...
---[FILE: image-hat.ts]---
Location: payload-main/templates/ecommerce/src/endpoints/seed/image-hat.ts
...
Location: payload-main/templates/ecommerce/src/endpoints/seed/image-hero-1.ts

```typescript
import { RequiredDataFromCollectionSlug } from 'payload'

export const imageHero1Data: RequiredDataFromCollectionSlug<'media'> = {
...
---[FILE: image-tshirt-black.ts]---
Location: payload-main/templates/ecommerce/src/endpoints/seed/image-tshirt-black.ts
...
---[FILE: image-tshirt-white.ts]---
Location: payload-main/templates/ecommerce/src/endpoints/seed/image-tshirt-white.ts
...
---[FILE: index.ts]---
Location: payload-main/templates/ecommerce/src/endpoints/seed/index.ts
