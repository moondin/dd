...
## Verbatim Content (Part 380 of 1290)
...
Location: zulip-main/locale/no/translations.json
Signals: React, Next.js

```json
{
  "%'{file}' exceeds the maximum file size for attachments ({variable} MB).": "%'{fil}' overgår maksimum lovlig filstørrelse for vedlegg ({variabel} MB).",
  "(attached file)": "",
  "(default)": "",
  "(forever)": "(for alltid)",
  "(hidden)": "(skjult)",
  ...
  "6 hours": "6 timer",
  "90 days": "",
  "<b>Total messages</b>: {total_messages}": "<b>Totalt antall beskjeder</b>:: {antall_beskjeder}",
  ...
  "Add a new emoji": "Legg til en ny emoji",
  "Add a new linkifier": "",
  ...
  "Add video call": "Legg til videosamtale",
  "Add voice call": "",
  ...
  "An unknown error occurred.": "En ukjent feil fant sted.",
  "Animals & Nature": "",
