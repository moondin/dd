...
## Verbatim Content (Part 330 of 1290)
...
Location: zulip-main/locale/fa/translations.json
...
```json
{
  ...
  "<kbd>Enter</kbd> sends when composing a message": "<kbd>Enter</kbd> برای ارسال پیام هنگام نوشتن",
  ...
  "<z-link>Learn more</z-link> about other data export options.": "در مورد سایر گزینه‌های خروجی گرفتن داده‌ها، <z-link>بیشتر یاد بگیرید</z-link>.",
  ...
  "A deactivated user group with this name already exists.": "یک گروه کاربری غیرفعال شده با این نام وجود دارد.",
  ...
  "A public data export is a complete data export for your organization other than <z-private-channel-link>private channel</z-private-channel-link> messages and <z-direct-messages-link>direct messages</z-direct-messages-link>.": "خروجی داده‌های عمومی، خروجی کاملی از داده‌ها برای سازمان شما است، جدا از <z-private-channel-link>پیام‌های کانال خصوصی</z-private-channel-link> و <z-direct-messages-link>پیام‌های مستقیم</z-direct-messages-link>.",
  "A standard export additionally includes private data accessible to users who have allowed administrators to export their private data.": "یک خروجی استاندارد، علاوه بر این شامل داده‌های خصوصی قابل دسترسی برای کاربرانی است که به مدیران اجازه خروجی گرفتن از داده‌های خصوصی خود را داده‌اند.",
  "A to-do list must be an entire message.": "یک لیست انجام کار‌ها باید یک پیام کامل باشد.",
  ...
  "AI summaries are not available on Zulip Cloud yet.": "خلاصه‌های ساخته شده با هوش مصنوعی هنوز در زولیپ ابری در دسترس نیستند.",
  "AI summaries are not enabled on this server.": "خلاصه‌های هوش مصنوعی روی این سرور فعال نشده‌اند.",
  "AI summaries may have errors.": "خلاصه‌سازی‌های هوش مصنوعی ممکن است خطا داشته باشند.",
  "API documentation": "مستندات API",
  "API key": "کلید API",
  "About Zulip": "درباره زولیپ",
  "Account": "حساب کاربری",
  "Account & privacy": "حساب کاربری و حریم خصوصی",
  "Action": "اقدام",
  "Action message": "پیام اقدام",
  "Actions": "عملیات",
  "Active an hour ago": "یک ساعت پیش فعال بوده",
  "Active and deactivated": "فعال و غیرفعال کردن",
  "Active bots": "بات های فعال",
  "Active groups": "گروه‌های فعال",
  ...
  "Add roles, groups or users": "اضافه کردن نقش‌ها، گروه‌ها و کاربران",
  "Add saved snippet": "اضافه کردن قطعه کد ذخیره شده",
  "Add subscribers": "اضافه کردن اعضا",
  "Add subscribers to": "اضافه کردن مشترکین به",
  "Add subscribers.": "",
  "Add task": "افزودن وظیفه",
  "Add to-do list": "اضافه کردن فهرست کارها",
  "Add todo task list title": "اضافه کردن عنوان برای لیست کارها",
  "Add user groups": "اضافه کردن گروه‌های کاربری",
  "Add users or groups. Use #channelname to add all subscribers.": "گروه‌های کاربری را اضافه کنید. از #نام‌کانال برای اضافه کردن مشترکان استفاده کنید.",
  ...
  "Add {full_name} to groups": "اضافه‌کردن {full_name} به گروه‌ها",
  ...
  "After how much time should all data for this organization be permanently deleted (users, channels, messages, etc.)?": "بعد از چه مدت زمانی باید تمام داده‌های این سازمان (کاربران، کانال‌ها، پیام‌ها و غیره) برای همیشه حذف شوند؟",
  ...
  "All roles ({count})": "تمام نقش‌ها ({count})",
  ...
  "All your messages.": "تمام پیام‌های شما.",
  ...
  "Allow viewing the history of a message?": "اجازه می‌دهید سابقه پیام‌ها دیده شود؟",
  ...
  "Already above recommended maximum font size ({maximum_value})": "در حال حاضر بیشتر از حداکثر اندازه فونت پیشنهاد شده ({maximum_value})، است.",
  "Already above recommended maximum line spacing": "در حال حاضر فاصله خطوط بیشتر از حداکثر فاصله توصیه‌شده، است.",
  "Already at default font size ({default_value})": "در حال حاضر دارای اندازه فونت پیش‌فرض ({default_value})",
  "Already at default line spacing": "در حال حاضر دارای فاصله خطوط پیش‌فرض",
  "Already at maximum font size ({maximum_value})": "در حال حاضر دارای حداکثر اندازه فونت ({maximum_value})",
  "Already at maximum line spacing": "در حال حاضر دارای حداکثر فاصله خطوط",
  "Already at minimum font size ({minimum_value})": "در حال حاضر دارای حداقل اندازه فونت ({maximum_value})",
  "Already at minimum line spacing": "در حال حاضر دارای حداقل فاصله خطوط",
  "Already below recommended minimum font size ({minimum_value})": "در حال حاضر کمتر از حداقل اندازه فونت پیشنهاد شده ({minimum_value})، است.",
  "Already below recommended minimum line spacing": "در حال حاضر فاصله خطوط کمتر از فاصله توصیه‌شده، است.",
  ...
  "An archived channel with this name already exists.": "یک کانال بایگانی شده با این نام، وجود دارد.",
  ...
  "Anyone can add more tasks after the to-do list is posted.": "پس از انتشار لیست انجام کارها، هرکسی می‌تواند کارهای بیشتر به آن اضافه کند.",
  "Anyone on the internet can view messages; members of your organization can join.": "هر کسی در اینترنت می‌توان پیام‌ها را ببیند؛ اعضای سازمان شما می‌توانند وارد شوند.",
  "App theme": "زمینه اپ",
  "April": "آوریل",
  "Archive <z-link></z-link>?": "آرشیو <z-link></z-link>؟",
  "Archive channel": "آرشیو کردن کانال",
  "Archived and non-archived": "بایگانی شده و بایگانی نشده",
  "Archived channels": "کانال‌های بایگانی شده",
  "Archiving this channel will:": "بایگانی کردن این کانال باعث:",
  ...
  "Are you sure you want to deactivate this organization? All users will lose access to their Zulip accounts.": "آیا از غیرفعال کردن این سازمان مطمئن هستید؟ همه کاربران دسترسی به حساب‌های کاربری زولیپ خود را از دست خواهند داد.",
  ...
  "Are you sure you want to join it directly as well?": "آیا مطمئن هستید که می‌خواهید مستقیماً به آن بپیوندید؟",
  "Are you sure you want to mark messages as unread? Messages in multiple conversations may be affected.": "آیا مطمئن هستید که می‌خواهید پیام‌ها را به عنوان خوانده‌نشده علامت‌گذاری کنید؟ پیام‌هایی که در چند مکالمه مختلف باشند ممکن است تحت تأثیر قرار گیرند.",
  "Are you sure you want to mark {count} messages as unread? Messages in multiple conversations may be affected.": "آیا مطمئن هستید که می‌خواهید {count} پیام‌ را به خوانده‌نشده تبدیل کنید؟ پیام‌هایی که در چند مکالمه مختلف باشند ممکن است تحت تأثیر قرار می‌گیرند.",
  ...
  "Are you sure you want to permanently delete <z-topic-display-name></z-topic-display-name>?": "آیا مطمئن هستید که می‌خواهید به صورت دائمی <z-topic-display-name></z-topic-display-name> را حذف کنید؟",
  ...
  "At least {count, plural, one {# message} other {# messages}} will be moved.": "حداقل {count, plural, one {# پیام} other {# پیام}} حذف خواهند شد.",
  ...
  "Automatically follow topics based on my participation": "دنبال کردن اتوماتیک موضوعاتی که من در آن‌ها مشارکت می‌کنم",
  "Automatically follow topics where I'm mentioned": "موضوعاتی که در آنها به من اشاره شده است، به صورت خودکار دنبال کن",
  "Automatically go to conversation where you sent a message": "به صورت اتوماتیک به مکالمه‌ای می‌روید که در آن پیامی فرستاده‌اید",
  ...
  "Available": "",
  "Available on Zulip Cloud Standard.": "قابل دسترس در زولیپ ابری استاندارد",
  "Avatar": "آواتار",
  ...
  "BROWSE 1 MORE CHANNEL": "مرور 1 کانال دیگر",
  "BROWSE {can_subscribe_stream_count} MORE CHANNELS": "مرور {can_subscribe_stream_count} کانال دیگر",
  ...
  "Because you are not subscribed to <z-streams></z-streams>, messages in this channel were not marked as unread.": "از آنجا که شما در کانال <z-streams></z-streams> مشترک نیستید، پیام‌های این کانال به عنوان خوانده نشده علامت‌گذاری نشده‌اند.",
  ...
  "Change to default line spacing": "تغییر به فاصله خطوط پیش‌فرض",
  "Change to font size {new_value}": "تغییر اندازه فونت به {new_value}",
  "Change to {new_value_string} line spacing": "تغییر به فاصله خطوط {new_value_string}",
  ...
  "Channel folder name": "",
  "Channel folders": "",
  "Channel links in the left sidebar go to": "لینک‌های کانال‌های نوار کناری به اینجا می‌روند",
  ...
  "Channels organize conversations based on who needs to see them.": "کانال‌ها مکالمات را بر اساس اینکه چه کسی باید آنها را ببیند، سازماندهی می‌کنند.",
  "Channels they should join": "کانال‌هایی که باید عضو شوند",
  "Check all": "بررسی همه",
  "Check your email (<b>{email}</b>) to confirm the new address.": "ایمیل خود (<b>{email}</b>) را کنترل کنید و آدرس جدید را تایید کنید.",
  ...
  "Combined feed options": "گزینه‌های ترکیب فیدها",
  "Common words were excluded from your search:": "",
  "Community": "انجمن",
  "Commuting": "در رفت و آمد",
  "Compact": "فشرده",
  "Complete": "کامل",
  "Complete your organization profile, which is displayed on your organization's registration and login pages.": "مشخصات سازمان خود را که در صفحات ثبت نام و ورود به سیستم سازمان شما نمایش داده می‌شود، تکمیل کنید.",
  "Compose a message.": "یک پیام بنویسید",
  "Compose message": "ایجاد پیام",
  "Compose settings": "تنظیمات نوشتن",
  "Compose your message here": "پیام خود را اینجا بنویسید",
  "Compose your message here…": "",
  "Composing messages": "نوشتن پیام‌ها",
  "Configuration instructions": "راهنمای پیکریندی",
  ...
  "Configure outgoing mail": "پیکربندی ایمیل ارسالی",
  ...
  "Confirm new color": "تایید رنگ جدید",
  ...
  "Could not update time zone": "امکان به‌روزرسانی منطقه زمانی نیست",
  "Create": "ایجاد",
  "Create a channel": "ساخت یک کانال",
  "Create a collaborative to-do list": "ساخت یک لیست مشارکتی وظایف",
  "Create a new saved snippet": "ساخت یک قطعه کد ذخیره شده",
  ...
  "Create to-do list": "ساخت لیست کارها",
  "Create user group": "ساخت گروه کاربری",
  "Created by <z-user></z-user> on <z-date-created></z-date-created>.": "ساخته شده توسط <z-user></z-user> در <z-date-created></z-date-created>",
  "Created on <z-date-created></z-date-created>.": "ساخته شده در <z-date-created></z-date-created>.",
  "Creating channel…": "",
  "Creating group…": "",
  "Creating link…": "در حال ساختن لینک...",
  "Current font size: {current_value}": "اندازه فونت فعلی: {current_value}",
  "Current line spacing: {current_value_string}": "فاصله خطوط فعلی: {current_value_string}",
  ...
  "Custom time ({min}+ days)": "زمان سفارشی ({min}+ روز)",
  "Custom time ({min}-{max} days)": "زمان سفارشی ({min}-{max} روز)",
  "Customize a channel": "",
  "Customize another channel": "",
  "Customize notifications": "سفارشی‌کردن اطلاع‌رسانی‌ها",
  ...
  "Data will be deleted after {date}": "داده‌ها پس از {date} حذف خواهند شد",
  "Data will be deleted immediately": "داده‌ها بلافاصله پاک خواهند شد",
  "Data will not be automatically deleted": "داده‌ها به صورت اتوماتیک حذف نمی‌شوند",
  ...
  "Deactivate group": "غیرفعال کردن گروه",
  ...
  "Demo organization": "",
  "Demo organization deadline": "پایان مهلت سازمان آزمایشی",
  ...
  "Disable": "غیر فعال",
  "Disable announcements that are currently sent to this channel:": "غیرفعال کردن اطلاعیه‌هایی که در حال حاضر به این کانال ارسال می‌شود:",
  ...
  "Do you want to <z-link>allow your private data to be exported</z-link>?": "آیا می‌خواهید <z-link>اجازه دهید داده‌های خصوصی شما خروجی گرفته شود</z-link>؟",
  "Do you want to convert the pasted text into a file?": "",
  "Domain": "دامنه",
  "Don't allow": "اجازه نده",
  "Don't delete": "پاک نکن",
  ...
  "Drafts options": "گزینه‌های پیش‌نویس‌ها",
  ...
  "Edit #{stream_name} (<i>archived</i>)": "ویرایش #{stream_name} (<i>بایگانی شده</i>)",
  "Edit channel folder": "",
  ...
  "Embedded bot": "بات امبدد",
  "Emoji": "ایموجی",
  "Emoji name": "نام ایموجی",
  "Emoji reactions to your messages.": "واکنش‌های ایموجی به پیام‌های شما.",
  ...
  "Enter a task before adding a description.": "قبل از نوشتن توضیحات،‌ ابتدا یک وظیفه را اضافه کنید.",
  "Enter a topic (skip for <z-empty-string-topic-display-name></z-empty-string-topic-display-name>)": "یک موضوع وارد کنید (از <z-empty-string-topic-display-name></z-empty-string-topic-display-name> صرف نظر کن)",
  "Enter to send choices": "Enter برای فرستادن گزینه‌ها",
  "Enter who should be added.": "",
  "Error": "خطا",
  "Error adding subscription": "خطا در افزودن عضویت",
  "Error adding user to {group_name}: {error}": "خطا در اضافه کردن کاربر به {group_name}: {error}",
  "Error creating channel": "خطا در ساخت کانال",
  "Error creating channel: A channel with this name already exists.": "خطا در ساخت کانال: یک کانال با این نام وجود دارد.",
  ...
  "Error joining {group_name}: {error}": "خطا در اتصال به {group_name}: {error}",
  "Error leaving group {group_name}": "خطا در ترک گروه {group_name}",
  ...
  "Error removing subgroup from this group.": "خطا در هنگام حذف زیرگروه از این گروه",
  "Error removing subscription": "خطا در حذف عضویت",
  "Error removing user from #{channel_name}": "خطا در جابجایی پیام از #{channel_name}",
  "Error removing user from group {group_name}": "خطا در حذف کاربر از گروه {group_name}",
  ...
  "Error: Could not resend invitation.": "خطا: فرستادن دعوتنامه ممکن نیست",
  "Error: Could not resolve topic.": "",
  "Error: Could not revoke invitation.": "خطا: لغو دعوت امکان‌پذیر نبود.",
  ...
  "Everyone": "همه",
  "Everyone except guests": "همه به‌جز مهمان‌ها",
  "Everyone including guests": "همه به همراه مهمان‌ها",
  ...
  "Export permission": "اجازه خروجی گرفتن",
  "Export permissions": "اجازه‌های خروجی گرفتن",
  ...
  "Failed to load read receipts.": "خطا در لود کردن رسید دریافت.",
  ...
  "Failed: Invalid Pattern": "ناموفق: الگوی نامعتبر",
  ...
  "Filter direct messages": "فیلتر کردن پیام‌های مستقیم",
  ...
  "Filter invitations": "فیلتر دعوتنامه‌ها",
  "Filter left sidebar": "",
  ...
  "Filter {total_user_count, plural, =1 {1 person} other {# people}}": "فیلتر کردن {total_user_count, plural, =1 {1 نفر} other {# نفر}}",
  ...
  "Forward message": "فورواردکردن پیام",
  "Friday": "جمعه",
  "Full members": "اعضای کامل",
  ...
  "Go to #{channel_name} &gt; <z-topic-display-name></z-topic-display-name>": "برو به #{channel_name} &gt; <z-topic-display-name></z-topic-display-name>",
  "Go to #{display_recipient}": "برو به #{display_recipient}",
  "Go to #{display_recipient} > {topic_display_name}": "برو به #{display_recipient} > {topic_display_name}",
  "Go to channel feed": "برو به فیدهای کانال",
  "Go to channel feed from topic view": "رفتن به فید کانال‌ها از صفحه موضوعات",
  "Go to channel settings": "رفتن به تنظیمات کانال",
  "Go to combined feed": "بروه به فیدهای ترکیبی",
  "Go to conversation": "برو به مکالمه",
  "Go to direct message feed": "برو به فید پیام‌های مستقیم",
  ...
  "Go to inbox": "رفتن به صندوق ورودی",
  ...
  "Go to next unread followed topic": "برو به پیام خوانده نشده بعدی در موضوعات دنبال شده",
  "Go to next unread topic": "رفتن به موضوع خوانده نشده بعدی",
  "Go to recent conversations": "برو به مکالمات اخیر",
  "Go to starred messages": "برو به پیام‌های ستاره‌دار",
  ...
  "Go to {recipient_text}": "برو به {recipient_text}",
  "Got it": "متوجه شدم",
  "Got it — Cancel": "متوجه شدم — لغو",
  "Got it — Confirm": "متوجه شدم — تایید",
  "Government": "دولت",
  "Granted": "اعطاشده",
  ...
  "Help menu": "منو کمک",
  "Hide AI features": "پنهان کردن ویژگی‌های هوش مصنوعی",
  ...
  "However, it will no longer be subscribed to the private channels that you are not subscribed to.": "با این حال، دیگر در کانال‌های خصوصی که مشترک آنها نیستید، مشترک نخواهید شد.",
  "Humans": "افراد",
  "Idle": "بی کار",
  ...
  "Ignored deactivated groups:": "گروه‌های غیرفعال نادیده گرفته شده:",
  ...
  "Inbox": "صندوق ورودی",
  "Inbox options": "گزینه‌های صندوق ورودی",
  ...
  "Including message content in message notification emails is not allowed in this organization.": "در این سازمان، اضافه کردن محتوای پیام در ایمیل‌های اطلاع‌رسانی، مجاز نیست.",
  "Incoming webhook": "وب‌هوک‌های ورودی",
  "Increase font size": "افزایش اندازه فونت",
  "Increase line spacing": "افزایش فاصله خطوط",
  "Information": "اطلاعات",
  "Initiate a search": "شروع یک جستجو",
  "Insecure desktop app": "برنامه دسکتاپ ناامن",
  ...
  "Invalid custom time": "زمان سفارشی غیرمعتبر",
  "Invalid date value": "",
  ...
  "Invite to organization": "دعوت به سازمان",
  ...
  "Joining and viewing messages requires being invited": "متصل شدن و دیدن پیام‌ها نیازمند دعوت شدن است",
  "Joining and viewing messages requires being invited; users can only view messages sent while they were subscribed": "پیوستن و مشاهده پیام‌ها نیاز به دعوت دارد؛ کاربران فقط می‌توانند پیام‌های ارسال شده در زمان عضویت خود را مشاهده کنند.",
  ...
  "LOG IN TO BROWSE MORE": "برای مرور بیشتر وارد شوید",
  "Label": "برچسب",
  "Language": "زبان",
  ...
  "Last edited {edited_time_string}.": "آخرین ویرایش {edited_time_string}.",
  "Last message": "آخرین پیام",
  "Last modified": "آخرین تغییر",
  "Last moved {moved_time_string}.": "آخرین جابه‌جایی {moved_time_string}.",
  "Learn more": "یادگیری بیشتر",
  "Learn more about emoji reactions <z-link>here</z-link>.": "درباره واکنش‌های ایموجی در <z-link>اینجا</z-link> چیزهای بیشتری یاد بگیرید.",
  "Learn where to find everything you need to get started with this 2-minute video tour.": "با این تور ویدیویی 2 دقیقه‌ای یاد بگیرید که هر آنچه را برای شروع نیاز دارید، از کجا پیدا کنید.",
  "Leave group": "ترک گروه",
  "Leave group {name}": "ترک گروه {name}",
  "Leave {group_name}": "ترک کردن {group_name}",
  "Left sidebar": "",
  "Let administrators export my private data": "اجازه به مدیران برای خروجی گرفتن از اطلاعات خصوصی من",
  ...
  "Manage channel settings": "مدیریت تنظیمات کانال",
  ...
  "Mark messages as unread?": "علامت‌گذاری پیام به عنوان خوانده نشده؟",
  "Mark topic as read": "تبدیل موضوع به خوانده شده",
  "Mark topic as resolved": "علامت‌گذاری موضوع به عنوان حل‌شده",
  "Matching Zulip channel": "",
  "Math (LaTeX)": "ریاضی (لاتکس)",
  "Maximize compose box": "حداکثرکردن بخش نوشتن",
  "Maximum message length: {max_length} characters": "حداکثر طول پیام: {max_length} کاراکتر",
  "Maximum message length: {max_message_length} characters": "حداکثر طول پیام: {max_message_length} کاراکتر",
  "Maximum password length: {max_length} characters.": "حداکثر طول کلمه عبور: {max_length} کاراکتر",
  "Maximum password length: {max} characters.": "حداکثر طول کلمه عبور: {max} کاراکتر",
  "May": "می",
  "Me": "من",
  "Member": "عضو",
  "Members": "اعضا",
  "Members of your organization can view messages and join": "اعضای سازمان شما می‌توانند پیام‌ها را ببینند و وارد شوند",
  "Members preview": "پیش‌نمایش اعضا",
  ...
  "Message <z-recipient-label></z-recipient-label>": "پیام <z-recipient-label></z-recipient-label>",
  "Message actions": "اقدامات برروی پیام",
  "Message deletion": "پاک کردن پیام",
  "Message edit and move history": "سابقه ویرایش و جابه‌جایی پیام",
  "Message edit history": "تاریخچه ویرایش پیام",
  "Message editing": "ویرایش پیام",
  "Message feed settings": "تنظیمات فید پیام",
  ...
  "Message move history": "سابقه جابه‌جایی پیام",
  ...
  "Messages in topics you follow.": "پیام‌ها در موضوعاتی که شما دنبال می‌کنید.",
  "Messages in your view are faded to remind you that you are viewing a different conversation from the one you are composing to.": "پیام‌های در صفحه شما محو می‌شوند تا به شما یادآوری کنند که شما مکالمه‌ای متفاوت از آن که در آن پیام می‌دهید، مشاهده می‌کنید.",
  "Messages must be scheduled at least {minimum_scheduled_message_delay_minutes} minutes in the future.": "پیام‌ها باید حداقل برای {minimum_scheduled_message_delay_minutes} دقیقه دیگر در آینده، برنامه‌ریزی شوند.",
  ...
  "Move <z-stream-or-topic></z-stream-or-topic>": "حرکت <z-stream-or-topic></z-stream-or-topic>",
  "Move all messages in this topic": "جابجایی تمام پیام‌ها در این موضوع",
  "Move history only": "فقط سابقه را جابه‌جا کن",
  "Move message": "جابجایی پیام",
  "Move messages": "جابجایی پیام‌ها",
  "Move messages from <z-stream-or-topic></z-stream-or-topic>": "جابه‌جا کردن پیام‌ها از <z-stream-or-topic></z-stream-or-topic>",
  ...
  "Narrow to messages in followed topics.": "محدود کردن به پیام‌های موجود در موضوعات دنبال‌شده.",
  "Narrow to messages in resolved topics.": "محدود کردن به پیام‌های موجود در موضوعات حل‌شده.",
  "Narrow to messages in unresolved topics.": "محدود به پیام‌های مربوط به موضوعات حل‌نشده.",
  ...
  "Narrow to messages with emoji reactions.": "محدود کردن به پیام های دارای واکنش‌های ایموجی.",
  "Narrow to messages with topic <z-value></z-value>.": "محدود کردن به پیام‌ها با موضوع <z-value></z-value>.",
  "Narrow to muted messages.": "محدود کردن به پیام‌های بی‌صدا شده.",
  ...
  "New password is too weak!": "رمز عبور جدید بسیار ضعیف است!",
  "New task": "وظیفه جدید",
  ...
  "No channels match your filter.": "هیچ کانالی با فیلتر شما منطبق نبود.",
  "No channels to show.": "کانال برای نمایش‌دادن نیست.",
  ...
  "No custom profile fields configured.": "پیکربندی برای هیچ فیلد سفارشی پروفایل انجام نشده است.",
  ...
  "No, don't ask again.": "نه، دوباره سوال نکن.",
  "Nobody": "هیچ کس",
  ...
  "Non-archived channels": "کانال‌های بایگانی نشده",
  "Non-profit (registered)": "غیرانتفاعی (ثبت شده)",
  "None": "هیچکدام",
  "None of the members of <z-group-pill></z-group-pill> are subscribed to this channel.": "هیج کدام از اعضای <z-group-pill></z-group-pill> در این کانال مشترک نیستند.",
  "None of your messages have emoji reactions yet.": "هنوز هیچ‌کدام از پیام‌های شما واکنش ایموجی ندارند.",
  "Not a member of any groups.": "عضو هیچ گروهی نیست.",
  "Not active in the last year": "در سال گذشته فعال نبوده است",
  ...
  "November": "نوامبر",
  "Now following <z-link></z-link>.": "الان <z-link></z-link> دنبال می‌شود.",
  ...
  "Objects": "اشیاء",
  "October": "اکتبر",
  "Offer to update to my computer's time zone": "پینشهاد برای به‌روزرسانی منطقه زمانی کامپیوتر من",
  ...
  "One or more files could not be deleted.": "یک یا چند عدد از فایل‌ها قابل حذف کردن نیستند.",
  ...
  "Only channel administrators can edit these settings.": "فقط مدیران کانال می‌توانند این تنظیمات را ویرایش کنند.",
  ...
  "Organization administrators can automatically administer all channels.": "مدیران سازمان به صورت اتوماتیک می‌توانند تمام کانال‌ها را مدیریت کنند.",
  ...
  "Organization profile incomplete": "پروفایل سازمان کامل نیست",
  ...
  "Other views": "صفحه‌های دیگر",
  "Out sick": "بیمار",
  "Outgoing webhook": "وب‌هوک‌های خروجی",
  ...
  "Play animated images": "پخش تصاویر متحرک‌شده",
  ...
  "Please add a valid recipient.": "لطفا یک گیرنده معتبر اضافه کنید.",
  "Please ask a user with billing permission to <z-link-billing>increase the number of licenses</z-link-billing> or <z-link-help-page>deactivate inactive users</z-link-help-page>, and try again.": "از یک کاربر با دسترسی صورتحساب بخواهید که <z-link-billing>تعداد مجوزها را افزایش دهد</z-link-billing> یا <z-link-help-page>کاربران غیرفعال را حذف کنید</z-link-help-page> و دوباره تلاش کنید.",
  "Please choose a new password.": "لطفا یک کلمه عبور جدید انتخاب کنید.",
  "Please enter a question.": "لطفاً یک سوال وارد کنید.",
  "Please enter task title.": "لطفا عنوان وظیفه را وارد کنید.",
  "Please enter your password.": "لطفا کلمه عبور خود را وارد کنید.",
  ...
  "Please select a channel.": "لطفا یک کانال را انتخاب کنید.",
  ...
  "Prevent messages in this channel from being edited, deleted, or moved.": "از ویرایش، پاک کردن و یا جابه‌جایی پیام‌های این کانال جلوگیری کن.",
  "Prevent new messages from being sent to this channel.": "از ارسال پیام‌های جدید به این کانال جلوگیری کن.",
  ...
  "Profile": "پروفایل",
  "Profile missing required fields": "فیلدهای الزامی که در پروفایل وجود ندارند",
  "Pronouns": "ضمایر",
  "Public": "عمومی",
  "Public data": "داده عمومی",
  "Question": "سوال",
  "Quote": "نقل قول",
  "Quote message": "نقل قول پیام",
  ...
  "Reactions": "واکنش‌ها",
  "Reactions to your messages": "واکنش‌ها به پیام‌های شما",
  ...
  "Read receipts are disabled for this organization.": "رسید دریافت در این سازمان غیرفعال شده است.",
  ...
  "Recent conversations options": "گزینه‌های مکالمات اخیر",
  "Reloading…": "بارگیری مجدد...",
  "Remind me about this": "",
  "Reminder scheduled": "",
  "Reminders": "",
  "Remove": "حذف",
  "Remove from default": "از پیش فرض حذف کن",
  "Remove it from the left sidebar for all users.": "این مورد را برای همه کاربران، از منوی کناری حذف کن.",
  "Removed successfully!": "با موفقیت حذف شد!",
  "Rename <z-stream-or-topic></z-stream-or-topic>": "تغییر نام <z-stream-or-topic></z-stream-or-topic>",
  "Rename archived channel": "تغییر نام کانال بایگانی شده",
  "Rename deactivated user group": "تغییر نام گروه کاربری غیرفعال شده",
  "Rename topic": "تغییر نام موضوع",
  "Rename {group_name} (<i>deactivated</i>)": "تغییر نام {group_name} (<i>غیرفعال</i>)",
  ...
  "Reset to default font size ({default_value})": "تنظیم اندازه فونت به اندازه پیش‌فرض ({default_value})",
  "Reset to default line spacing": "بازگشت به فاصله خطوط پیش‌فرض",
  "Reset to default notifications": "بازنشانی اطلاع‌رسانی‌های پیش‌فرض",
  "Reset to default notifications?": "",
  "Reset zoom": "بازنشانی زوم",
  "Resolved topics": "موضوعات حل‌شده",
  "Restrict email domains of new users": "محدود کردن دامنه‌های ایمیل کاربران جدید",
  ...
  "Scrolling": "حرکت دادن",
  "Scrolling to your last message will mark <b>{num_unread}</b> unread messages as read. Would you like to scroll to that message and edit it?": "با اسکرول کردن به آخرین پیام، <b>{num_unread}</b> پیام‌ خوانده نشده به عنوان خوانده شده، علامت‌گذاری می‌شوند. آیا می‌خواهید به آن پیام بروید و آن را ویرایش کنید؟",
  "Search": "جستجو",
  "Search all public channels that you can view.": "تمام کانال‌های عمومی که شما می‌توانید ببینید، جستجو شود.",
  "Search all public channels.": "جستجوی تمام کانال‌های عمومی.",
  ...
  "Send me a direct message when my invitation is accepted": "وقتی دعوت‌نامه من پذیرفته شد برای من یک پیام مستقیم بفرست",
  ...
  "Send notifications for all branches": "ارسال اطلاع‌رسانی برای همه شاخه‌ها",
  ...
  "September": "سپتامبر",
  "Server needs upgrade": "سرور نیازمند به‌روزرسانی است",
  "Set font size to default": "تنظیم اندازه فونت به پیش‌فرض",
  "Set line spacing to default": "تنظیم فاصله خطوط به پیش‌فرض",
  "Set status": "تعیین وضعیت",
  "Set up two factor authentication": "راه‌اندازی اعتبارسنجی دو مرحله‌ای",
  "Setting updated": "تنظیمات به‌روزرسانی شد",
  "Settings": "تنظیمات",
  "Setup": "پیکره بندی",
  "Several people are typing…": "افراد زیادی در حال نوشتن هستند...",
  "Show API key": "نمایش کلید API",
  "Show all": "",
  "Show all topics": "نمایش تمام موضوعات",
  "Show avatar": "نمایش آواتار",
  "Show channel folders": "",
  "Show counts for starred messages": "نمایش تعداد برای پیام های ستاره دار",
  "Show edits and moves": "نمایش ویرایش‌ها و جابه‌جایی‌ها",
  ...
  "Sign up": "نام‌نویسی",
  "Size": "اندازه",
  "Skip the rest": "رد کردن باقیمانده",
  "Skip video — I'm familiar with Zulip": "رد کردن ویدئو — با زولیپ آشنا هستم",
  "Skipped unsubscribed channels": "کانال‌های مشترک‌نشده را رد کرد",
  "Slack-compatible": "",
  ...
  "Starred messages options": "گزینه‌های پیام‌های ستاره‌دار",
  "Starring messages is a good way to keep track of important messages, such as tasks you need to go back to, or useful references. To star a message, hover over a message and click the <star-icon></star-icon>. <z-link>Learn more</z-link>": "ستاره‌دار کردن پیام‌ها روش خوبی است که پیام‌های مهم مانند فعالیت‌هایی که باید به آنها رجوع کنید یا منابع مهم را دنبال کنید. برای ستاره‌دار کردن یک پیام، روی آن بروید و <star-icon></star-icon> را کلیک کنید. <z-link>یادگیری بیشتر</z-link>",
  "Start a new topic or select one from the list.": "یک موضوع جدید شروع کنید یا از فهرست پایین یکی را انتخاب کنید.",
  "Start export": "شروع خروجی گرفتن",
  "Start export?": "خروجی‌گرفتن شروع شود؟",
  ...
  "Subscribe to this channel": "عضویت در این کانال",
  ...
  "Subscribers": "اعضا",
  "Subscribers preview": "پیش‌نمایش مشترکین",
  "Subscription permissions": "",
  "Summarize recent messages": "خلاصه کردن پیام‌های اخیر",
  "Sunday": "یکشنبه",
  "Support Zulip": "پشتیبانی زولیپ",
  "Switch between tabs": "جابه جایی بین تب ها",
  "Switch to light theme": "تغییردادن به زمینه روشن",
  "Switch to the dark theme": "تغییر دادن به تم تاریک",
  "Symbols": "نمادها",
  "System bot": "ربات سامانه",
  "THIS CHANNEL": "این کانال",
  "THIS CONVERSATION": "این مکالمه",
  "Task already exists": "وظیفه هم اکنون وجود دارد",
  "Task description (optional)": "شرح وظیفه (اختیاری)",
  "Task list": "لیست وظایف",
  "Tasks": "وظایف",
  "The administrators provided the following comment:": "ادمین‌ها نظر زیر را ارائه کرده‌اند:",
  "The application has been updated; Reloading…": "برنامه به‌روزرسانی شده‌است؛ بارگیری مجدد...",
  "The basics": "پایه‌ها",
  ...
  "The following <z-link>uploaded files</z-link> are no longer attached to any messages. They can still be accessed from this message's edit history. Would you like to delete them entirely?": "<z-link>فایل‌های آپلود شده‌ی</z-link> زیر دیگر به هیچ پیامی پیوست نشده‌اند. همچنان می‌توانید از طریق تاریخچه‌ی ویرایش این پیام& به آن‌ها دسترسی داشته باشید. آیا می‌خواهید آن‌ها را به طور کامل حذف کنید؟",
  "The following <z-link>uploaded files</z-link> are no longer attached to any messages. Would you like to delete them entirely?": "<z-link>فایل‌های آپلود شده‌ی</z-link> زیر دیگر به هیچ پیامی پیوست نشده‌اند. آیا می‌خواهید آن‌ها را به طور کامل حذف کنید؟",
  ...
  "The topic <z-topic-name>{topic_display_name}</z-topic-name> already exists in this channel. Are you sure you want to combine messages from these topics? This cannot be undone.": "موضوع <z-topic-name>{topic_display_name}</z-topic-name> در این کانال وجود دارد.آیا مطمئن هستید که می‌خواهید پیام‌های این موضوعات را با هم تجمیع کنید؟ این کار غیر قابل برگشت است.",
  ...
  "There are no groups matching your filters.": "هیچ گروهی با فیلترهای شما منطبق نبود.",
  "There are no invitations.": "دعوتنامه‌ای وجود ندارد.",
  "There are no messages here.": "اینجا هیچ پیامی نیست.",
  "There are no messages in this topic.": "هیچ پیامی در این موضوع نیست.",
  "There are no messages in your combined feed.": "پیامی در فید ترکیبی شما وجود ندارد.",
  "There are no messages to move.": "پیامی برای جا‌به‌جا کردن وجود ندارد.",
  ...
  "There was an error updating the setting.": "خطایی در به‌روزرسانی تنظیمات، وجود دارد.",
  ...
  "This channel doesn't exist, or you are not allowed to view it.": "این کانال وجود ندارد، یا شما اجازه ندارید آن را ببینید.",
  ...
  "This feature is available on Zulip Cloud Plus.": "این ویژگی بر روی زولیپ ابری پلاس در دسترس است.",
  ...
  "This group has been deactivated.": "این گروه غیرفعال شده است.",
  "This group has no assigned permissions.": "این گروه هیچ مجوزی ندارد.",
  "This group has no members.": "این گروه هیچ عضوی ندارد.",
  "This group has this permission because it's a subgroup of {supergroup_name}.": "این گروه این مجوز را دارد چون زیرگروهی از {supergroup_name} است.",
  "This group is deactivated. It can't be mentioned or used for any permissions.": "این گروه غیرفعال شده است. نمی‌توان به آن اشاره کرد یا از آن برای هیچ مجوزی استفاده کرد.",
  ...
  "This silent mention won't trigger notifications.": "این اشاره بی‌صدا، اطلاع‌رسانی را فعال نخواهد کرد.",
  "This user cannot be deactivated.": "نمی‌توان این کاربر را غیرفعال کرد.",
  ...
  "This user is a member of {name} because they are a member of a subgroup ({subgroups_name}).": "این کاربر عضو {name} است چون عضوی از زیرگروه ({subgroups_name}) است.",
  "This view will show messages where you are mentioned.": "این صفحه، پیام‌هایی را نشان می‌دهد که در آن‌ها به شما اشاره شده است.",
  ...
  "Time zone update offer": "پینشهاد به‌روزرسانی منطقه زمانی",
  "Time zone updated": "منطقه زمانی به‌روزرسانی شد",
  "Time's up!": "زمان به پایان رسیده است!",
  "Tip: You can watch this video without sound.": "نکته: می‌توانید این ویدیو را بدون صدا تماشا کنید.",
  "Title": "عنوان",
  "To call attention to a message, you can mention a user, a group, topic participants, or all subscribers to a channel. Type @ in the compose box, and choose who you'd like to mention from the list of suggestions. <z-link>Learn more</z-link>": "برای جلب توجه به یک پیام، می‌توانید به یک کاربر، گروه، موضوع درگیر یا تمام مشترکان کانال، اشاره کنید. علامت @ را در بخش نوشتن پیام تایپ کنید و از بین گزینه‌ها انتخاب کنید که به کدام موارد می‌خواهید اشاره کنید. <z-link>یادگیری بیشتر</z-link>",
  "To deactivate this group, you must first remove all permissions assigned to it.": "برای غیرفعال کردن این گروه، ابتدا باید تمام مجوزهای اختصاص داده شده به آن را حذف کنید.",
  ...
  "To make it easier to tell where your message will be sent, messages in conversations you are not composing to are faded.": "برای ساده‌کردن آنکه پیام شما به کجا ارسال می‌شود، پیام‌های مکالماتی که شما در آن‌ها مطلبی نمی‌نویسید، محو می‌شوند.",
  ...
  "To-do list title": "عنوان لیست انجام کارها",
  "Today": "امروز",
  ...
  "Topic": "موضوع",
  "Topic actions": "",
  "Topic actions menu": "منوی اقدامات موضوعی",
  ...
  "Travel & Places": "سفر ومکان‌ها",
  "Try now": "الان امتحان کن",
  "Tuesday": "سه شنبه",
  ...
  "Unable to update setting": "ناموفق در به‌روزرسانی تنظیمات",
  ...
  "Unexpected error updating the timezone.": "خطای غیرمنتظره در به‌روزرسانی منطقه زمانی.",
  ...
  "Unmuted": "صدادار شده",
  "Unmuted <z-link></z-link>.": "صدادارشدن <z-link></z-link>",
  ...
  "Unsubscribe from this channel": "لغو عضویت در این کانال",
  ...
  "Use or create a saved snippet": "ساخت یا ویرایش یک قطعه کد ذخیره شده",
  ...
  "User group ID": "شناسه گروه کاربری",
  "User group creation": "ساخت گروه کاربری",
  "User group description": "توضیحات گروه کاربری",
  "User group details": "جزییات گروه کاربری",
  "User group name": "نام گروه کاربری",
  "User group permissions": "مجوزهای گروه کاربری",
  "User group settings": "تنظیمات گروه کاربری",
  "User groups": "گروه‌های کاربری",
  "User groups offer a flexible way to manage permissions in your organization.": "گروه‌های کاربری روشی انعطاف‌پذیر برای مدیریت مجوزها در سازمان شما ارائه می‌دهند.",
  "User groups they should join": "گروه‌های کاربری که باید عضو آن شوند",
  ...
  "Users can edit this field for their own account": "کاربران می‌توانند این فیلد را برای حساب کاربری خود، ویرایش کنند",
  ...
  "View all members": "مشاهده تمام اعضا",
  ...
  "View in channel settings": "مشاهده در تنظیمات کانال",
  ...
  "View move history": "مشاهده سابقه جابه‌جایی",
  ...
  "Welcome back! You have at least {unread_msgs_count} unread messages. Do you want to mark them all as read?": "خوش برگشتید! شما {unread_msgs_count} پیام خوانده‌نشده دارید. آیا می‌خواهید همه آنها را به خوانده‌شده تبدیل کنید؟",
  "Welcome back! You have {unread_msgs_count} unread messages. Do you want to mark them all as read?": "خوش برگشتید! شما {unread_msgs_count} پیام خوانده‌نشده دارید. آیا می‌خواهید همه آنها را به خوانده‌شده تبدیل کنید؟",
  ...
  "Which branches should notifications be sent for?": "برای کدام شعب باید اطلاع‌رسانی ارسال شود؟",
  "Which messages do you want to mark as read? This action cannot be undone.": "",
  "Which messages should be moved?": "کدام پیام‌ها باید جا‌به‌جا شوند؟",
  "Which parts of the emails should be included in the Zulip messages?": "کدام بخش‌های ایمیل‌ها باید در پیام زولیپ ضمیمه شود؟",
  "Who can access this channel": "چه کسی می‌تواند به این کانال دسترسی داشته باشد",
  ...
  "Who can add members to this group": "چه کسی می‌تواند به این گروه عضو اضافه کند",
  "Who can administer all user groups": "چه کسی می‌تواند تمام گروه‌های کاربری را مدیریت کند",
  "Who can administer this channel": "چه کسی می‌تواند این کانال را مدیریت کند",
  "Who can administer this group": "چه کسی می‌تواند این گروه را مدیریت کند",
  ...
  "Who can create any bot": "چه کسی می‌تواند هر رباتی بسازد",
  "Who can create bots that send messages into Zulip": "چه کسی می‌تواند بات بسازد و به زولیپ پیام بفرستد",
  ...
  "Who can create user groups": "چه کسی می‌تواند گروه‌های کاربری بسازد",
  "Who can create web-public channels": "چه کسی می‌تواند کانال‌های عمومی وب بسازد",
  "Who can delete any message": "چه کسی می‌تواند هر پیامی را پاک کند",
  ...
  "Who can join this group": "چه کسی می‌تواند وارد این گروه شود",
  "Who can leave this group": "چه کسی می‌تواند این گروه را ترک کند",
  "Who can manage plans and billing": "چه کسی می‌تواند طرح‌ها و صورتحساب‌ها را مدیریت کند",
  ...
  "Who can post to this channel": "چه کسی می‌تواند در این کانال پست منتشر کند",
  "Who can remove members from this group": "چه کسی می‌تواند اعضا را از این گروه حذف کند",
  "Who can resolve topics": "چه کسی می‌تواند موضوعات را حل‌شده کند",
  ...
  "Who can start a direct message conversation": "چه کسی می‌تواند یک مکالمه پیام مستقیم را شروع کند",
  "Who can subscribe anyone to this channel": "چه کسی می‌تواند افراد دیگر را مشترک این کانال کند",
  "Who can subscribe others to channels": "چه کسی می‌تواند دیگران را مشترک کانال‌ها کند",
  "Who can subscribe to this channel": "چه کسی می‌تواند در این کانال مشترک شود",
  "Who can unsubscribe anyone from this channel": "چه کسی می‌تواند اشتراک اعضا در این کانال را لغو کند",
  "Who can use AI summaries": "چه کسی می‌تواند از خلاصه‌سازی هوش مصنوعی استفاده کند",
  "Who can view all other users in the organization": "چه کسی می‌تواند تمام کاربران دیگر در سازمان را مشاهده کند",
  "Who should be the sender of the Zulip messages for this email address?": "چه کسی باید فرستنده پیام‌های زولیپ برای این آدرس ایمیل باشد؟",
  "Why not <z-link>start the conversation</z-link>?": "چرا <z-link>شروع مکالمه</z-link> را امتحان نکنید؟",
  "Word": "کلمه",
  "Working remotely": "دورکار",
  "Would you like to <z-link>view messages in all public channels</z-link>?": "آیا دوست دارید <z-link>پیام‌های همه کانال‌های عمومی را ببینید</z-link>؟",
  ...
  "You are a member of this group because you are a member of a subgroup (<z-subgroup-names></z-subgroup-names>).": "شما عضو این گروه هستید چون عضوی از یک زیرگروه هستید (<z-subgroup-names></z-subgroup-names>).",
  "You are a member of this group.": "شما عضوی از این گروه هستید.",
  "You are a member of {name} because you are a member of a subgroup ({subgroups_name}).": "شما عضو {name} هستید چون عضوی از زیرگروه ({subgroups_name}) هستید.",
  ...
  "You are already a member of this group because you are a member of a subgroup": "شما از قبل عضو این گروه هستید چون عضوی از یک زیرگروه هستید.",
  "You are moving messages to a topic that already exists. Messages from these topics will be combined.": "شما در حال انتقال پیام‌ها به موضوعی هستید که از قبل وجود دارد. پیام‌های این موضوعات با هم ترکیب خواهند شد.",
  "You are not a member of any user groups.": "شما عضو هیچ گروه کاربری نیستید.",
  "You are not a member of this group.": "شما عضوی از این گروه نیستید.",
  "You are not allowed to add members to this group": "شما اجازه ندارید عضوی به این گروه اضافه کنید",
  "You are not allowed to change this field. Contact an administrator to update it.": "شما اجازه ندارید این فیلد را تغییر دهید. برای به‌روزرسانی آن، با یکی از ادمین‌ها تماس بگیرید.",
  "You are not allowed to remove this permission.": "شما اجازه ندارید این مجوز را حذف کنید.",
  "You are not allowed to start direct message conversations.": "شما اجازه ندارید که یک مکالمه پیام مستقیم را شروع کنید.",
  "You are not subscribed to <z-stream-name></z-stream-name>. <subscribe-button></subscribe-button>": "شما مشترک <z-stream-name></z-stream-name> نیستید. <subscribe-button></subscribe-button>",
  ...
  "You aren't following any topics.": "شما هیج موضوعی را دنبال نمی‌کنید.",
  ...
  "You can create bots that can only send messages.": "شما می‌توانید باتی درست کنید که فقط پیام بفرستد.",
  ...
  "You can only view channels that you are subscribed to.": "شما فقط کانال‌هایی را می‌توانید ببینید که مشترک آن هستید.",
  ...
  "You cannot create a user group with no members or subgroups.": "شما نمی‌توانید گروهی بدون عضو یا بدون زیرگروه، بسازید.",
  "You cannot join a deactivated user group.": "شما نمی‌توانید عضو گروه کاربری غیرفعال شده، بشوید.",
  "You cannot leave a deactivated user group.": "شما نمی‌توانید از گروه غیرفعال شده خارج شوید.",
  ...
  "You do not have permission to add other users to this channel.": "شما مجوز ندارید که کاربران دیگر را به این کانال اضافه کنید.",
  "You do not have permission to create bots.": "شما مجوز ندارید که بات بسازید.",
  "You do not have permission to create channels.": "شما مجوز ندارید که کانال بسازید.",
  "You do not have permission to create user groups.": "شما مجوز ندارید که گروه کاربری بسازید.",
  "You do not have permission to edit this setting.": "شما مجوز ندارید که این تنظیمات را ویرایش کنید.",
  ...
  "You do not have permission to send invite emails in this organization.": "شما اجازه ارسال ایمیل دعوت در این سازمان را ندارید.",
  ...
  "You have no direct messages with these users.": "شما با این کاربران هیچ پیام مستقیمی ندارید.",
  "You have no direct messages with {person} yet.": "شما هنوز هیچ پیام مستقیمی با {person} ندارید.",
  "You have no direct messages with {person}.": "شما پیام مستقیمی با {person} ندارید.",
  "You have no direct messages yet!": "شما هنوز پیام مستقیمی ندارید!",
  "You have no inactive bots.": "شما ربات های غیرفعال ندارید",
  "You have no messages in muted topics and channels.": "شما هیچ پیامی در موضوعات و کانال‌های بی‌صدا شده، ندارید.",
  ...
  "You have unread mentions": "اشاره‌های خوانده نشده دارید",
  "You have {display_count, plural, =0 {no drafts} one {# draft} other {# drafts}}.": "شما {display_count, plural, =0 {no drafts} one {# پیش‌نویس} other {# پیش‌نویس}} دارید.",
  "You have {display_count, plural, =0 {no scheduled messages} one {# scheduled message} other {# scheduled messages}}.": "شما {display_count, plural, =0 {هیچ پیام زمان‌بندی‌شده‌ای ندارید} یک {# پیام زمان‌بندی‌شده} دیگر {# پیام زمان‌بندی‌شده}} دارید.",
  "You have {display_count, plural, =0 {no starred messages} one {# starred message} other {# starred messages}}.": "شما {display_count, plural, =0 {پیام ستاره‌دار ندارید} یک {# پیام ستاره‌دار} دیگر {# پیام ستاره‌دار}} دارید.",
  "You have {display_count, plural, =0 {no unread mentions} one {# unread mention} other {# unread mentions}}.": "شما {display_count, plural, =0 {اشاره خوانده نشده ندارید} یک {# اشاره خوانده نشده} دیگر {# اشاره خوانده نشده}} دارید.",
  "You have {display_count, plural, =0 {no unread messages} one {# unread message} other {# unread messages}}.": "شما {display_count, plural, =0 {پیام خوانده نشده‌ ندارید} یک {# پیام خوانده نشده} دیگر {# پیام خوانده نشده}} دارید.",
  ...
  "You subscribed to <z-stream-name></z-stream-name>. <channel-settings-link></channel-settings-link>": "شما مشترک <z-stream-name></z-stream-name> شده‌اید. <channel-settings-link></channel-settings-link>",
  "You type": "شما تایپ می کنید",
  "You unsubscribed from <z-stream-name></z-stream-name>. <channel-settings-link></channel-settings-link>": "شما از <z-stream-name></z-stream-name> لغو اشتراک کردید. <channel-settings-link></channel-settings-link>",
  ...
  "You will be able to export all public data, and (optionally) private data from users who have given their permission.": "شما قادر خواهید بود از تمام داده‌های عمومی و داده‌های خصوصی کاربرانی که اجازه داده‌اند (مورد دوم اختیاری است)، خروجی بگیرید.",
  "You will lose access to content in this channel if you make it private. To keep access, subscribe or grant yourself permission to do so under Advanced configurations.": "اگر این کانال را خصوصی کنید، دسترسی به محتوای آن را از دست خواهید داد. برای حفظ دسترسی، مشترک شوید یا در تنظیمات پیشرفته به خودتان اجازه انجام این کار را بدهید.",
  "You will no longer be prompted to update your time zone.": "شما دیگر پیغامی برای به‌روزرسانی منطقه زمانی، دریافت نخواهید کرد.",
  ...
  "You will receive a confirmation email at the new address you enter.": "شما یک ایمیل تایید در آدرسی جدید که وارد کرده‌اید، دریافت خواهید کرد.",
  ...
  "Your computer's time zone differs from your Zulip profile. Update your time zone to {browser_time_zone}?": "منطقه زمانی رایانه شما با پروفایل زولیپ شما متفاوت است. منطقه زمانی خود را به {browser_time_zone} به‌روزرسانی می‌کنید؟",
  ...
  "Your organization’s data will be exported in a format designed for imports into Zulip Cloud or a self-hosted installation of Zulip.": "داده‌های سازمان شما با فرمتی که برای وارد کردن به زولیپ ابری یا نصب خودمیزبانی شده‌ی زولیپ طراحی شده است، خروجی گرفته می‌شوند.",
  ...
  "Your time zone was updated to {time_zone}.": "منطقه زمانی شما به {time_zone} تغییر کرد.",
  "Your time zone:": "منطقه زمانی شما:",
  "Your uploads": "آپلودهای شما",
  ...
  "Zulip needs your permission to enable desktop notifications for important messages.": "زولیپ برای فعال کردن اعلان‌های دسکتاپ برای پیام‌های مهم، به مجوز شما نیاز دارد.",
  ...
  "[Configure]": "[پیکربندی]",
  "[Error fetching message content.]": "[خطا در دریافت محتوای پیام.]",
  "[Quoting…]": "[نقل قول…]",
  "acme": "acme",
  "and {remaining_senders, plural, one {1 other} other {# others}}.": "و {remaining_senders, plural, one {1 دیگر} other {# دیگر}}.",
  ...
  "does not apply to users who can delete any message": "برای کاربرانی که می‌توانند هر پیامی را حذف کنند، صدق نمی‌کند.",
  "everyone except guests can subscribe to any public channel": "همه به جز مهمانان می‌توانند در هر کانال عمومی مشترک شوند",
  "general chat": "مکالمه عمومی",
  ...
  "{N, plural, one {# other subscriber} other {# other subscribers}}": "{N, plural, one {# سایر مشترکان} other {# سایر مشترکان}}",
  ...
  "{N, plural, one {Delete this option?} other {Delete these options?}}": "{N, plural, one {حذف این گزینه؟} other {حذف این گزینه‌ها؟}}",
  ...
  "{N, plural, one {Working… {N} message marked as read so far.} other {Working… {N} messages marked as read so far.}}": "{N, plural, one {در حال کار… {N} پیام تا الان به عنوان خوانده‌شده علامت‌گذاری شده‌اند.} other {در حال کار… {IN} پیام تا اینجا به عنوان خوانده‌شده علامت‌گذاری شده‌اند.}}",
  ...
  "{count, plural, one {# message} other {# messages}} will be moved.": "{count, plural, one {# پیام} other {# پیام}} will be moved.",
  ...
  "{members_count, plural, =1 {1 member} other {# members}}": "{members_count, plural, =1 {1 عضو} other {# عضو}}",
  ...
  "{names} are guests in this organization.": "{names} در این سازمان مهمان هستند.",
  "{name} (guest)": "{name} (مهمان)",
  "{name} is a guest in this organization.": "در این سازمان، {name} یک مهمان است.",
  ...
  "{subscribers_count, plural, =0 {No subscribers} =1 {1 subscriber} other {# subscribers}}": "{subscribers_count, plural, =0 {بدون مشترک} =1 {1 مشترک} other {# مشترک}}",
