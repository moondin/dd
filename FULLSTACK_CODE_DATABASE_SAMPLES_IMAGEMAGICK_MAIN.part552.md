...
## Verbatim Content (Part 552 of 851)
...
---[FILE: download.html]---
Location: ImageMagick-main/www/download.html
...
<head>
  ...
  <meta property="og:title" content="ImageMagick | Download" />
  ...
  <meta property="og:url" content="../www/download.html" />
  ...
  <meta name="twitter:title" content="ImageMagick | Download" />
  ...
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <div class="mt-3 ms-3">
      <a href="../index.html" class="text-decoration-none">
        <h1 class="fs-2 mb-1">Download</h1>
      </a>
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
      <td><a href= "../archive/linux/CentOS/x86_64/ImageMagick-7.1.2-3.x86_64.rpm">ImageMagick-7.1.2-3.x86_64.rpm</a></td>
    <td>Fedora x86_64 RPM</td>
  </tr>

  <tr>
      <td><a href= "../archive/linux/CentOS/x86_64/ImageMagick-libs-7.1.2-3.x86_64.rpm">ImageMagick-libs-7.1.2-3.x86_64.rpm</a></td>
    <td>Fedora x86_64 RPM</td>
  </tr>
  ...
  <tr>
    <td><a href="../archive/binaries/ImageMagick-x86_64-pc-cygwin.tar.gz">ImageMagick-x86_64-pc-cygwin.tar.gz</a></td>
    <td>Cygwin</td>
  </tr>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>rpm -Uvh ImageMagick-7.1.2-3.x86_64.rpm</samp></pre>

<p>You'll need the libraries as well:</p>
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>rpm -Uvh ImageMagick-libs-7.1.2-3.x86_64.rpm</samp></pre>
...
<pre class="p-3 mb-2 text-body-secondary bg-body-tertiary"><samp>export MAGICK_HOME="$HOME/ImageMagick-7.1.2"</samp></pre>
...
<p>Congratulations, you have a working ImageMagick distribution under macOS and you are ready to use ImageMagick to <a href="../index.html">convert, compose, or edit</a> your images or perhaps you'll want to use one of the <a href="develop.html">Application Program Interfaces</a> for C, C++, Perl, and others.</p>
...
<p>where <var>VERSION</var> is the version of ImageMagick you want to compile (i.e.: 7.1.2-3, svn, ...)</p>
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tbody>
  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-HDRI-x64-dll.exe">ImageMagick-7.1.2-3-Q16-HDRI-x64-dll.exe</a></td>
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tbody>
  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-x64-dll.exe">ImageMagick-7.1.2-3-Q16-x64-dll.exe</a></td>
    <td>Win64 dynamic at 16 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-x64-static.exe">ImageMagick-7.1.2-3-Q16-x64-static.exe</a></td>
    <td>Win64 static at 16 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q8-x64-dll.exe">ImageMagick-7.1.2-3-Q8-x64-dll.exe</a></td>
    <td>Win64 dynamic at 8 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q8-x64-static.exe">ImageMagick-7.1.2-3-Q8-x64-static.exe</a></td>
    <td>Win64 static at 8 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-HDRI-x64-static.exe">ImageMagick-7.1.2-3-Q16-HDRI-x64-static.exe</a></td>
    <td>Win64 static at 16 bits-per-pixel component with <a href="../www/high-dynamic-range.html">high dynamic-range imaging</a> enabled</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q8-arm64-dll.exe">ImageMagick-7.1.2-3-Q8-arm64-dll.exe</a></td>
    <td>ARM64 dynamic at 8 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q8-arm64-static.exe">ImageMagick-7.1.2-3-Q8-arm64-static.exe</a></td>
    <td>ARM64 static at 8 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-arm64-dll.exe">ImageMagick-7.1.2-3-Q16-arm64-dll.exe</a></td>
    <td>ARM64 dynamic at 16 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-arm64-static.exe">ImageMagick-7.1.2-3-Q16-arm64-static.exe</a></td>
    <td>ARM64 dynamic at 16 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-HDRI-arm64-dll.exe">ImageMagick-7.1.2-3-Q16-HDRI-arm64-dll.exe</a></td>
    <td>ARM64 dynamic at 16 bits-per-pixel component with <a href="../www/high-dynamic-range.html">high dynamic-range imaging</a> enabled</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-HDRI-arm64-static.exe">ImageMagick-7.1.2-3-Q16-HDRI-arm64-static.exe</a></td>
    <td>ARM64 static at 16 bits-per-pixel component with <a href="../www/high-dynamic-range.html">high dynamic-range imaging</a> enabled</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-x86-dll.exe">ImageMagick-7.1.2-3-Q16-x86-dll.exe</a></td>
    <td>Win32 dynamic at 16 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-x86-static.exe">ImageMagick-7.1.2-3-Q16-x86-static.exe</a></td>
    <td>Win32 static at 16 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q8-x86-dll.exe">ImageMagick-7.1.2-3-Q8-x86-dll.exe</a></td>
    <td>Win32 dynamic at 8 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q8-x86-static.exe">ImageMagick-7.1.2-3-Q8-x86-static.exe</a></td>
    <td>Win32 static at 8 bits-per-pixel component</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-HDRI-x86-dll.exe">ImageMagick-7.1.2-3-Q16-HDRI-x86-dll.exe</a></td>
    <td>Win32 dynamic at 16 bits-per-pixel component with <a href="../www/high-dynamic-range.html">high dynamic-range imaging</a> enabled</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-Q16-HDRI-x86-static.exe">ImageMagick-7.1.2-3-Q16-HDRI-x86-static.exe</a></td>
    <td>Win32 static at 16 bits-per-pixel component with <a href="../www/high-dynamic-range.html">high dynamic-range imaging</a> enabled</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-portable-Q16-x64.zip">ImageMagick-7.1.2-3-portable-Q16-x64.zip</a></td>
  ...
  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-portable-Q16-arm64.zip">ImageMagick-7.1.2-3-portable-Q16-arm64.zip</a></td>
  ...
  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-portable-Q16-x86.zip">ImageMagick-7.1.2-3-portable-Q16-x86.zip</a></td>
  ...
  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-portable-Q8-x64.zip">ImageMagick-7.1.2-3-portable-Q8-x64.zip</a></td>
  ...
  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-portable-Q8-arm64.zip">ImageMagick-7.1.2-3-portable-Q8-arm64.zip</a></td>
  ...
  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-portable-Q8-x86.zip">ImageMagick-7.1.2-3-portable-Q8-x86.zip</a></td>
  ...
  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-portable-Q16-HDRI-x64.zip">ImageMagick-7.1.2-3-portable-Q16-HDRI-x64.zip</a></td>
    <td>Portable Win64 static at 16 bits-per-pixel component with <a href="../www/high-dynamic-range.html">high dynamic-range imaging</a> enabled.  Just copy to your host and run (no installer, no Windows registry entries).</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-portable-Q16-HDRI-arm64.zip">ImageMagick-7.1.2-3-portable-Q16-HDRI-arm64.zip</a></td>
    <td>Portable ARM64 static at 16 bits-per-pixel component with <a href="../www/high-dynamic-range.html">high dynamic-range imaging</a> enabled.  Just copy to your host and run (no installer, no Windows registry entries).</td>
  </tr>

  <tr>
      <td><a href= "../archive/binaries/ImageMagick-7.1.2-3-portable-Q16-HDRI-x86.zip">ImageMagick-7.1.2-3-portable-Q16-HDRI-x86.zip</a></td>
...
<!-- Magick Cache 3rd October 2025 23:12 -->
```
