...
## Verbatim Content (Part 234 of 1290)
...
---[FILE: upgrade_user_to_fixed_price_monthly_basic_plan--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/upgrade_user_to_fixed_price_monthly_basic_plan--Event.list.2.json
  ...
  "data": [
    {
      ...
      "data": {
        "object": {
          ...
          "latest_charge": "upgrade_user_to_fixed_price_monthly_basic_plan--Event.list.2.json",
          "livemode": false,
          "metadata": {},
          "next_action": null,
          ...
          "payment_details": {
            ...
            "order_reference": "in_1SVWupDwzgQ85STga2fDju"
          },
    ...
    },
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "upgrade_user_to_fixed_price_monthly_basic_plan--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
          "payment_method_details": {
            "card": {
              "amount_authorized": 10000,
              "authorization_code": "924141",
              "brand": "visa",
              "checks": {
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "upgrade_user_to_fixed_price_monthly_basic_plan--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
