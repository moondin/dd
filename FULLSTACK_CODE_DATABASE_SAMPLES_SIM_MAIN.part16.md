...
## Verbatim Content (Part 16 of 933)
...
Location: sim-main/apps/docs/content/docs/de/permissions/roles-and-permissions.mdx
...
---[FILE: python.mdx]---
Location: sim-main/apps/docs/content/docs/de/sdks/python.mdx
