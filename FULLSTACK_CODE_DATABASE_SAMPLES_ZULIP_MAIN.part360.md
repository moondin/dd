...
## Verbatim Content (Part 360 of 1290)
...
Location: zulip-main/locale/ko/translations.json
...
```json
{
  ...
  "Mark topic as read": "주제를 읽음으로 표시",
  ...
  "Welcome to Zulip!": "Zulip에 오신 것을 환영합니다!",
  ...
  "Yesterday": "어제",
  "You": "당신",
  "You (click to remove) and {other_username} reacted with {emoji_name}": "당신 (클릭하여 삭제) 그리고 {emoji_name}으로 반응한 {other_username}",
