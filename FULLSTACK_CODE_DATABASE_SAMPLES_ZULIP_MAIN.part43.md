...
## Verbatim Content (Part 43 of 1290)
...
---[FILE: billing_page_permissions--Event.list.1.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/billing_page_permissions--Event.list.1.json
  ...
  "data": [
    {
      ...
      "data": {
        "object": {
          ...
          "created": 1000000000,
          "currency": "usd",
          "id": "billing_page_permissions--Event.list.1.json",
...
---[FILE: billing_page_permissions--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/billing_page_permissions--Event.list.2.json
  ...
  "data": [
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "billing_page_permissions--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
          "payment_method_details": {
            "card": {
              "amount_authorized": 48000,
              "authorization_code": "706017",
              "brand": "visa",
              "checks": {
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "billing_page_permissions--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
    ...
    },
    {
      ...
      "data": {
        "object": {
          ...
          "id": "billing_page_permissions--Customer.create.1.json",
