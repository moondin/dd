...
## Verbatim Content (Part 741 of 1290)
...
Location: zulip-main/web/styles/subscriptions.css
...
.advanced-configurations-container,
.channel-permissions {
    .stream-message-retention-days-input input[type="text"] {
        border-radius: 5px;
        box-shadow: none;
        margin: 0;
        height: inherit;
...
---[FILE: tooltips.css]---
Location: zulip-main/web/styles/tooltips.css
