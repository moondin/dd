...
## Verbatim Content (Part 609 of 650)
...
---[FILE: UploadersConfigForm.ja-JP.resx]---
Location: ShareX-develop/ShareX.UploadersLib/Forms/UploadersConfigForm.ja-JP.resx
...
<root>
  ...
  <data name="cbAmazonS3CustomCNAME.Text" xml:space="preserve">
    <value>独自のドメインを使用:</value>
  </data>
  <data name="cbAmazonS3CustomCNAME.ToolTip" xml:space="preserve">
    <value>独自のドメインにバケットを設置している場合に、このオプションを使用します。
フィールドが空の場合は、バケット名をURLとして使用します。
たとえば、バケット名が「bucket.example.com」であれば、URLは「http://bucket.example.com/...」となります。</value>
  </data>
  <data name="btnTwitterNameUpdate.Text" xml:space="preserve">
    <value>更新</value>
  </data>
  <data name="lblTwitterDefaultMessage.Text" xml:space="preserve">
    <value>既定のツイート メッセージ:</value>
  </data>
  <data name="cbTwitterSkipMessageBox.Text" xml:space="preserve">
    <value>ツイート メッセージ ボックスをスキップする</value>
  </data>
  ...
  <data name="lblPolrAPIHostname.Text" xml:space="preserve">
    <value>API ホスト名: (例 http://example.com/api.php, polr.me を使用する場合は空白にする)</value>
  </data>
  ...
  <data name="cbFTPRemoveFileExtension.Text" xml:space="preserve">
    <value>URL パスからファイル拡張子を取り除く</value>
  </data>
  ...
  <data name="lblBoxFolderTip.Text" xml:space="preserve">
    <value>メモ: フォルダー名をダブルクリックで、そのフォルダーに入れます。</value>
  </data>
  ...
  <data name="cbMediaFireUseLongLink.Text" xml:space="preserve">
    <value>ファイル名を含む、長いリンクを使用する</value>
  </data>
  ...
  <data name="lblSeafileWritePermNotif.Text" xml:space="preserve">
    <value>書き込み権限のないライブラリは非表示です。
暗号化ライブラリを使用すると共有できません。</value>
  </data>
  ...
  <data name="cbImgurUseGIFV.Text" xml:space="preserve">
    <value>GIF の代わりに GIFV へのリンクを使用する</value>
  </data>
  <data name="cbImgurUploadSelectedAlbum.Text" xml:space="preserve">
    <value>画像を選択したアルバムにアップロード</value>
  </data>
  ...
  <data name="lblPicasaAlbumID.Text" xml:space="preserve">
    <value>アップロードするアルバム ID (空白 = アルバム アップロードなし):</value>
  </data>
  ...
  <data name="llVgymeAccountDetailsPage.Text" xml:space="preserve">
    <value>ユーザー キーはアカウントの詳細ページから取得できます。</value>
  </data>
  ...
  <data name="cbKuttReuse.Text" xml:space="preserve">
    <value>指定した対象URLがあればそれを返す</value>
  </data>
  ...
  <data name="lblFirebaseDomainExample.Text" xml:space="preserve">
    <value>例: google.page.link</value>
  </data>
  ...
  <data name="cbAmazonS3SignedPayload.Text" xml:space="preserve">
    <value>署名付きペイロード (Signed payload)</value>
  </data>
</root>
```
