...
## Verbatim Content (Part 619 of 650)
...
---[FILE: UploadersConfigForm.uk.resx]---
Location: ShareX-develop/ShareX.UploadersLib/Forms/UploadersConfigForm.uk.resx
...
<root>
  ...
  <data name="tpOtherUploaders.Text" xml:space="preserve">
    <value>Інші вивантажувачі</value>
  </data>
  ...
  <data name="lblSFTPKeyPassphrase.Text" xml:space="preserve">
    <value>Ключові фрази:</value>
  </data>
  <data name="lblSFTPKeyLocation.Text" xml:space="preserve">
    <value>Розташування ключів:</value>
  </data>
  ...
  <data name="cbFTPRemoveFileExtension.Text" xml:space="preserve">
    <value>Вилучити розширення файлу зі шляху посилання</value>
  </data>
  ...
  <data name="cbGoogleDriveUseFolder.Text" xml:space="preserve">
    <value>Вивантажити файли у вибрану теку</value>
  </data>
  ...
  <data name="btnGoogleDriveRefreshFolders.Text" xml:space="preserve">
    <value>Оновити список тек</value>
  </data>
  ...
  <data name="lblAzureStorageAccountName.Text" xml:space="preserve">
    <value>Назва облікового запису:</value>
  </data>
  ...
  <data name="lblMegaStatus.Text" xml:space="preserve">
    <value>Налаштовано / не налаштовано</value>
  </data>
  ...
  <data name="btnPushbulletGetDeviceList.Text" xml:space="preserve">
    <value>Отримати список пристроїв</value>
  </data>
  ...
  <data name="lblSeafileSelectLibrary.Text" xml:space="preserve">
    <value>Виберіть бібліотеку:</value>
  </data>
  ...
  <data name="grpSeafileAccInfo.Text" xml:space="preserve">
    <value>Інформацію про обліковий запис</value>
  </data>
  ...
  <data name="cbGistPublishPublic.Text" xml:space="preserve">
    <value>Створити публічний Gist</value>
  </data>
  ...
  <data name="lblHastebinSyntaxHighlighting.Text" xml:space="preserve">
    <value>Підсвічування синтаксису:</value>
  </data>
  ...
  <data name="gbPhotobucketUserAccount.Text" xml:space="preserve">
    <value>Обліковий запис користувача</value>
  </data>
  <data name="lblGooglePhotosCreateAlbumName.Text" xml:space="preserve">
    <value>Назва альбому:</value>
  </data>
  ...
  <data name="tpGooglePhotos.Text" xml:space="preserve">
    <value>Google Фото</value>
  </data>
  <data name="lblCheveretoUploadURLExample.Text" xml:space="preserve">
    <value>Приклад: http://example.com/api/1/upload</value>
  </data>
  ...
  <data name="llVgymeAccountDetailsPage.Text" xml:space="preserve">
    <value>Ви можете отримати ключ зі сторінки подробиць облікового запису.</value>
  </data>
  ...
  <data name="lblPomfResultURL.Text" xml:space="preserve">
    <value>URL-адреса результату:</value>
  </data>
  <data name="cbImgurUploadSelectedAlbum.Text" xml:space="preserve">
    <value>Вивантажувати зображення до вибраного альбому</value>
  </data>
  <data name="cbB2CustomUrl.Text" xml:space="preserve">
    <value>Використовувати власну URL-адресу:</value>
  </data>
  <data name="cbPolrUseAPIv1.Text" xml:space="preserve">
    <value>Використовувати застарілий API v1</value>
  </data>
  <data name="cbLocalhostrDirectURL.Text" xml:space="preserve">
    <value>Використовувати пряму URL-адресу, якщо вона існує</value>
  </data>
  <data name="cbHastebinUseFileExtension.Text" xml:space="preserve">
    <value>Використовувати розширення файлу для підсвічування синтаксису (крім .txt)</value>
  </data>
  <data name="cbImgurUseGIFV.Text" xml:space="preserve">
    <value>Використовувати посилання на GIFV замість GIF</value>
  </data>
  <data name="cbMediaFireUseLongLink.Text" xml:space="preserve">
    <value>Використовувати довге посилання, яке містить ім'я файлу</value>
  </data>
  <data name="cbAmazonS3UsePathStyle.Text" xml:space="preserve">
    <value>Використовувати запит у вигляді шляху</value>
  </data>
  <data name="cbOwnCloudUsePreviewLinks.Text" xml:space="preserve">
    <value>Використовувати посилання для попереднього перегляду (лише NextCloud)</value>
  </data>
  <data name="cbOwnCloudAutoExpire.Text" xml:space="preserve">
    <value>Автоматичне завершення терміну дії спільних посилань</value>
  </data>
  <data name="lblAzureStorageCacheControl.Text" xml:space="preserve">
    <value>Заголовок Cache-Control:</value>
  </data>
  <data name="lblB2ManageLink.Text" xml:space="preserve">
    <value>Натисніть тут, щоб створити ключ застосунку або керувати своїми відрами.</value>
  </data>
  <data name="lblOwnCloudExpiryTime.Text" xml:space="preserve">
    <value>Термін дії (днів):</value>
  </data>
  <data name="lblFirebaseWebAPIKey.Text" xml:space="preserve">
    <value>Ключ Web API:</value>
  </data>
  <data name="lblYouTubePrivacyType.Text" xml:space="preserve">
    <value>Видимість:</value>
  </data>
  <data name="cbAmazonS3SignedPayload.Text" xml:space="preserve">
    <value>Підписане корисне навантаження</value>
  </data>
  <data name="lblAmazonS3Endpoints.Text" xml:space="preserve">
    <value>Кінцеві точки:</value>
  </data>
  <data name="cbAmazonS3CustomCNAME.ToolTip" xml:space="preserve">
    <value>Використовуйте цю опцію, якщо ви маєте відро з власним доменом.
Якщо текстове поле порожнє, то в якості URL буде використано ім'я вашого відра.
Наприклад, якщо ваше відро називається "bucket.example.com", то URL буде "http://bucket.example.com/...".</value>
  </data>
  <data name="cbAmazonS3PublicACL.Text" xml:space="preserve">
    <value>Встановити для файлів public-read ACL</value>
  </data>
  ...
  <data name="cbSeafileCreateShareableURLRaw.Text" xml:space="preserve">
    <value>Використовувати сиру URL-адресу</value>
  </data>
  <data name="cbYouTubeShowDialog.Text" xml:space="preserve">
    <value>Показувати діалогове вікно налаштувань відео</value>
  </data>
  <data name="grpSeafileShareSettings.Text" xml:space="preserve">
    <value>Налаштування спільного доступу Seafile</value>
  </data>
  <data name="lblAmazonS3SecretKey.Text" xml:space="preserve">
    <value>Секретний ключ доступу:</value>
  </data>
  <data name="lblAmazonS3StorageClass.Text" xml:space="preserve">
    <value>Клас сховища:</value>
  </data>
  <data name="lblYouTubePermissionsTip.Text" xml:space="preserve">
    <value>Ви можете відкликати доступ у будь-який час, скориставшись посиланням нижче:</value>
  </data>
  <data name="lblYourlsNote.Text" xml:space="preserve">
    <value>Примітка: Якщо ви маєте підпис, вам не потрібні ім'я користувача та пароль.</value>
  </data>
  <data name="lblSeafileWritePermNotif.Text" xml:space="preserve">
    <value>Бібліотеки без дозволів на запис приховано.
Використання зашифрованої бібліотеки вимикає спільний доступ.</value>
  </data>
  <data name="lblBoxShareAccessLevel.Text" xml:space="preserve">
    <value>Рівень доступу спільного посилання:</value>
  </data>
  <data name="lblBoxFolderTip.Text" xml:space="preserve">
    <value>Примітка: Ви можете двічі клацнути назву теки, щоб перейти до неї.</value>
  </data>
  <data name="lblGistOAuthInfo.Text" xml:space="preserve">
    <value>Примітка: GitHub Enterprise не підтримується.</value>
  </data>
  <data name="cbKuttReuse.Text" xml:space="preserve">
    <value>Якщо URL-адреса з вказаною ціллю існує, повернути її</value>
  </data>
  <data name="lblPhotobucketVerificationCode.Text" xml:space="preserve">
    <value>Код підтвердження (отримайте код підтвердження на сторінці авторизації):</value>
  </data>
  <data name="lblPushbulletUserKey.Text" xml:space="preserve">
    <value>Ключ API користувача:</value>
  </data>
  <data name="lblPhotobucketNewAlbumName.Text" xml:space="preserve">
    <value>Нова назва альбому (має містити від 2 до 50 символів. Допустимі символи: літери, цифри, символ підкреслення ( _ ), дефіс (-) та пробіл)</value>
  </data>
  <data name="lblLambdaInfo.Text" xml:space="preserve">
    <value>Щоб отримати ключ API, увійдіть до Lambda за адресою https://lambda.sx/, натисніть на своє ім'я користувача, а потім натисніть "Керувати обліковим записом".</value>
  </data>
  <data name="cbTeknikEncrypt.Text" xml:space="preserve">
    <value>Шифрування на стороні клієнта</value>
  </data>
  <data name="cbTeknikGenDeleteKey.Text" xml:space="preserve">
    <value>Генерувати ключ для видалення</value>
  </data>
  <data name="lblAdflyAPIUID.Text" xml:space="preserve">
    <value>UID API:</value>
  </data>
  <data name="lblPicasaAlbumID.Text" xml:space="preserve">
    <value>ID альбому для вивантаження (Порожньо = не вивантажувати в альбом):</value>
  </data>
  <data name="lblTeknikAuthUrl.Text" xml:space="preserve">
    <value>URL для автентифікації:</value>
  </data>
  ...
  <data name="lblTeknikUploadAPIUrl.Text" xml:space="preserve">
    <value>URL API для вивантаження:</value>
  </data>
  <data name="lblTeknikUrlShortenerAPIUrl.Text" xml:space="preserve">
    <value>URL API сервісу коротких посилань:</value>
  </data>
  <data name="llAdflyLink.Text" xml:space="preserve">
    <value>Тут можна знайти ваші ключ API та UID</value>
  </data>
</root>
```
