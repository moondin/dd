...
## Verbatim Content (Part 136 of 1290)
...
---[FILE: schedule_fixed_price_plan_upgrade_to_another_fixed_price_plan--Event.list.2.json]---
Location: zulip-main/corporate/tests/stripe_fixtures/schedule_fixed_price_plan_upgrade_to_another_fixed_price_plan--Event.list.2.json
            ...
            "data": [
              {
                ...
                "parent": {
                  "invoice_item_details": {
                    "invoice_item": "schedule_fixed_price_plan_upgrade_to_another_fixed_price_plan--Event.list.2.json",
                    "proration": false,
                    "proration_details": {
                      "credited_items": null
                    },
    ...
    },
    {
      ...
      "data": {
        "object": {
          ...
          "latest_charge": "schedule_fixed_price_plan_upgrade_to_another_fixed_price_plan--Event.list.2.json",
          "livemode": false,
          "metadata": {},
          "next_action": null,
          ...
          "payment_details": {
            ...
            "order_reference": "in_1SVWtFDwzgQ85STg6IGZVx"
          },
    ...
    },
    {
      ...
      "data": {
        "object": {
          ...
          "paid": true,
          "payment_intent": "schedule_fixed_price_plan_upgrade_to_another_fixed_price_plan--Event.list.2.json",
          "payment_method": "pm_NORMALIZED",
          "payment_method_details": {
            "card": {
              "amount_authorized": 10000,
              "authorization_code": "708128",
              "brand": "visa",
              "checks": {
